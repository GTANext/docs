...
//#region content/docs/cleo/sa/plus/fx.mdx?collection=docs
var frontmatter = {
	"title": "特效 Fx",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "系统指针",
			"content": "particle 对应的 FX 系统地址；句柄无效为 0。用在 `if` 里。"
		},
		{
			"heading": "加粒子",
			"content": "往 FX 系统加一个粒子：位置、速度、大小、亮度、RGBA、`lastFactor`。"
		},
		{
			"heading": "按名可用",
			"content": "是否存在该名字的 FX 系统。用在 `if` 里。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#系统指针",
		title: jsx(Fragment, { children: "系统指针" })
	},
	{
		depth: 2,
		url: "#加粒子",
		title: jsx(Fragment, { children: "加粒子" })
	},
	{
		depth: 2,
		url: "#按名可用",
		title: jsx(Fragment, { children: "按名可用" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0EBF",
			name: "GET_FX_SYSTEM_POINTER",
			member: "Fx.GetAddress",
			children: [jsxs(_components.p, { children: [
				"particle 对应的 FX 系统地址；句柄无效为 0。用在 ",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0EBF GET_FX_SYSTEM_POINTER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: particle" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0EC0",
			name: "ADD_FX_SYSTEM_PARTICLE",
			member: "Fx.AddParticle",
			children: [jsxs(_components.p, { children: [
				"往 FX 系统加一个粒子：位置、速度、大小、亮度、RGBA、",
				jsx(_components.code, { children: "lastFactor" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0EC0 ADD_FX_SYSTEM_PARTICLE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: particle, posX, posY, posZ, velX, velY, velZ, size, brightness, r, g, b, a, lastFactor" })
								})
							] })
						}) })
					}),
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "  posX, posY, posZ, velX, velY, velZ,"
									})
								}),
								"\n",
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "  size, brightness, r, g, b, a, lastFactor"
									})
								}),
								"\n",
								jsx(_components.span, {
		...
		jsxs(Opcode, {
			id: "0EC1",
			name: "IS_FX_SYSTEM_AVAILABLE_WITH_NAME",
			member: "Fx.IsAvailableWithName",
			children: [jsxs(_components.p, { children: [
				"是否存在该名字的 FX 系统。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0EC1 IS_FX_SYSTEM_AVAILABLE_WITH_NAME" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " isFxSystemAvailableWithName"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",

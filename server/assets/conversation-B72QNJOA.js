...
//#region content/docs/cleo/sa/default/conversation.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "共 11 条。写法见 Lua / Redux。"
		},
		{
			"heading": "开始配置",
			"content": "开始配置与玩家的对话，并清掉旧行。"
		},
		{
			"heading": "结束配置",
			"content": "结束 `0717` 配置；选项字幕会显示。"
		},
		{
			"heading": "是否在节点",
			"content": "对话是否在指定节点。用在 `if` 里。"
		},
		{
			"heading": "位置是否合适",
			"content": "双方是否在对话且能互相交流。用在 `if` 里。"
		},
		{
			"heading": "开关对话",
			"content": "暂停 / 恢复该角色的脚本对话。"
		},
		{
			"heading": "清角色对话",
			"content": "清掉该角色上的对话。"
		...
		{
			"heading": "节点--脚本语音",
			"content": "用脚本语音 ID（`03CF` 一类）加对话行。"
		},
		{
			"heading": "结束节点--脚本语音",
			"content": "结束节点的脚本语音 ID。"
		},
		{
			"heading": "结束配置无字幕",
			"content": "结束 `0717` 配置；选项不显示字幕。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#开始配置",
		title: jsx(Fragment, { children: "开始配置" })
	},
	{
		depth: 2,
		url: "#结束配置",
		title: jsx(Fragment, { children: "结束配置" })
	},
	{
		depth: 2,
		url: "#是否在节点",
		title: jsx(Fragment, { children: "是否在节点" })
	},
	{
		depth: 2,
		url: "#位置是否合适",
		title: jsx(Fragment, { children: "位置是否合适" })
	},
	{
		depth: 2,
		url: "#开关对话",
		title: jsx(Fragment, { children: "开关对话" })
	},
	{
		depth: 2,
		url: "#清角色对话",
		title: jsx(Fragment, { children: "清角色对话" })
	},
	{
		depth: 2,
		url: "#节点--语音",
		title: jsx(Fragment, { children: "节点 + 语音" })
	},
	{
		depth: 2,
		url: "#结束节点--语音",
		title: jsx(Fragment, { children: "结束节点 + 语音" })
	},
	{
		depth: 2,
		url: "#节点--脚本语音",
		title: jsx(Fragment, { children: "节点 + 脚本语音" })
	},
	{
		depth: 2,
		url: "#结束节点--脚本语音",
		title: jsx(Fragment, { children: "结束节点 + 脚本语音" })
	},
	{
		depth: 2,
		url: "#结束配置无字幕",
		title: jsx(Fragment, { children: "结束配置无字幕" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Conversation.StartSettingUp",
			children: [jsx(_components.p, { children: "开始配置与玩家的对话，并清掉旧行。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0717 START_SETTING_UP_CONVERSATION" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "startSettingUpConversation"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
		...
		jsxs(Opcode, {
			...
			member: "Conversation.FinishSettingUp",
			children: [jsxs(_components.p, { children: [
				"结束 ",
				jsx(_components.code, { children: "0717" }),
				" 配置；选项字幕会显示。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0719 FINISH_SETTING_UP_CONVERSATION" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "finishSettingUpConversation"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "071A IS_CONVERSATION_AT_NODE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: handle, speech" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Conversation.IsPlayerInPosition",
			children: [jsxs(_components.p, { children: [
				"双方是否在对话且能互相交流。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "089B IS_PLAYER_IN_POSITION_FOR_CONVERSATION" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " isPlayerInPositionForConversation"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Conversation.Enable",
			children: [jsx(_components.p, { children: "暂停 / 恢复该角色的脚本对话。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "089C ENABLE_CONVERSATION" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Conversation.ClearForChar",
			children: [jsx(_components.p, { children: "清掉该角色上的对话。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "08ED CLEAR_CONVERSATION_FOR_CHAR" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "clearConversationForChar"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
		...
		jsxs(Opcode, {
			...
			member: "Conversation.SetUpNodeWithSpeech",
			children: [jsx(_components.p, { children: "配置节点：问 / 正 / 负 GXT 与语音短语。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "09A4 SET_UP_CONVERSATION_NODE_WITH_SPEECH" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: question, positiveAnswer, negativeAnswer, questionPhrase, positiveAnswerPhrase, negativeAnswerPhrase" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "setUpConversationNodeWithSpeech"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(question, positiveAnswer, negativeAnswer, questionPhrase, positiveAnswerPhrase, negativeAnswerPhrase)"
								})]
							}) })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Conversation.SetUpEndNodeWithSpeech",
			children: [jsx(_components.p, { children: "结束节点的语音短语。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "09AA SET_UP_CONVERSATION_END_NODE_WITH_SPEECH" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: text, phrase" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "setUpConversationEndNodeWithSpeech"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(text, phrase)"
								})]
							}) })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "setUpEndNodeWithSpeech"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Conversation.SetUpNodeWithScriptedSpeech",
			children: [jsxs(_components.p, { children: [
				"用脚本语音 ID（",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0A18 SET_UP_CONVERSATION_NODE_WITH_SCRIPTED_SPEECH" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: question, positiveAnswer, negativeAnswer, questionSoundId, positiveAnswerSoundId, negativeAnswerSoundId" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "setUpConversationNodeWithScriptedSpeech"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(question, positiveAnswer, negativeAnswer, questionSoundId, positiveAnswerSoundId, negativeAnswerSoundId)"
								})]
							}) })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "setUpNodeWithScriptedSpeech"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Conversation.SetUpEndNodeWithScriptedSpeech",
			children: [jsx(_components.p, { children: "结束节点的脚本语音 ID。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0A3C SET_UP_CONVERSATION_END_NODE_WITH_SCRIPTED_SPEECH" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: speech, speechSoundId" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "setUpConversationEndNodeWithScriptedSpeech"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(speech, speechSoundId)"
								})]
							}) })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "setUpEndNodeWithScriptedSpeech"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Conversation.FinishSettingUpNoSubtitles",
			children: [jsxs(_components.p, { children: [
				"结束 ",
				jsx(_components.code, { children: "0717" }),
				" 配置；选项不显示字幕。"
				...
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0A47 FINISH_SETTING_UP_CONVERSATION_NO_SUBTITLES" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "finishSettingUpConversationNoSubtitles"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "finishSettingUpNoSubtitles"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",

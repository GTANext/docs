...
//#region content/docs/cleo/sa/default/streamedscript.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "共 10 条。写法见 Lua / Redux。"
		},
		{
			"heading": "注册脚本脑",
			"content": "按名注册环境脚本脑（如室内行人行为）。"
		},
		{
			"heading": "注册吸引点脚本脑",
			"content": "为地图吸引点行人注册环境脚本（如购物）。"
		},
		{
			"heading": "流加载",
			"content": "从 script.img 流式加载环境脚本。"
		},
		{
			"heading": "是否加载完",
			"content": "`08A9` 是否已加载完。用在 `if` 里。"
		},
		{
			"heading": "标记可卸载",
			"content": "标记环境脚本可卸载。"
		...
		{
			"heading": "释放",
			"content": "释放该 ID 环境脚本内存。"
		},
		{
			"heading": "启动实例",
			"content": "启动该 ID 环境脚本实例。"
		},
		{
			"heading": "实例数",
			"content": "该脚本当前实例数。"
		...
		{
			"heading": "绑随机行人",
			"content": "玩家靠近某模型行人时启动环境脚本。"
		},
		{
			"heading": "绑物体",
			"content": "玩家靠近某模型物体时启动环境脚本。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#注册脚本脑",
		title: jsx(Fragment, { children: "注册脚本脑" })
	},
	{
		depth: 2,
		url: "#注册吸引点脚本脑",
		title: jsx(Fragment, { children: "注册吸引点脚本脑" })
	},
	{
		depth: 2,
		url: "#流加载",
		title: jsx(Fragment, { children: "流加载" })
	},
	{
		depth: 2,
		url: "#是否加载完",
		title: jsx(Fragment, { children: "是否加载完" })
	},
	{
		depth: 2,
		url: "#标记可卸载",
		title: jsx(Fragment, { children: "标记可卸载" })
	},
	{
		depth: 2,
		url: "#释放",
	...
	},
	{
		depth: 2,
		url: "#启动实例",
		title: jsx(Fragment, { children: "启动实例" })
	},
	{
		depth: 2,
		url: "#实例数",
		title: jsx(Fragment, { children: "实例数" })
	},
	{
		depth: 2,
		url: "#绑随机行人",
		title: jsx(Fragment, { children: "绑随机行人" })
	},
	{
		depth: 2,
		url: "#绑物体",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "StreamedScript.RegisterScriptBrainForCodeUse",
			children: [jsx(_components.p, { children: "按名注册环境脚本脑（如室内行人行为）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07D3 REGISTER_SCRIPT_BRAIN_FOR_CODE_USE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: id, scriptName" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "registerScriptBrainForCodeUse"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(id, scriptName)"
								})]
							}) })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "StreamedScript.RegisterAttractorScriptBrainForCodeUse",
			children: [jsx(_components.p, { children: "为地图吸引点行人注册环境脚本（如购物）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0884 REGISTER_ATTRACTOR_SCRIPT_BRAIN_FOR_CODE_USE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "registerAttractorScriptBrainForCodeUse"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
		...
		jsxs(Opcode, {
			id: "08A9",
			name: "STREAM_SCRIPT",
			member: "StreamedScript.Stream",
			children: [jsx(_components.p, { children: "从 script.img 流式加载环境脚本。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "08A9 STREAM_SCRIPT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "StreamedScript.HasLoaded",
			children: [jsxs(_components.p, { children: [
				jsx(_components.code, { children: "08A9" }),
				" 是否已加载完。用在 ",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "08AB HAS_STREAMED_SCRIPT_LOADED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " hasStreamedScriptLoaded"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "StreamedScript.MarkAsNoLongerNeeded",
			children: [jsx(_components.p, { children: "标记环境脚本可卸载。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "090F MARK_STREAMED_SCRIPT_AS_NO_LONGER_NEEDED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "markStreamedScriptAsNoLongerNeeded"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
		...
		jsxs(Opcode, {
			...
			member: "StreamedScript.Remove",
			children: [jsx(_components.p, { children: "释放该 ID 环境脚本内存。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0910 REMOVE_STREAMED_SCRIPT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "StreamedScript.StartNew",
			children: [jsx(_components.p, { children: "启动该 ID 环境脚本实例。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0913 START_NEW_STREAMED_SCRIPT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: id, args" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "startNewStreamedScript"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
		...
		jsxs(Opcode, {
			...
			member: "StreamedScript.GetNumberOfInstances",
			children: [jsx(_components.p, { children: "该脚本当前实例数。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0926 GET_NUMBER_OF_INSTANCES_OF_STREAMED_SCRIPT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: numScripts" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " getNumberOfInstancesOfStreamedScript"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "StreamedScript.AllocateToRandomPed",
			children: [jsx(_components.p, { children: "玩家靠近某模型行人时启动环境脚本。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0928 ALLOCATE_STREAMED_SCRIPT_TO_RANDOM_PED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: id, modelId, priority" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "allocateStreamedScriptToRandomPed"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(id, modelId, priority)"
								})]
							}) })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "StreamedScript.AllocateToObject",
			children: [jsx(_components.p, { children: "玩家靠近某模型物体时启动环境脚本。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0929 ALLOCATE_STREAMED_SCRIPT_TO_OBJECT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: id, modelId, priority, radius, groupingId" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "allocateStreamedScriptToObject"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(id, modelId, priority, radius, groupingId)"
								})]
							}) })
						}) })
					}),

...
//#region content/docs/plugins/entities/placeable.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`CPlaceable.h`"
		},
		{
			"heading": void 0,
			"content": "位置 / 朝向基类。`CEntity` 继承它。有矩阵走 `m_matrix`，否则走 `m_placement`。"
		},
		{
			"heading": "取位置",
			"content": "无矩阵时用 simple transform。"
		},
		{
			"heading": "设位置",
			"content": "只改坐标不改朝向。"
...
var toc = [
	{
		depth: 2,
		url: "#取位置",
		title: jsx(Fragment, { children: "取位置" })
	},
	{
		depth: 2,
		url: "#设位置",
		title: jsx(Fragment, { children: "设位置" })
	},
	{
		depth: 2,
		url: "#朝向与航向",
		title: jsx(Fragment, { children: "朝向与航向" })
	},
	{
		depth: 2,
		url: "#轴向",
		title: jsx(Fragment, { children: "轴向" })
	},
	{
		depth: 2,
		url: "#矩阵分配",
		title: jsx(Fragment, { children: "矩阵分配" })
	},
	{
		depth: 2,
		url: "#区域判定",
		title: jsx(Fragment, { children: "区域判定" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CPlaceable.h" }) }),
		"\n",
		jsxs(_components.p, { children: [
			"位置 / 朝向基类。",
			jsx(_components.code, { children: "CEntity" }),
			" 继承它。有矩阵走 ",
			jsx(_components.code, { children: "m_matrix" }),
			"，否则走 ",
			jsx(_components.code, { children: "m_placement" }),
			"。"
		] }),
		"\n",
		jsx(_components.h2, {
		...
		"\n",
		jsxs(Api, {
			name: "GetPosition / m_placement / m_matrix",
			children: [jsx(_components.p, { children: "无矩阵时用 simple transform。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "CSimpleTransform m_placement;"
									})
								}),
								"\n",
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// GetPosition() 内联：有 matrix 取 matrix 位，否则 m_placement.m_vPosn"
									})
								})
							] })
						}) })
		...
		jsxs(Api, {
			name: "SetPosn",
			children: [jsx(_components.p, { children: "只改坐标不改朝向。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsxs(Api, {
			name: "SetHeading / GetHeading / SetOrientation",
			children: [jsx(_components.p, { children: "参数为弧度。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsxs(Api, {
			name: "GetRight / GetForward / GetUp",
			children: [jsx(_components.p, { children: "需要已分配矩阵。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsx(Api, {
			name: "GetMatrix / AllocateMatrix / SetMatrix",
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// 改 m 后实体位姿跟着变；复杂场景优先走游戏 API"
									})
								})
							] })
						}) })
		...
		jsxs(Api, {
			name: "IsWithinArea",
			children: [jsx(_components.p, { children: "2D / 3D 矩形盒。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",

...
//#region content/docs/cleo/sa/ext/sampfuncs/object.mdx?collection=docs
var frontmatter = {
	"title": "物体 Object",
...
var toc = [{
	depth: 2,
	url: "#物体-id",
	title: jsx(Fragment, { children: "物体 ID" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0B52",
			name: "SAMP_GET_OBJECT_ID",
			member: "Object.GetSampId",
			children: [jsx(_components.p, { children: "按物体句柄返回 SA-MP 物体 ID。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B52 SAMP_GET_OBJECT_ID" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

...
//#region content/docs/cleo/sa/ext/newopcodes/draw.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "射线 ColPoint、2D shape、TXD、串操作。写法见 Lua / Redux。"
		},
		{
			"heading": "colpoint",
			"content": "两点射线检测，可滤建筑/车/人/物等。"
		},
		{
			"heading": "colpoint",
			"content": "从 ColPoint 取法线。"
		},
		{
			"heading": "colpoint",
			"content": "取表面类型。"
		...
		{
			"heading": "shape-绘制",
			"content": "画 2D 多边形（图元类型、贴图、顶点缓冲、混合）。"
		},
		{
			"heading": "shape-绘制",
			"content": "配置 shape 某个顶点（位置/RHW/色/UV/翻转）。"
		},
		{
			"heading": "shape-绘制",
			"content": "绕轴点旋转 shape 顶点。"
		},
		{
			"heading": "txd--模型",
			"content": "从文件加载 TXD 并注册名。用在 `if` 里。"
		},
		{
			"heading": "txd--模型",
			"content": "取已注册 TXD 槽 id。"
		},
		{
			"heading": "txd--模型",
			"content": "在命名字典里按贴图名找指针。用在 `if` 里。"
		},
		{
			"heading": "txd--模型",
			"content": "在槽 id 字典里找贴图。用在 `if` 里。"
		},
		{
			"heading": "txd--模型",
			"content": "模型使用的 TXD 槽。用在 `if` 里。"
		},
		{
			"heading": "txd--模型",
			"content": "模型 CRC32 key。用在 `if` 里。"
		},
		{
			"heading": "字符串",
			"content": "比较两串；相等条件真。用在 `if` 里。"
		},
		{
			"heading": "字符串",
			"content": "把 `append` 接到 `string` 缓冲。"
		},
		{
			"heading": "字符串",
			"content": "找子串，返回指针或失败。用在 `if` 里。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#colpoint",
		title: jsx(Fragment, { children: "ColPoint" })
	},
	{
		depth: 2,
		url: "#shape-绘制",
		title: jsx(Fragment, { children: "Shape 绘制" })
	},
	{
		depth: 2,
		url: "#txd--模型",
		title: jsx(Fragment, { children: "TXD / 模型" })
	},
	{
		depth: 2,
		url: "#字符串",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		"\n",
		jsxs(_components.p, { children: [
			"射线 ColPoint、2D shape、TXD、串操作。写法见 ",
			jsx(_components.a, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "两点射线检测，可滤建筑/车/人/物等。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: fromX..toZ, buildings, vehicles, peds, objects, dummies, seeThroughCheck, cameraIgnoreCheck, shotThroughCheck, entityToIgnore" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: colPoint, outX, outY, outZ, entity" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0D3B",
			name: "GET_COL_DATA_NORMAL_VECTOR",
			children: [jsx(_components.p, { children: "从 ColPoint 取法线。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D3B GET_COL_DATA_NORMAL_VECTOR" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: colPoint" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " getColDataNormalVector"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			id: "0D3C",
			name: "GET_COL_DATA_SURFACE",
			children: [jsx(_components.p, { children: "取表面类型。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D3C GET_COL_DATA_SURFACE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: surface" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0D3D",
			name: "GET_COL_DATA_LIGHTING",
			children: [jsx(_components.p, { children: "取光照打包值。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D3D GET_COL_DATA_LIGHTING" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0D3E",
			name: "GET_COL_DATA_DEPTH",
			children: [jsx(_components.p, { children: "取 depth。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D3E GET_COL_DATA_DEPTH" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0D40",
			name: "DRAW_SHAPE",
			children: [jsx(_components.p, { children: "画 2D 多边形（图元类型、贴图、顶点缓冲、混合）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D40 DRAW_SHAPE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: type, texture, numVerts, pVerts, vertexAlpha, srcBlend, dstBlend, unused" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: ", type, texture, numVerts, pVerts, vertexAlpha, srcBlend, dstBlend, unused)"
									})
								]
							}) })
						}) })
		...
		jsxs(Opcode, {
			id: "0D41",
			name: "SETUP_SHAPE_VERTEX",
			children: [jsx(_components.p, { children: "配置 shape 某个顶点（位置/RHW/色/UV/翻转）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D41 SETUP_SHAPE_VERTEX" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: shape, vertex, x, y, z, rhw, r, g, b, a, u, v, invertX, invertY" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: ", shape, vertex, x, y, z, rhw, r, g, b, a, u, v, invertX, invertY)"
									})
								]
							}) })
						}) })
		...
		jsxs(Opcode, {
			id: "0D45",
			name: "ROTATE_SHAPE_VERTICES",
			children: [jsx(_components.p, { children: "绕轴点旋转 shape 顶点。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D45 ROTATE_SHAPE_VERTICES" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: shape, numVerts, x, y, angle" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: ", shape, numVerts, x, y, angle)"
									})
								]
							}) })
						}) })
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D42 LOAD_TXD" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: txd, path" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0D43",
			name: "GET_TXD_ID",
			children: [jsx(_components.p, { children: "取已注册 TXD 槽 id。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D43 GET_TXD_ID" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: txd" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0D44",
			name: "FIND_TEXTURE_IN_TXD_WITH_NAME",
			children: [jsxs(_components.p, { children: [
				"在命名字典里按贴图名找指针。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D44 FIND_TEXTURE_IN_TXD_WITH_NAME" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: texture, dictionary" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " findTextureInTxdWithName"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			id: "0D46",
			name: "FIND_TEXTURE_IN_TXD_WITH_ID",
			children: [jsxs(_components.p, { children: [
				"在槽 id 字典里找贴图。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D46 FIND_TEXTURE_IN_TXD_WITH_ID" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " findTextureInTxdWithId"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D47 GET_MODEL_TXD_ID" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: txdId" })
								})
							] })
						}) })
					}),
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D48 GET_MODEL_CRC" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: crc32Key" })
								})
							] })
						}) })
					}),
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D49 STRING_CMP" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: strA, strB" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			children: [jsxs(_components.p, { children: [
				"把 ",
				jsx(_components.code, { children: "append" }),
				" 接到 ",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D4A STRING_CAT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: string, append" })
								})
							] })
						}) })
					}),
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D4B STRING_STR" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: string, substring" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

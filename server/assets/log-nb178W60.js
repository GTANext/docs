...
//#region content/docs/xbase/log.mdx?collection=docs
var frontmatter = {
	"title": "Log",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`include/XBase/Log.h` · `XBase::Log`"
		},
		{
			"heading": void 0,
			"content": "`Level` 枚举: `Debug`, `Info`, `Warn`, `Error`"
		},
		{
			"heading": void 0,
			"content": "`Entry` 结构: `Level level`, `std::string message`, `std::chrono::system_clock::time_point timestamp`"
		},
		{
			"heading": void 0,
			"content": "线程安全，写入 `[YYYY-MM-DD HH:MM:SS] [LEVEL] message` 格式日志。"
		}
	],
	"headings": []
};
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "include/XBase/Log.h" }),
			" · ",
			jsx(_components.code, { children: "XBase::Log" })
		] }),
		"\n",
				...
				jsxs(_components.span, {
					...
					children: [
						...
						jsx(_components.span, {
							...
							children: "  // 默认 <模块目录>\\XBase\\logs\\xbase.log"
						})
					]
				}),
				"\n",
		...
		jsxs(_components.ul, { children: [
			...
			jsxs(_components.li, { children: [
				jsx(_components.code, { children: "Level" }),
				" 枚举: ",
				jsx(_components.code, { children: "Debug" }),
				", ",
				jsx(_components.code, { children: "Info" }),
				", ",
				jsx(_components.code, { children: "Warn" }),
				", ",
			...
			jsxs(_components.li, { children: [
				...
				" 结构: ",
				jsx(_components.code, { children: "Level level" }),
				", ",
				jsx(_components.code, { children: "std::string message" }),
				", ",
				jsx(_components.code, { children: "std::chrono::system_clock::time_point timestamp" })
			] }),
			"\n",
			jsxs(_components.li, { children: [
				"线程安全，写入 ",
				jsx(_components.code, { children: "[YYYY-MM-DD HH:MM:SS] [LEVEL] message" }),
				" 格式日志。"
			] }),
			"\n"
		] })

...
//#region content/docs/plugins/pattern.mdx?collection=docs
var frontmatter = {
	"title": "特征码 Pattern",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`shared/Pattern.h` · `plugin::pattern`"
		},
		{
			"heading": void 0,
			"content": "用十六进制字节串在模块里定位地址。空格分隔，`?` 表示通配。结果会缓存；找不到时返回 `0`。"
		},
		{
			"heading": void 0,
			"content": "搜到的地址通常交给 `CallDyn*` 或 `plugin::patch`。调用前务必判断非零。"
		},
		{
			"heading": "主模块搜索",
			"content": "在主模块中搜索特征串。`offset` 加在匹配起始地址上（可用来跳到指令中部或相对偏移处）。"
		},
		{
			"heading": "指定模块搜索",
			"content": "在指定模块映像中搜索，例如外部 DLL。"
		},
		{
			"heading": "匹配后读内存",
			"content": "先按特征定位，再从 `offset` 处按类型读取（常见：读绝对地址 / 函数指针）。"
		},
		{
			"heading": "宏简写",
			"content": "常用简写：`gpattern` 等价 `Get(..., 0)`；`gpatternt` 等价 `Read`。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#主模块搜索",
		title: jsx(Fragment, { children: "主模块搜索" })
	},
	{
		depth: 2,
		url: "#指定模块搜索",
		title: jsx(Fragment, { children: "指定模块搜索" })
	},
	{
		depth: 2,
		url: "#匹配后读内存",
		title: jsx(Fragment, { children: "匹配后读内存" })
	},
	{
		depth: 2,
		url: "#宏简写",
		title: jsx(Fragment, { children: "宏简写" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "shared/Pattern.h" }),
			" · ",
			jsx(_components.code, { children: "plugin::pattern" })
		] }),
		"\n",
		jsxs(_components.p, { children: [
			"用十六进制字节串在模块里定位地址。空格分隔，",
		...
		jsx(Fragment, { children: jsx(_components.pre, {
			...
			children: jsx(_components.code, { children: jsx(_components.span, {
				className: "line",
				children: jsx(_components.span, { children: "\"89 86 ? ? ? ? 8B 0D\"" })
			}) })
		}) }),
		"\n",
		jsx(Callout, {
		...
		jsxs(Api, {
			name: "Get",
			header: "plugin::pattern",
			children: [jsxs(_components.p, { children: [
				"在主模块中搜索特征串。",
				jsx(_components.code, { children: "offset" }),
				" 加在匹配起始地址上（可用来跳到指令中部或相对偏移处）。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		jsxs(Api, {
			name: "GetExternal",
			header: "plugin::pattern",
			children: [jsx(_components.p, { children: "在指定模块映像中搜索，例如外部 DLL。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsxs(Api, {
			name: "Read / ReadExternal",
			header: "plugin::pattern",
			children: [jsxs(_components.p, { children: [
				"先按特征定位，再从 ",
				jsx(_components.code, { children: "offset" }),
				" 处按类型读取（常见：读绝对地址 / 函数指针）。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsxs(Api, {
			name: "gpattern / gpatternt",
			header: "宏",
			children: [jsxs(_components.p, { children: [
				"常用简写：",
				jsx(_components.code, { children: "gpattern" }),
				" 等价 ",
				jsx(_components.code, { children: "Get(..., 0)" }),
				"；",
				jsx(_components.code, { children: "gpatternt" }),
				" 等价 ",
				jsx(_components.code, { children: "Read" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [

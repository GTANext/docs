...
//#region content/docs/cleo/sa/ext/sampfuncs/char.mdx?collection=docs
var frontmatter = {
	"title": "角色 Char",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "共 1 条。调用见 Lua / Redux。"
		},
		{
			"heading": "玩家-id",
			"content": "返回控制该角色句柄的 SA-MP 玩家 ID；无人控制则返回 -1。"
		}
	],
	"headings": [{
		"id": "玩家-id",
...
var toc = [{
	depth: 2,
	url: "#玩家-id",
	title: jsx(Fragment, { children: "玩家 ID" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0B2B",
			name: "SAMP_GET_PLAYER_ID",
			member: "Char.GetSampId",
			children: [jsx(_components.p, { children: "返回控制该角色句柄的 SA-MP 玩家 ID；无人控制则返回 -1。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B2B SAMP_GET_PLAYER_ID" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: idAsHandle" })
								})
							] })
						}) })
					}),

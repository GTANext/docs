...
//#region content/docs/cleo/sa/default/mission.mdx?collection=docs
var frontmatter = {
	"title": "任务 Mission",
	"description": "任务启动与收尾"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "任务收尾",
			"content": "收尾任务 / 脚本里常见的一批状态重置。"
		},
		{
			"heading": "加载并启动",
			"content": "按 main.scm 头里的任务表下标加载并启动任务。"
		},
		{
			"heading": "失败当前任务",
			"content": "跑当前任务的清理逻辑并失败收场。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#任务收尾",
		title: jsx(Fragment, { children: "任务收尾" })
	},
	{
		depth: 2,
		url: "#加载并启动",
		title: jsx(Fragment, { children: "加载并启动" })
	},
	{
		depth: 2,
		url: "#失败当前任务",
		title: jsx(Fragment, { children: "失败当前任务" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Mission.Finish",
			children: [jsx(_components.p, { children: "收尾任务 / 脚本里常见的一批状态重置。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "00D8 MISSION_HAS_FINISHED" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
		...
		jsxs(Opcode, {
			...
			member: "Mission.LoadAndLaunchInternal",
			children: [jsx(_components.p, { children: "按 main.scm 头里的任务表下标加载并启动任务。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0417 LOAD_AND_LAUNCH_MISSION_INTERNAL" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "loadAndLaunchMissionInternal"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "loadAndLaunchInternal"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Mission.Fail",
			children: [jsx(_components.p, { children: "跑当前任务的清理逻辑并失败收场。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "045C FAIL_CURRENT_MISSION" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {

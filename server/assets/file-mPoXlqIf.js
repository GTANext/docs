...
//#region content/docs/cleo/gta3/file.mdx?collection=docs
var frontmatter = {
	"title": "文件 File / Fs",
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#读文件",
		title: jsx(Fragment, { children: "读文件" })
	},
	{
		depth: 2,
		url: "#写文件",
		title: jsx(Fragment, { children: "写文件" })
	},
	{
		depth: 2,
		url: "#文件是否存在",
	...
	},
	{
		depth: 2,
		url: "#文件指针移动",
		title: jsx(Fragment, { children: "文件指针移动" })
	},
	{
		depth: 2,
		url: "#是否到文件尾",
		title: jsx(Fragment, { children: "是否到文件尾" })
	},
	{
		depth: 2,
		url: "#读字符串",
	...
	},
	{
		depth: 2,
		url: "#格式化写文件",
		title: jsx(Fragment, { children: "格式化写文件" })
	},
	{
		depth: 2,
		url: "#扫描文件",
	...
	},
	{
		depth: 2,
		url: "#查找首个文件",
		title: jsx(Fragment, { children: "查找首个文件" })
	},
	{
		depth: 2,
		url: "#查找下一个文件",
		title: jsx(Fragment, { children: "查找下一个文件" })
	},
	{
		depth: 2,
		url: "#关闭查找",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "设工作目录。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
		...
		jsxs(Opcode, {
			...
			name: "OPEN_FILE",
			member: "File.Open",
			children: [jsx(_components.p, { children: "打开文件。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			name: "CLOSE_FILE",
			member: "File.Close",
			children: [jsx(_components.p, { children: "关闭文件。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			name: "GET_FILE_SIZE",
			member: "File.GetSize",
			children: [jsx(_components.p, { children: "文件大小。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			name: "READ_FROM_FILE",
			member: "File.Read",
			children: [jsx(_components.p, { children: "读字节。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			name: "WRITE_TO_FILE",
			member: "File.Write",
			children: [jsx(_components.p, { children: "写字节。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "文件是否存在。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			name: "FILE_SEEK",
			member: "File.Seek",
			children: [jsx(_components.p, { children: "移动文件指针。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "是否 EOF。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "读一行字符串。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "写字符串。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "格式化写文件。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			name: "SCAN_FILE",
			member: "File.Scan",
			children: [jsx(_components.p, { children: "fscanf。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "目录是否存在。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "创建目录。条件表示是否成功。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "关闭查找句柄。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {

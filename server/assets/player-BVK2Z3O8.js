...
//#region content/docs/plugins/entities/player.mdx?collection=docs
var frontmatter = {
	"title": "玩家 FindPlayer*",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`common.h` · SA 高频"
		},
		{
			"heading": void 0,
			"content": "未进档时指针常 null，先判空。"
		},
		{
			"heading": "取玩家-ped",
			"content": "`playerId = -1` 为本机。"
		},
		{
			"heading": "取玩家载具",
			"content": "不在车返回 null。"
...
var toc = [
	{
		depth: 2,
		url: "#取玩家-ped",
		title: jsx(Fragment, { children: "取玩家 ped" })
	},
	{
		depth: 2,
		url: "#取玩家载具",
		title: jsx(Fragment, { children: "取玩家载具" })
	},
	{
		depth: 2,
		url: "#取坐标速度朝向",
		title: jsx(Fragment, { children: "取坐标速度朝向" })
	},
	{
		depth: 2,
		url: "#取玩家实体与世界中心",
		title: jsx(Fragment, { children: "取玩家实体与世界中心" })
	},
	{
		depth: 2,
		url: "#取通缉对象",
		title: jsx(Fragment, { children: "取通缉对象" })
	},
	{
		depth: 2,
		url: "#双人模式",
		title: jsx(Fragment, { children: "双人模式" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [jsx(_components.code, { children: "common.h" }), " · SA 高频"] }),
		"\n",
		jsx(_components.p, { children: "未进档时指针常 null，先判空。" }),
		"\n",
		jsx(_components.h2, {
			id: "取玩家-ped",
			children: "取玩家 ped"
		...
		jsxs(Api, {
			name: "FindPlayerPed",
			children: [jsxs(_components.p, { children: [jsx(_components.code, { children: "playerId = -1" }), " 为本机。"] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		"\n",
		jsxs(Api, {
			name: "FindPlayerVehicle",
			children: [jsx(_components.p, { children: "不在车返回 null。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsx(Api, {
			name: "FindPlayerCoors / FindPlayerSpeed / FindPlayerHeading",
		...
		"\n",
		jsxs(Api, {
			name: "FindPlayerEntity / FindPlayerCentreOfWorld",
			children: [jsx(_components.p, { children: "变体去掉瞄准 / 室内偏移。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " FindPlayerCentreOfWorld"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " FindPlayerCentreOfWorld_NoSniperShift"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " FindPlayerCentreOfWorld_NoInteriorShift"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",

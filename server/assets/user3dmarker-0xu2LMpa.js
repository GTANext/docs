...
//#region content/docs/cleo/sa/default/user3dmarker.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "创建",
			"content": "创建类似黄色入口标记的 3D 标记。"
		},
		{
			"heading": "删除",
			"content": "删掉 `0A40` 建的标记。"
		}
	],
	"headings": [{
		"id": "创建",
...
var toc = [{
	depth: 2,
	url: "#创建",
	title: jsx(Fragment, { children: "创建" })
}, {
	depth: 2,
	url: "#删除",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "User3DMarker.Create",
			children: [jsx(_components.p, { children: "创建类似黄色入口标记的 3D 标记。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0A40 CREATE_USER_3D_MARKER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: x, y, z, color" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "User3DMarker.Remove",
			children: [jsxs(_components.p, { children: [
				"删掉 ",
				jsx(_components.code, { children: "0A40" }),
				" 建的标记。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0A41 REMOVE_USER_3D_MARKER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

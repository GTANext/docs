...
//#region content/docs/plugins/entities/world-state.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "全局游戏态。改全局表要备份还原，别每帧无脑写。"
		},
		{
			"heading": "锁定游戏时钟",
			"content": "冻时间每帧写回；或用 `SetGameClock` / `StoreClock` / `RestoreClock`。"
		},
		{
			"heading": "强制天气",
			"content": "也可用 Command `FORCE_WEATHER`。"
		},
		{
			"heading": "改武器全局参数",
			"content": "改的是全局表。实例弹药见 CWeapon。"
		},
		{
			"heading": "改武器全局参数",
			"content": "Command 写法："
...
var toc = [
	{
		depth: 2,
		url: "#锁定游戏时钟",
		title: jsx(Fragment, { children: "锁定游戏时钟" })
	},
	{
		depth: 2,
		url: "#强制天气",
	...
	},
	{
		depth: 2,
		url: "#读当前天气强度",
		title: jsx(Fragment, { children: "读当前天气强度" })
	},
	{
		depth: 2,
		url: "#预报天气",
		title: jsx(Fragment, { children: "预报天气" })
	},
	{
		depth: 2,
		url: "#改武器全局参数",
		title: jsx(Fragment, { children: "改武器全局参数" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: "全局游戏态。改全局表要备份还原，别每帧无脑写。" }),
		"\n",
		jsx(_components.h2, {
			id: "锁定游戏时钟",
			children: "锁定游戏时钟"
		...
		"\n",
		jsxs(Api, {
			name: "CClock::ms_nGameClockHours / SetGameClock",
			children: [jsxs(_components.p, { children: [
				"冻时间每帧写回；或用 ",
				jsx(_components.code, { children: "SetGameClock" }),
				" / ",
				jsx(_components.code, { children: "StoreClock" }),
				" / ",
				jsx(_components.code, { children: "RestoreClock" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// 一次性：CClock::SetGameClock(12, 0, CClock::ms_nGameClockDays);"
									})
								})
							] })
						}) })
		...
		"\n",
		jsxs(Api, {
			name: "CWeather::ForceWeather / ForceWeatherNow",
			children: [jsxs(_components.p, { children: [
				"也可用 Command ",
				jsx(_components.code, { children: "FORCE_WEATHER" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// CWeather::ReleaseWeather();"
									})
								})
							] })
						}) })
		...
		"\n",
		jsx(Api, {
			name: "Rain / Sandstorm / Wind / Foggyness",
		...
		"\n",
		jsx(Api, {
			name: "ForecastWeather / SetWeatherToAppropriateTypeNow",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " SetWeatherToAppropriateTypeNow"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// CWeather::ForecastWeather(weatherId, 1);"
								})
							}) })
						}) })
					})
		...
		"\n",
		jsxs(Api, {
			name: "CWeaponInfo::GetWeaponInfo",
			children: [jsxs(_components.p, { children: [
				"改的是全局表。实例弹药见 ",
				jsx(_components.a, {
		...
		"\n",
		jsx(_components.p, { children: "Command 写法：" }),
		"\n",

...
//#region content/docs/plugins/utils/text-error.mdx?collection=docs
var frontmatter = {
	"title": "文本与报错",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`TextLoader.h` / `StringUtils.h` / `Error.h`"
		},
		{
			"heading": "加载键值文本",
			"content": "SA 上 `Get` 返回 `char*`；III / VC 为 `wchar_t*`（见头文件 `char_t`）。"
		},
		{
			"heading": "窄转宽写固定缓冲",
			"content": "命名空间 `StringUtils`（不在 `plugin::`）。超出长度会截断。"
		},
		{
			"heading": "弹窗提示与报错",
			"content": "`Message` / `Error` / `Warning` 走 MessageBox，适合调试。`Error` 返回 `false`，可写 `return Error(...)`。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#加载键值文本",
		title: jsx(Fragment, { children: "加载键值文本" })
	},
	{
		depth: 2,
		url: "#字符映射替换",
		title: jsx(Fragment, { children: "字符映射替换" })
	},
	{
		depth: 2,
		url: "#窄转宽写固定缓冲",
		title: jsx(Fragment, { children: "窄转宽写固定缓冲" })
	},
	{
		depth: 2,
		url: "#弹窗提示与报错",
		title: jsx(Fragment, { children: "弹窗提示与报错" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "TextLoader.h" }),
			" / ",
			jsx(_components.code, { children: "StringUtils.h" }),
			" / ",
			jsx(_components.code, { children: "Error.h" })
		] }),
		"\n",
		jsx(_components.h2, {
			id: "加载键值文本",
		...
		jsxs(_components.p, { children: [
			...
			" 返回 ",
			jsx(_components.code, { children: "char*" }),
			"；III / VC 为 ",
			jsx(_components.code, { children: "wchar_t*" }),
			"（见头文件 ",
			jsx(_components.code, { children: "char_t" }),
			"）。"
		] }),
		"\n",
		jsxs(CodeBlockTabs, {
		...
		jsxs(_components.p, { children: [
			"命名空间 ",
			jsx(_components.code, { children: "StringUtils" }),
			"（不在 ",
		...
		jsxs(_components.p, { children: [
			...
			" / ",
			jsx(_components.code, { children: "Warning" }),
			" 走 MessageBox，适合调试。",
			jsx(_components.code, { children: "Error" }),
			" 返回 ",
			jsx(_components.code, { children: "false" }),
			"，可写 ",
			jsx(_components.code, { children: "return Error(...)" }),
			"。"
		] }),
		"\n",
		jsxs(CodeBlockTabs, {
						...
						children: jsxs(_components.code, { children: [
							...
							jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// Error / Warning / Internal* 等同理"
								})
							})
						] })
					}) })

...
//#region content/docs/plugins/entities/world.mdx?collection=docs
var frontmatter = {
	"title": "世界 CWorld",
...
var toc = [
	{
		depth: 2,
		url: "#贴地高度",
		title: jsx(Fragment, { children: "贴地高度" })
	},
	{
		depth: 2,
		url: "#视线是否畅通",
		title: jsx(Fragment, { children: "视线是否畅通" })
	},
	{
		depth: 2,
		url: "#射线检测",
		title: jsx(Fragment, { children: "射线检测" })
	},
	{
		depth: 2,
		url: "#半径内找实体",
		title: jsx(Fragment, { children: "半径内找实体" })
	},
	{
		depth: 2,
		url: "#清空区域实体",
		title: jsx(Fragment, { children: "清空区域实体" })
	},
	{
		depth: 2,
		url: "#爆炸与着火",
		title: jsx(Fragment, { children: "爆炸与着火" })
	},
	{
		depth: 2,
		url: "#实体进出世界",
		title: jsx(Fragment, { children: "实体进出世界" })
	},
	{
		depth: 2,
		url: "#灭区域车火",
		title: jsx(Fragment, { children: "灭区域车火" })
	},
	{
		depth: 2,
		url: "#区域清热闹内容",
		title: jsx(Fragment, { children: "区域清热闹内容" })
	},
	{
		depth: 2,
		url: "#球测碰撞",
		title: jsx(Fragment, { children: "球测碰撞" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CWorld.h" }) }),
		"\n",
		jsx(_components.h2, {
			id: "贴地高度",
			children: "贴地高度"
		...
		"\n",
		jsx(Api, {
			name: "FindGroundZForCoord / FindRoofZFor3DCoord",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " FindGroundZFor3DCoord"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetIsLineOfSightClear"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsxs(Api, {
			name: "ProcessLineOfSight / ProcessVerticalLine",
			children: [jsx(_components.p, { children: "写出碰撞点。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		jsxs(Api, {
			...
			children: [jsx(_components.p, { children: "计数 + 缓冲。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsx(Api, {
			name: "ClearPedsFromArea / ClearCarsFromArea",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsx(Api, {
			name: "TriggerExplosion / SetWorldOnFire",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " processVehicleBombTimer"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Api, {
			name: "Add / Remove",
			children: [jsx(_components.p, { children: "自己 new 的才需要。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsx(Api, {
			name: "ExtinguishAllCarFiresInArea / SetAllCarsCanBeDamaged",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " ExtinguishAllCarFiresInArea"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Api, {
			...
			children: [jsx(_components.p, { children: "含可选弹道阴影。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " ClearExcitingStuffFromArea"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
									...
									jsx(_components.span, {
										...
										children: " bRemoveProjectilesAndShadows"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		"\n",
		jsxs(Api, {
			name: "TestSphereAgainstWorld",
			children: [jsx(_components.p, { children: "返回命中实体。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " TestSphereAgainstWorld"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",

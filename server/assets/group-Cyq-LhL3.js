...
//#region content/docs/cleo/sa/default/group.mdx?collection=docs
var frontmatter = {
	"title": "小组 Group",
	"description": "角色组"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "共 12 条。写法见 Lua / Redux。"
		},
		{
			"heading": "创建",
			"content": "创建角色组（可统一指挥多名角色）。"
		},
		{
			"heading": "设组长",
			"content": "设组长。"
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#设组长",
		title: jsx(Fragment, { children: "设组长" })
	},
	{
		depth: 2,
		url: "#加组员",
		title: jsx(Fragment, { children: "加组员" })
	},
	{
		depth: 2,
		url: "#释放",
		title: jsx(Fragment, { children: "释放" })
	},
	{
		depth: 2,
		url: "#决策器",
		title: jsx(Fragment, { children: "决策器" })
	},
	{
		depth: 2,
		url: "#分离距离",
		title: jsx(Fragment, { children: "分离距离" })
	},
	{
		depth: 2,
		url: "#默认任务分配",
		title: jsx(Fragment, { children: "默认任务分配" })
	},
	{
		depth: 2,
		url: "#组规模",
		title: jsx(Fragment, { children: "组规模" })
	},
	{
		depth: 2,
		url: "#是否存在",
	...
	},
	{
		depth: 2,
		url: "#组序列",
		title: jsx(Fragment, { children: "组序列" })
	},
	{
		depth: 2,
		url: "#取组员",
		title: jsx(Fragment, { children: "取组员" })
	},
	{
		depth: 2,
		url: "#跟随上车",
		title: jsx(Fragment, { children: "跟随上车" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			name: "CREATE_GROUP",
			member: "Group.Create",
			children: [jsx(_components.p, { children: "创建角色组（可统一指挥多名角色）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "062F CREATE_GROUP" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: defaultTaskAllocator" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Group.SetLeader",
			children: [jsx(_components.p, { children: "设组长。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0630 SET_GROUP_LEADER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Group.SetMember",
			children: [jsx(_components.p, { children: "加人作组员。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0631 SET_GROUP_MEMBER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			name: "REMOVE_GROUP",
			member: "Group.Remove",
			children: [jsx(_components.p, { children: "释放组。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0632 REMOVE_GROUP" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Group.SetDecisionMaker",
			children: [jsx(_components.p, { children: "设组决策器。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "06AD SET_GROUP_DECISION_MAKER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, handleOrTemplate" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "setGroupDecisionMaker"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "(self, handleOrTemplate)"
									})
								]
							}) })
						}) })
		...
		jsxs(Opcode, {
			...
			member: "Group.SetSeparationRange",
			children: [jsx(_components.p, { children: "组员离组长多远会被踢出组。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "06F0 SET_GROUP_SEPARATION_RANGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, range" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "setGroupSeparationRange"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Group.SetDefaultTaskAllocator",
			children: [jsx(_components.p, { children: "设默认任务分配器。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07B3 SET_GROUP_DEFAULT_TASK_ALLOCATOR" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, defaultTaskAllocator" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "setGroupDefaultTaskAllocator"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "setDefaultTaskAllocator"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
										...
										children: "(self, defaultTaskAllocator)"
									})
								]
							}) })
						}) })
		...
		jsxs(Opcode, {
			id: "07F6",
			name: "GET_GROUP_SIZE",
			member: "Group.GetSize",
			children: [jsx(_components.p, { children: "取组长数与组员数。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07F6 GET_GROUP_SIZE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: numLeaders, numMembers" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " numLeaders, numMembers "
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#D73A49",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07FD DOES_GROUP_EXIST" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Group.SetSequence",
			children: [jsx(_components.p, { children: "组员默认任务序列。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "087D SET_GROUP_SEQUENCE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, sequence" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "取第 n 个组员。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "092B GET_GROUP_MEMBER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, slotId" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Group.SetFollowStatus",
			children: [jsx(_components.p, { children: "组长上车时组员是否跟着上。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0940 SET_GROUP_FOLLOW_STATUS" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

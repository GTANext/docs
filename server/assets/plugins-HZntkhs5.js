...
//#region content/docs/plugins/index.mdx?collection=docs
var frontmatter = {
	"title": "综述",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "plugin-sdk 的 **ASI 高频精选**。对着本地头文件写，本站不替代完整源码树。"
		},
		{
			"heading": void 0,
			"content": "单页结构约定：模块说明 → 功能小节 → 说明 + 签名 + 调用。下面提供可直接抄的组合示例；单个 API 见侧栏各页。"
		},
		{
			"heading": void 0,
			"content": "C++ ASI 在本区。CLEO / CLEO+ 的 **opcode 调用**（Lua / Redux，`0A8C` 一类）见 CLEO。"
		},
		{
			"heading": "覆盖范围",
			"content": "状态"
		...
		{
			"heading": "覆盖范围",
			"content": "核心 / 扩展 / 工具 / Extender / 实体 / 组合"
		},
		{
			"heading": "覆盖范围",
			"content": "**边界**"
		...
		{
			"heading": "覆盖范围",
			"content": "Task/Event 全家桶、全 `CAE*`、VC/III 游戏类全文、`ScriptCommands` 全枚举 **不扩**"
		},
		{
			"heading": "覆盖范围",
			"content": "**未收录**"
		...
		{
			"heading": "覆盖范围",
			"content": "`game_sa` 长尾头；`injector` / `hooking` / `safetyhook` 底层栈"
		},
		{
			"heading": "覆盖范围",
			"content": "仓库：DK22Pac/plugin-sdk"
		},
		{
			"heading": "覆盖范围",
			"content": "宏"
		...
		{
			"heading": "导航",
			"content": "<Card title=\"PluginBase / Call\" href=\"/docs/plugins/plugin-base\" description=\"Call · CallDyn · Method · VMT 与选型表\" />"
		},
		{
			"heading": "导航",
			"content": "<Card title=\"Events\" href=\"/docs/plugins/events\" description=\"生命周期回调（SA 为主）\" />"
		},
		{
			"heading": "导航",
			"content": "<Card title=\"Patch\" href=\"/docs/plugins/patch\" description=\"内存读写与重定向\" />"
		},
		{
			"heading": "导航",
			"content": "<Card title=\"Pattern\" href=\"/docs/plugins/pattern\" description=\"特征码定位\" />"
		},
		{
			"heading": "导航",
			"content": "<Card title=\"Command\" href=\"/docs/plugins/commands\" description=\"C++ 调 SCM 命令\" />"
		},
		{
			"heading": "导航",
			"content": "<Card title=\"扩展\" href=\"/docs/plugins/extensions\" description=\"路径 / 屏幕 / Config / KeyCheck\" />"
		},
		{
			"heading": "导航",
			"content": "<Card title=\"工具\" href=\"/docs/plugins/utils\" description=\"精灵 / 音频 / 着色器等\" />"
		},
		{
			"heading": "导航",
			"content": "<Card title=\"Extender\" href=\"/docs/plugins/extender\" description=\"Ped / Vehicle / Object 附加数据\" />"
		},
		{
			"heading": "导航",
			"content": "<Card title=\"实体\" href=\"/docs/plugins/entities\" description=\"SA 游戏类 API 综述\" />"
		},
		{
			"heading": "导航",
			"content": "<Card title=\"组合\" href=\"/docs/plugins/recipes\" description=\"可抄组合示例\" />"
		},
		{
			"heading": "最小-asi",
			"content": "全局构造里 **只注册回调**。真正碰游戏对象，放到事件回调内。"
		},
		{
			"heading": "热键边沿--满血",
			"content": "先 `KeyCheck::Update()`，再用 `CheckJustDown` 取边沿；玩家指针务必判空。"
		},
		{
			"heading": "给武器",
			"content": "在逻辑帧里发武器；模型与枚举以头文件为准。"
		},
		{
			"heading": "command-刷车",
			"content": "模型是异步的：`REQUEST` → 每帧 `HAS_MODEL_LOADED` → `CREATE` → `MARK_MODEL_AS_NO_LONGER_NEEDED`。同帧请求再创建通常会挂。"
		},
		{
			"heading": "patch-可逆开关",
			"content": "改数值前用 `GetFloat` 备份；关闭时写回备份，不要写死「原值」。"
		},
		{
			"heading": "setraw-备份还原",
			"content": "改代码字节同样：先 `GetRaw` 进缓冲，关闭时只写回缓冲。"
		},
		{
			"heading": "pedextendeddata",
			"content": "每行人一份附加数据；配合 Extender（后续文档页）。"
		},
		{
			"heading": "贴图与设备丢失",
			"content": "`shutdownRw` / `d3dLost` 释放，`d3dReset` / 合适的 init 再加载。"
		},
		{
			"heading": "推荐阅读顺序",
			"content": "本页最小 ASI + 热键示例，确认工程能加载"
		},
		{
			"heading": "推荐阅读顺序",
			"content": "Events 弄清回调该挂在哪一帧"
		},
		{
			"heading": "推荐阅读顺序",
			"content": "需要调游戏函数时看 PluginBase / Call"
		},
		{
			"heading": "推荐阅读顺序",
			"content": "改内存 / 找地址： Patch、Pattern"
		},
		{
			"heading": "推荐阅读顺序",
			"content": "走脚本命令： Command"
		}
	],
	"headings": [
		{
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#最小-asi",
		title: jsx(Fragment, { children: "最小 ASI" })
	},
	{
		depth: 2,
		url: "#热键边沿--满血",
		title: jsx(Fragment, { children: "热键边沿 + 满血" })
	},
	{
		depth: 2,
		url: "#给武器",
		title: jsx(Fragment, { children: "给武器" })
	},
	{
		depth: 2,
		url: "#command-刷车",
		title: jsx(Fragment, { children: "Command 刷车" })
	},
	{
		depth: 2,
		url: "#patch-可逆开关",
		title: jsx(Fragment, { children: "patch 可逆开关" })
	},
	{
		depth: 2,
		url: "#setraw-备份还原",
		title: jsx(Fragment, { children: "SetRaw 备份还原" })
	},
	{
		depth: 2,
		url: "#pedextendeddata",
		title: jsx(Fragment, { children: "PedExtendedData" })
	},
	{
		depth: 2,
		url: "#贴图与设备丢失",
		title: jsx(Fragment, { children: "贴图与设备丢失" })
	},
	{
		depth: 2,
		url: "#推荐阅读顺序",
		title: jsx(Fragment, { children: "推荐阅读顺序" })
	}
];
function _createMdxContent(props) {
	const _components = {
		...
		tr: "tr",
		...props.components
	}, { Callout, Card, Cards, Step, Steps } = _components;
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			"plugin-sdk 的 ",
			jsx(_components.strong, { children: "ASI 高频精选" }),
			"。对着本地头文件写，本站不替代完整源码树。"
		] }),
		"\n",
		jsx(_components.p, { children: "单页结构约定：模块说明 → 功能小节 → 说明 + 签名 + 调用。下面提供可直接抄的组合示例；单个 API 见侧栏各页。" }),
		"\n",
		jsx(Callout, {
			type: "warn",
			title: "别混",
			children: jsxs(_components.p, { children: [
				"C++ ASI 在本区。CLEO / CLEO+ 的 ",
		...
		jsxs(_components.table, { children: [jsx(_components.thead, { children: jsxs(_components.tr, { children: [jsx(_components.th, { children: "状态" }), jsx(_components.th, { children: "内容" })] }) }), jsxs(_components.tbody, { children: [
			jsxs(_components.tr, { children: [jsx(_components.td, { children: jsx(_components.strong, { children: "已收录" }) }), jsxs(_components.td, { children: ["核心 / 扩展 / 工具 / Extender / 实体 / ", jsx(_components.a, {
				href: "/docs/plugins/recipes",
				children: "组合"
			})] })] }),
			jsxs(_components.tr, { children: [jsx(_components.td, { children: jsx(_components.strong, { children: "边界" }) }), jsxs(_components.td, { children: [
				"Task/Event 全家桶、全 ",
				jsx(_components.code, { children: "CAE*" }),
				"、VC/III 游戏类全文、",
				jsx(_components.code, { children: "ScriptCommands" }),
				" 全枚举 ",
				jsx(_components.strong, { children: "不扩" })
			] })] }),
			jsxs(_components.tr, { children: [jsx(_components.td, { children: jsx(_components.strong, { children: "未收录" }) }), jsxs(_components.td, { children: [
				jsx(_components.code, { children: "game_sa" }),
				" 长尾头；",
				jsx(_components.code, { children: "injector" }),
				" / ",
				jsx(_components.code, { children: "hooking" }),
				" / ",
		...
		"\n",
		jsxs(_components.p, { children: ["仓库：", jsx(_components.a, {
			href: "https://github.com/DK22Pac/plugin-sdk",
			children: "DK22Pac/plugin-sdk"
		})] }),
		"\n",
		...
		"\n",
		jsxs(_components.table, { children: [jsx(_components.thead, { children: jsxs(_components.tr, { children: [jsx(_components.th, { children: "宏" }), jsx(_components.th, { children: "含义" })] }) }), jsxs(_components.tbody, { children: [jsxs(_components.tr, { children: [jsxs(_components.td, { children: [
			jsx(_components.code, { children: "GTA3" }),
			" / ",
			jsx(_components.code, { children: "GTAVC" }),
			" / ",
			jsx(_components.code, { children: "GTASA" })
		] }), jsx(_components.td, { children: "当前编译目标游戏" })] }), jsxs(_components.tr, { children: [jsx(_components.td, { children: jsx(_components.code, { children: "BY_GAME(iii, vc, sa)" }) }), jsx(_components.td, { children: "三端各取一值" })] })] })] }),
		"\n",
		jsx(_components.h2, {
			id: "导航",
			children: "导航"
		...
		jsxs(Cards, { children: [
			jsx(Card, {
				...
				description: "Call · CallDyn · Method · VMT 与选型表"
			}),
			jsx(Card, {
				title: "Events",
				href: "/docs/plugins/events",
				description: "生命周期回调（SA 为主）"
			}),
			jsx(Card, {
				title: "Patch",
				href: "/docs/plugins/patch",
				description: "内存读写与重定向"
			}),
			jsx(Card, {
				title: "Pattern",
			...
			jsx(Card, {
				...
				description: "C++ 调 SCM 命令"
			}),
			jsx(Card, {
				title: "扩展",
				href: "/docs/plugins/extensions",
				description: "路径 / 屏幕 / Config / KeyCheck"
			}),
			jsx(Card, {
				title: "工具",
				href: "/docs/plugins/utils",
				description: "精灵 / 音频 / 着色器等"
			}),
			jsx(Card, {
				title: "Extender",
		...
		jsxs(_components.p, { children: [
			"全局构造里 ",
			jsx(_components.strong, { children: "只注册回调" }),
			"。真正碰游戏对象，放到事件回调内。"
		] }),
		"\n",
		jsx(Fragment, { children: jsx(_components.pre, {
		...
		jsxs(_components.p, { children: [
			"先 ",
			jsx(_components.code, { children: "KeyCheck::Update()" }),
			"，再用 ",
		...
		"\n",
		jsx(_components.p, { children: "在逻辑帧里发武器；模型与枚举以头文件为准。" }),
		"\n",
		jsx(Fragment, { children: jsx(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		jsxs(_components.p, { children: [
			...
			" → 每帧 ",
			jsx(_components.code, { children: "HAS_MODEL_LOADED" }),
			" → ",
			jsx(_components.code, { children: "CREATE" }),
			" → ",
			jsx(_components.code, { children: "MARK_MODEL_AS_NO_LONGER_NEEDED" }),
			"。同帧请求再创建通常会挂。"
		] }),
		"\n",
		jsx(Fragment, { children: jsx(_components.pre, {
			...
			children: jsxs(_components.code, { children: [
				...
				jsx(_components.span, {
					...
					children: jsx(_components.span, {
						...
						children: "// 开始：g_wait = true; Command REQUEST_MODEL(g_model)"
					})
				}),
				"\n",
				jsx(_components.span, {
					...
					children: jsx(_components.span, {
						...
						children: "// 在 processScriptsEvent 中："
					})
				}),
				"\n",
				jsxs(_components.span, {
		...
		jsxs(_components.p, { children: [
			"改数值前用 ",
			jsx(_components.code, { children: "GetFloat" }),
			" 备份；关闭时写回备份，不要写死「原值」。"
		] }),
		"\n",
		jsx(Fragment, { children: jsx(_components.pre, {
		...
		jsx(_components.h2, {
			id: "setraw-备份还原",
			children: "SetRaw 备份还原"
		}),
		"\n",
		jsxs(_components.p, { children: [
			"改代码字节同样：先 ",
			jsx(_components.code, { children: "GetRaw" }),
			" 进缓冲，关闭时只写回缓冲。"
		] }),
		"\n",
		jsx(Fragment, { children: jsx(_components.pre, {
		...
		jsx(_components.h2, {
			id: "pedextendeddata",
			children: "PedExtendedData"
		}),
		"\n",
		jsx(_components.p, { children: "每行人一份附加数据；配合 Extender（后续文档页）。" }),
		"\n",
		jsx(Fragment, { children: jsx(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
			...
			children: jsxs(_components.code, { children: [
				jsxs(_components.span, {
					...
					children: [jsx(_components.span, {
						...
						children: " \"extender/PedExtender.h\""
					})]
				}),
				"\n",
				jsx(_components.span, { className: "line" }),
		...
		"\n",
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "shutdownRw" }),
			" / ",
			jsx(_components.code, { children: "d3dLost" }),
			" 释放，",
			jsx(_components.code, { children: "d3dReset" }),
			" / 合适的 init 再加载。"
		] }),
		"\n",
		jsx(Fragment, { children: jsx(_components.pre, {
				...
				jsxs(_components.span, {
					...
					children: [
						...
						jsx(_components.span, {
							...
							children: "LoadAllSpritesFromFolder"
						}),
						jsx(_components.span, {
							style: {
								"--shiki-light": "#24292E",
		...
		"\n",
		jsxs(Steps, { children: [
			jsx(Step, { children: jsx(_components.p, { children: "本页最小 ASI + 热键示例，确认工程能加载" }) }),
			jsx(Step, { children: jsxs(_components.p, { children: [jsx(_components.a, {
				href: "/docs/plugins/events",
				children: "Events"
			}), " 弄清回调该挂在哪一帧"] }) }),
			jsx(Step, { children: jsxs(_components.p, { children: ["需要调游戏函数时看 ", jsx(_components.a, {
				href: "/docs/plugins/plugin-base",
				children: "PluginBase / Call"
			})] }) }),
			jsx(Step, { children: jsxs(_components.p, { children: [
				"改内存 / 找地址： ",
				jsx(_components.a, {
					href: "/docs/plugins/patch",
					children: "Patch"
			...
			jsx(Step, { children: jsxs(_components.p, { children: ["走脚本命令： ", jsx(_components.a, {
				href: "/docs/plugins/commands",
				children: "Command"
			})] }) })
		] })

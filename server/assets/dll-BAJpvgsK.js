...
//#region content/docs/cleo/sa/plus/dll.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "取已加载库",
			"content": "取已加载 DLL 地址 / 句柄。用在 `if` 里。"
		}
	],
	"headings": [{
		"id": "取已加载库",
...
var toc = [{
	depth: 2,
	url: "#取已加载库",
	title: jsx(Fragment, { children: "取已加载库" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0EFE",
			name: "GET_LOADED_LIBRARY",
			member: "DynamicLibrary.GetLoadedLibrary",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0EFE GET_LOADED_LIBRARY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

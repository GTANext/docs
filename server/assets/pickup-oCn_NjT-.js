...
//#region content/docs/cleo/sa/ext/sampfuncs/pickup.mdx?collection=docs
var frontmatter = {
	"title": "拾取物 Pickup",
...
var toc = [{
	depth: 2,
	url: "#拾取物-id",
	title: jsx(Fragment, { children: "拾取物 ID" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0B53",
			name: "SAMP_GET_PICKUP_ID",
			member: "Pickup.GetSampId",
			children: [jsx(_components.p, { children: "按拾取物句柄返回 SA-MP 拾取物 ID。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B53 SAMP_GET_PICKUP_ID" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

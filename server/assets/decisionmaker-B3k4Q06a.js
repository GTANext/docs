...
//#region content/docs/cleo/sa/default/decisionmaker.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "是否存在",
			"content": "handle 是否是有效决策器。用在 `if` 里。"
		}
	],
	"headings": [{
		"id": "删除",
...
var toc = [{
	...
	depth: 2,
	url: "#是否存在",
	title: jsx(Fragment, { children: "是否存在" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "DecisionMaker.Remove",
			children: [jsx(_components.p, { children: "删除决策器。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "065C REMOVE_DECISION_MAKER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "DecisionMaker.DoesExist",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "09F2 DOES_DECISION_MAKER_EXIST" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " doesDecisionMakerExist"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",

...
//#region content/docs/plugins/entities/entry-exit.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`CEntryExitManager.h`"
		},
		{
			"heading": void 0,
			"content": "室内门、进出栈、区域码。传送室内 / 调试门用。"
		},
		{
			"heading": "跳转",
			"content": "调试传送。"
...
var toc = [
	{
		depth: 2,
		url: "#活动入口",
		title: jsx(Fragment, { children: "活动入口" })
	},
	{
		depth: 2,
		url: "#查找",
		title: jsx(Fragment, { children: "查找" })
	},
	{
		depth: 2,
		url: "#启用开关",
		title: jsx(Fragment, { children: "启用开关" })
	},
	{
		depth: 2,
		url: "#跳转",
		title: jsx(Fragment, { children: "跳转" })
	},
	{
		depth: 2,
		url: "#添加删除",
		title: jsx(Fragment, { children: "添加删除" })
	},
	{
		depth: 2,
		url: "#池与栈",
		title: jsx(Fragment, { children: "池与栈" })
	},
	{
		depth: 2,
		url: "#世界坐标修正",
		title: jsx(Fragment, { children: "世界坐标修正" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CEntryExitManager.h" }) }),
		"\n",
		jsx(_components.p, { children: "室内门、进出栈、区域码。传送室内 / 调试门用。" }),
		"\n",
		jsx(_components.h2, {
			id: "活动入口",
			children: "活动入口"
		...
		"\n",
		jsx(Api, {
			name: "mp_Active / WeAreInInteriorTransition",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " WeAreInInteriorTransition"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsx(Api, {
			name: "FindNearestEntryExit / GetEntryExit",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsx(Api, {
			name: "SetEnabled / SetEnabledByName",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsxs(Api, {
			name: "GotoEntryExit / GotoNextEntryExit",
			children: [jsx(_components.p, { children: "调试传送。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GotoPreviousEntryExit"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// CEntryExitManager::GotoEntryExit(ee);"
								})
							}) })
						}) })
					})
		...
		"\n",
		jsxs(Api, {
			name: "AddOne / DeleteOne",
			children: [jsx(_components.p, { children: "参数多，对照头文件。" }), jsx(Fragment, { children: jsx(_components.pre, {
				className: "shiki shiki-themes github-light github-dark",
				style: {
					"--shiki-light": "#24292e",
					"--shiki-dark": "#e1e4e8",
		...
		"\n",
		jsx(Api, {
			name: "mp_poolEntryExits / ms_entryExitStack",
			children: jsx(Fragment, { children: jsx(_components.pre, {
				className: "shiki shiki-themes github-light github-dark",
				style: {
					"--shiki-light": "#24292e",
					...
					jsxs(_components.span, {
						...
						children: [
							...
							jsx(_components.span, {
								...
								children: " ms_entryExitStackPosn;"
							})
						]
					})
				] })
		...
		"\n",
		jsxs(Api, {
			name: "GetPositionRelativeToOutsideWorld",
			children: [jsx(_components.p, { children: "室内点映到外部世界坐标。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " GetPositionRelativeToOutsideWorld"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",

...
//#region content/docs/cleo/sa/default/pad.mdx?collection=docs
var frontmatter = {
	"title": "手柄 Pad",
	"description": "手柄 / 按键控制"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "跳过场键",
			"content": "是否按了跳过场键，或游戏已最小化。用在 `if` 里。"
		},
		{
			"heading": "跳键",
			"content": "是否允许跳。"
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#键状态",
		title: jsx(Fragment, { children: "键状态" })
	},
	{
		depth: 2,
		url: "#震动",
		title: jsx(Fragment, { children: "震动" })
	},
	{
		depth: 2,
		url: "#控制方案",
		title: jsx(Fragment, { children: "控制方案" })
	},
	{
		depth: 2,
		url: "#醉酒延迟",
		title: jsx(Fragment, { children: "醉酒延迟" })
	},
	{
		depth: 2,
		url: "#摇杆位置",
		title: jsx(Fragment, { children: "摇杆位置" })
	},
	{
		depth: 2,
		url: "#上下车键",
		title: jsx(Fragment, { children: "上下车键" })
	},
	{
		depth: 2,
		url: "#蹲键",
		title: jsx(Fragment, { children: "蹲键" })
	},
	{
		depth: 2,
		url: "#开火键",
		title: jsx(Fragment, { children: "开火键" })
	},
	{
		depth: 2,
		url: "#跳过场键",
		title: jsx(Fragment, { children: "跳过场键" })
	},
	{
		depth: 2,
		url: "#跳键",
		title: jsx(Fragment, { children: "跳键" })
	},
	{
		depth: 2,
		url: "#状态面板键",
		title: jsx(Fragment, { children: "状态面板键" })
	},
	{
		depth: 2,
		url: "#切枪键",
		title: jsx(Fragment, { children: "切枪键" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "00E1 IS_BUTTON_PRESSED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: pad, buttonId" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			name: "GET_PAD_STATE",
			member: "Pad.GetState",
			children: [jsx(_components.p, { children: "取键状态值。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "00E2 GET_PAD_STATE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			name: "SHAKE_PAD",
			member: "Pad.Shake",
			children: [jsx(_components.p, { children: "震动手柄：时长 + 强度。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "015B SHAKE_PAD" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: pad, time, intensity" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Pad.GetControllerMode",
			children: [jsx(_components.p, { children: "取当前控制方案模式。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0293 GET_CONTROLLER_MODE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Pad.SetDrunkInputDelay",
			children: [jsx(_components.p, { children: "醉酒输入延迟（影响开车左右转向）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "03FD SET_DRUNK_INPUT_DELAY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: pad, delay" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Pad.GetPositionOfAnalogueSticks",
			children: [jsx(_components.p, { children: "取左右摇杆偏移。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0494 GET_POSITION_OF_ANALOGUE_STICKS" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: pad" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: leftStickX, leftStickY, rightStickX, rightStickY" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " leftStickX, leftStickY, rightStickX, rightStickY "
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#D73A49",
									...
									jsx(_components.span, {
										...
										children: " getPositionOfAnalogueSticks"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Pad.SetPlayerEnterCarButton",
			children: [jsx(_components.p, { children: "是否允许上下车。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07CC SET_PLAYER_ENTER_CAR_BUTTON" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: playerId, enabled" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "setPlayerEnterCarButton"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(playerId, enabled)"
								})]
							}) })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Pad.SetPlayerDuckButton",
			children: [jsx(_components.p, { children: "是否允许蹲。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "082A SET_PLAYER_DUCK_BUTTON" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Pad.SetPlayerFireButton",
			children: [jsx(_components.p, { children: "是否允许开火用枪。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0881 SET_PLAYER_FIRE_BUTTON" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Pad.IsSkipCutsceneButtonPressed",
			children: [jsxs(_components.p, { children: [
				"是否按了跳过场键，或游戏已最小化。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "08D0 IS_SKIP_CUTSCENE_BUTTON_PRESSED" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " isSkipCutsceneButtonPressed"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Pad.SetPlayerJumpButton",
			children: [jsx(_components.p, { children: "是否允许跳。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0901 SET_PLAYER_JUMP_BUTTON" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Pad.SetPlayerDisplayVitalStatsButton",
			children: [jsx(_components.p, { children: "是否可用 ACTION 键打开状态面板。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0960 SET_PLAYER_DISPLAY_VITAL_STATS_BUTTON" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "setPlayerDisplayVitalStatsButton"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
		...
		jsxs(Opcode, {
			...
			member: "Pad.SetPlayerCycleWeaponButton",
			children: [jsx(_components.p, { children: "是否允许切枪。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0992 SET_PLAYER_CYCLE_WEAPON_BUTTON" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "setPlayerCycleWeaponButton"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"

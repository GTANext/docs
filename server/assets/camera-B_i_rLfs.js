...
//#region content/docs/plugins/entities/camera.mdx?collection=docs
var frontmatter = {
	"title": "镜头 CCamera",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`CCamera.h` · 全局 `TheCamera`"
		},
		{
			"heading": void 0,
			"content": "脚本接管后记得 `Restore` / `RestoreWithJumpCut`。FOV 也看 `CDraw::ms_fFOV`。"
		},
		{
			"heading": "恢复镜头",
			"content": "交回游戏默认跟拍。"
...
var toc = [
	{
		depth: 2,
		url: "#画面淡入淡出",
		title: jsx(Fragment, { children: "画面淡入淡出" })
	},
	{
		depth: 2,
		url: "#脚本接管镜头",
		title: jsx(Fragment, { children: "脚本接管镜头" })
	},
	{
		depth: 2,
		url: "#恢复镜头",
	...
	},
	{
		depth: 2,
		url: "#镜头震动",
		title: jsx(Fragment, { children: "镜头震动" })
	},
	{
		depth: 2,
		url: "#视场角",
		title: jsx(Fragment, { children: "视场角" })
	},
	{
		depth: 2,
		url: "#固定点位镜头",
		title: jsx(Fragment, { children: "固定点位镜头" })
	},
	{
		depth: 2,
		url: "#宽屏与运动模糊",
		title: jsx(Fragment, { children: "宽屏与运动模糊" })
	},
	{
		depth: 2,
		url: "#球可见性",
		title: jsx(Fragment, { children: "球可见性" })
	},
	{
		depth: 2,
		url: "#镜头朝向",
		title: jsx(Fragment, { children: "镜头朝向" })
	},
	{
		depth: 2,
		url: "#第三人称瞄准向量",
		title: jsx(Fragment, { children: "第三人称瞄准向量" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "CCamera.h" }),
			" · 全局 ",
			jsx(_components.code, { children: "TheCamera" })
		] }),
		"\n",
		jsxs(_components.p, { children: [
			"脚本接管后记得 ",
			jsx(_components.code, { children: "Restore" }),
			" / ",
			jsx(_components.code, { children: "RestoreWithJumpCut" }),
			"。FOV 也看 ",
			jsx(_components.code, { children: "CDraw::ms_fFOV" }),
			"。"
		] }),
		"\n",
		jsx(_components.h2, {
		...
		"\n",
		jsx(Api, {
			name: "Fade / SetFadeColour / GetScreenFadeStatus",
		...
		"\n",
		jsx(Api, {
			name: "TakeControl / TakeControlNoEntity",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " WhoIsInControlOfTheCamera"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " TakeControlAttachToEntity"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " TakeControlWithSpline"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsxs(Api, {
			name: "Restore / RestoreWithJumpCut",
			children: [jsx(_components.p, { children: "交回游戏默认跟拍。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsxs(Api, {
			name: "CamShake / AddShakeSimple",
			children: [jsx(_components.p, { children: "爆炸、撞击特效常用。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsx(Api, {
			name: "SetCamPositionForFixedMode",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " SetCamPositionForFixedMode"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		"\n",
		jsx(Api, {
			name: "SetWideScreenOn / SetMotionBlur",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Api, {
			...
			children: [jsx(_components.p, { children: "球是否在视锥。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsx(Api, {
			name: "Find3rdPersonCamTargetVector",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " Find3rdPersonCamTargetVector"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " Find3rdPersonQuickAimPitch"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// TheCamera.Find3rdPersonCamTargetVector(range, source, &cam, &point);"
								})
							}) })
						}) })
					})

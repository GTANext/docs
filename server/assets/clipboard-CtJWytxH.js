...
//#region content/docs/cleo/sa/ext/clipboard.mdx?collection=docs
var frontmatter = {
	"title": "剪贴板 Clipboard",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`sa` · 扩展 `clipboard` · 需对应 CLEO 扩展"
		},
		{
			"heading": void 0,
			"content": "与 CLEO+ `0B20` / `0B21` 同号同语义；装了哪套用哪套。"
		},
		{
			"heading": void 0,
		...
		{
			"heading": "读剪贴板",
			"content": "从系统剪贴板拷到 `address`，最多 `number` 字节。缓冲自己留够。"
		},
		{
			"heading": "写剪贴板",
			"content": "把 `address` 起 `number` 字节写进剪贴板。"
		}
	],
	"headings": [{
		"id": "读剪贴板",
...
var toc = [{
	depth: 2,
	url: "#读剪贴板",
	title: jsx(Fragment, { children: "读剪贴板" })
}, {
	depth: 2,
	url: "#写剪贴板",
	title: jsx(Fragment, { children: "写剪贴板" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			...
			" · 扩展 ",
			jsx(_components.code, { children: "clipboard" }),
			" · 需对应 CLEO 扩展"
		] }),
		"\n",
		jsxs(_components.p, { children: [
			...
			" / ",
			jsx(_components.code, { children: "0B21" }),
			" 同号同语义；装了哪套用哪套。"
		] }),
		"\n",
		jsxs(_components.p, { children: [
		...
		jsxs(Opcode, {
			id: "0B20",
			name: "READ_CLIPBOARD_DATA",
			member: "Clipboard.ReadData",
			children: [jsxs(_components.p, { children: [
				"从系统剪贴板拷到 ",
				jsx(_components.code, { children: "address" }),
				"，最多 ",
				jsx(_components.code, { children: "number" }),
				" 字节。缓冲自己留够。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B20 READ_CLIPBOARD_DATA" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: address, number" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0B21",
			name: "WRITE_CLIPBOARD_DATA",
			member: "Clipboard.WriteData",
			children: [jsxs(_components.p, { children: [
				"把 ",
				jsx(_components.code, { children: "address" }),
				" 起 ",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B21 WRITE_CLIPBOARD_DATA" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

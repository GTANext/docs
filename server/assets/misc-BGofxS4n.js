...
//#region content/docs/cleo/sa/plus/misc.mdx?collection=docs
var frontmatter = {
	"title": "杂项 Misc",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "CLEO+ 有 class 的 op 已进类型页，见 综述。"
		},
		{
			"heading": void 0,
			"content": "无 class 的收尾条（距离倍率、水面、模型名指针等）放在 game。本页不堆 opcode；其它扩展（NewOpcodes / imgui）不收录。"
		},
		{
			"heading": void 0,
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		"\n",
		jsxs(_components.p, { children: [
			"无 class 的收尾条（距离倍率、水面、模型名指针等）放在 ",
			jsx(_components.a, {
				href: "/docs/cleo/sa/plus/game",
				children: "game"
			}),
			"。本页不堆 opcode；其它扩展（NewOpcodes / imgui）不收录。"
		] }),
		"\n",
		jsxs(_components.p, { children: [
			"写法见 ",
						...
						children: jsxs(_components.code, { children: [
							jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// 无统一 Redux 符号；具体 op 见各类型页"
								})
							}),
							"\n",

...
//#region content/docs/cleo/sa/default/sound.mdx?collection=docs
var frontmatter = {
	"title": "音效 Sound",
	"description": "一次性音效"
};
...
var toc = [{
	depth: 2,
	url: "#播一次",
	title: jsx(Fragment, { children: "播一次" })
}, {
	depth: 2,
	url: "#移除",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Sound.AddOneOffSound",
			children: [jsx(_components.p, { children: "在坐标播一次指定 ID 音效。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "018C ADD_ONE_OFF_SOUND" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			name: "REMOVE_SOUND",
			member: "Sound.Remove",
			children: [jsx(_components.p, { children: "停掉 / 释放该音效实例。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "018E REMOVE_SOUND" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

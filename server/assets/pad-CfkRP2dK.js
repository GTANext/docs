...
//#region content/docs/plugins/entities/pad.mdx?collection=docs
var frontmatter = {
	"title": "输入 CPad",
	"description": "手柄与输入状态"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "逻辑帧读输入；自定义热键更常用 KeyCheck。"
		},
		{
			"heading": "当前控制状态",
			"content": "`CControllerState` 摇杆与按键。"
		},
		{
			"heading": "与-keycheck-分工",
			"content": "场景"
		},
		{
			"heading": "与-keycheck-分工",
...
var toc = [
	{
		depth: 2,
		url: "#取手柄对象",
		title: jsx(Fragment, { children: "取手柄对象" })
	},
	{
		depth: 2,
		url: "#当前控制状态",
		title: jsx(Fragment, { children: "当前控制状态" })
	},
	{
		depth: 2,
		url: "#鼠标状态",
		title: jsx(Fragment, { children: "鼠标状态" })
	},
	{
		depth: 2,
		url: "#清鼠标历史",
		title: jsx(Fragment, { children: "清鼠标历史" })
	},
	{
		depth: 2,
		url: "#与-keycheck-分工",
		title: jsx(Fragment, { children: "与 KeyCheck 分工" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CPad.h" }) }),
		"\n",
		...
		jsxs(Api, {
			...
			children: [jsxs(_components.p, { children: [jsx(_components.code, { children: "CControllerState" }), " 摇杆与按键。"] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "CControllerState NewState;"
									})
								}),
								"\n",
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "CControllerState OldState;"
									})
								}),
								"\n",
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// LeftStickX/Y, ButtonCross, ButtonCircle, ..."
									})
								})
							] })
						}) })
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " pad->NewState.LeftStickX;"
										})
									]
								}),
								"\n",
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " pad->NewState.ButtonCircle;"
										})
									]
								})
							] })
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// unsigned char lmb, rmb, wheelUp, wheelDown; float x, y;"
									})
								})
							] })
						}) })
		...
		jsx(_components.h2, {
			id: "与-keycheck-分工",
			children: "与 KeyCheck 分工"
		}),
		"\n",
		jsxs(_components.table, { children: [jsx(_components.thead, { children: jsxs(_components.tr, { children: [jsx(_components.th, { children: "场景" }), jsx(_components.th, { children: "用" })] }) }), jsxs(_components.tbody, { children: [
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "虚拟键边沿（菜单）" }), jsx(_components.td, { children: jsx(_components.code, { children: "KeyCheck" }) })] }),
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "游戏内摇杆 / 手柄" }), jsx(_components.td, { children: jsx(_components.code, { children: "CPad" }) })] }),
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "仅当前是否按下" }), jsx(_components.td, { children: jsx(_components.code, { children: "plugin::KeyPressed" }) })] })
		] })] })
	] });
}

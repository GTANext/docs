...
//#region content/docs/cleo/sa/ext/file.mdx?collection=docs
var frontmatter = {
	"title": "文件 Fs / File",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`sa` · 扩展 `file` · 需对应 CLEO 扩展"
		},
		{
			"heading": void 0,
			"content": "文件 / 目录操作与块读写。"
		...
		{
			"heading": "删文件",
			"content": "成功才真。用在 `if` 里。"
		},
		{
			"heading": "删目录",
			"content": "`recursive` 是否递归。用在 `if` 里。"
		},
		{
			"heading": "移动文件",
			"content": "用在 `if` 里。"
		...
		{
			"heading": "读块",
			"content": "从文件读 `size` 字节到 `address`。用在 `if` 里。"
		},
		{
			"heading": "写块",
			"content": "从 `address` 写 `size` 字节到文件。用在 `if` 里。"
		},
		{
			"heading": "解析路径",
			"content": "解析成绝对路径（相对 / 虚拟前缀 / 已是绝对均可）。"
		},
		{
			"heading": "脚本文件名",
			"content": "`fullPath` 控制是否完整路径。用在 `if` 里。"
		},
		{
			"heading": "文件修改时间",
			"content": "失败条件为假，输出不变。用在 `if` 里。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#删文件",
		title: jsx(Fragment, { children: "删文件" })
	},
	{
		depth: 2,
		url: "#删目录",
		title: jsx(Fragment, { children: "删目录" })
	},
	{
		depth: 2,
		url: "#移动文件",
		title: jsx(Fragment, { children: "移动文件" })
	},
	{
		depth: 2,
		url: "#移动目录",
		title: jsx(Fragment, { children: "移动目录" })
	},
	{
		depth: 2,
		url: "#复制文件",
		title: jsx(Fragment, { children: "复制文件" })
	},
	{
		depth: 2,
		url: "#复制目录",
		title: jsx(Fragment, { children: "复制目录" })
	},
	{
		depth: 2,
		url: "#文件位置",
		title: jsx(Fragment, { children: "文件位置" })
	},
	{
		depth: 2,
		url: "#读块",
		title: jsx(Fragment, { children: "读块" })
	},
	{
		depth: 2,
		url: "#写块",
		title: jsx(Fragment, { children: "写块" })
	},
	{
		depth: 2,
		url: "#解析路径",
		title: jsx(Fragment, { children: "解析路径" })
	},
	{
		depth: 2,
		url: "#脚本文件名",
		title: jsx(Fragment, { children: "脚本文件名" })
	},
	{
		depth: 2,
		url: "#文件修改时间",
		title: jsx(Fragment, { children: "文件修改时间" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		"\n",
		jsx(_components.p, { children: "文件 / 目录操作与块读写。" }),
		"\n",
		jsxs(_components.p, { children: [
			"写法见 ",
			jsx(_components.a, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B00 DELETE_FILE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Fs.DeleteDirectory",
			children: [jsxs(_components.p, { children: [
				jsx(_components.code, { children: "recursive" }),
				" 是否递归。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
			] }), jsxs(CodeBlockTabs, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B01 DELETE_DIRECTORY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: path, recursive" })
								})
							] })
						}) })
					}),
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B02 MOVE_FILE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: fileName, newFileName" })
								})
							] })
						}) })
					}),
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B03 MOVE_DIRECTORY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: dirPath, newDirPath" })
								})
							] })
						}) })
					}),
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B04 COPY_FILE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B05 COPY_DIRECTORY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "File.GetPosition",
			children: [jsx(_components.p, { children: "已打开文件当前读写位置。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2300 GET_FILE_POSITION" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2301 READ_BLOCK_FROM_FILE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, size, address" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "2302",
			name: "WRITE_BLOCK_TO_FILE",
			member: "File.WriteBlock",
			children: [jsxs(_components.p, { children: [
				"从 ",
				jsx(_components.code, { children: "address" }),
				" 写 ",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2302 WRITE_BLOCK_TO_FILE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "2303",
			name: "RESOLVE_FILEPATH",
			member: "Fs.ResolvePath",
			children: [jsx(_components.p, { children: "解析成绝对路径（相对 / 虚拟前缀 / 已是绝对均可）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2303 RESOLVE_FILEPATH" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: resolved" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "2304",
			name: "GET_SCRIPT_FILENAME",
			member: "Fs.GetScriptFilename",
			children: [jsxs(_components.p, { children: [
				jsx(_components.code, { children: "fullPath" }),
				" 控制是否完整路径。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
			] }), jsxs(CodeBlockTabs, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2304 GET_SCRIPT_FILENAME" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: address, fullPath" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: filenameOrPath" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "2305",
			name: "GET_FILE_WRITE_TIME",
			member: "Fs.GetFileWriteTime",
			children: [jsxs(_components.p, { children: [
				"失败条件为假，输出不变。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2305 GET_FILE_WRITE_TIME" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: year, month, day, hour, minute, second, milisecond" })
								})
							] })
						}) })
					}),

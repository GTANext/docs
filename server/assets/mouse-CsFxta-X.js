...
//#region content/docs/cleo/sa/plus/mouse.mdx?collection=docs
var frontmatter = {
	"title": "鼠标 Mouse",
	"description": "滚轮与灵敏度"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "滚轮上",
			"content": "本帧滚轮是否上滚。用在 `if` 里。"
		},
		{
			"heading": "滚轮下",
			"content": "本帧滚轮是否下滚。用在 `if` 里。"
		},
		{
			"heading": "灵敏度",
			"content": "选项里的鼠标灵敏度。"
...
var toc = [
	{
		depth: 2,
		url: "#滚轮上",
		title: jsx(Fragment, { children: "滚轮上" })
	},
	{
		depth: 2,
		url: "#滚轮下",
		title: jsx(Fragment, { children: "滚轮下" })
	},
	{
		depth: 2,
		url: "#灵敏度",
		title: jsx(Fragment, { children: "灵敏度" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0E10",
			name: "IS_MOUSE_WHEEL_UP",
			member: "Mouse.IsWheelUp",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0E10 IS_MOUSE_WHEEL_UP" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
		...
		jsxs(Opcode, {
			id: "0E11",
			name: "IS_MOUSE_WHEEL_DOWN",
			member: "Mouse.IsWheelDown",
			children: [jsxs(_components.p, { children: [
				"本帧滚轮是否下滚。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
				...
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0E11 IS_MOUSE_WHEEL_DOWN" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
		...
		jsxs(Opcode, {
			id: "0E23",
			name: "GET_MOUSE_SENSIBILITY",
			member: "Mouse.GetSensibility",
			children: [jsx(_components.p, { children: "选项里的鼠标灵敏度。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0E23 GET_MOUSE_SENSIBILITY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: sensibility" })
								})
							] })
						}) })
					}),

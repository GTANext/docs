...
//#region content/docs/cleo/sa/ext/sampfuncs/sampmyplayer.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "重生--昵称--状态",
			"content": "向服务器发送 SampRpc.Spawn，并传送本地角色到出生点。"
		},
		{
			"heading": "重生--昵称--状态",
			"content": "修改本地昵称（仅视觉）。"
...
var toc = [{
	depth: 2,
	url: "#重生--昵称--状态",
	title: jsx(Fragment, { children: "重生 / 昵称 / 状态" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0AF6",
			name: "SAMP_FORCE_SPAWN_MY_PLAYER",
			member: "SampMyPlayer.ForceSpawn",
			children: [jsx(_components.p, { children: "向服务器发送 SampRpc.Spawn，并传送本地角色到出生点。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0AF6 SAMP_FORCE_SPAWN_MY_PLAYER" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "sampForceSpawnMyPlayer"
		...
		jsxs(Opcode, {
			id: "0B29",
			name: "SAMP_SET_MY_NICKNAME",
			member: "SampMyPlayer.SetNickname",
			children: [jsx(_components.p, { children: "修改本地昵称（仅视觉）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B29 SAMP_SET_MY_NICKNAME" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: nickname" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0B61",
			name: "SAMP_IS_MY_PLAYER_SPAWNED",
			member: "SampMyPlayer.IsSpawned",
			children: [jsx(_components.p, { children: "若本地玩家已重生/入场则为真。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0B61 SAMP_IS_MY_PLAYER_SPAWNED" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " sampIsMyPlayerSpawned"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",

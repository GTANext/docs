...
//#region content/docs/cleo/sa/ext/sampfuncs/sampchatinput.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "可见--文本",
			"content": "设置聊天输入框打开/关闭。"
		},
		{
			"heading": "发送",
			"content": "经 SAMPFUNCS 回调处理后，作为 SampRpc.Chat 发往服务器。"
		}
	],
	"headings": [{
		"id": "可见--文本",
...
var toc = [{
	depth: 2,
	url: "#可见--文本",
	title: jsx(Fragment, { children: "可见 / 文本" })
}, {
	depth: 2,
	url: "#发送",
	title: jsx(Fragment, { children: "发送" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0B21",
			name: "SAMP_IS_CHAT_INPUT_VISIBLE",
			member: "SampChatInput.IsVisible",
			children: [jsx(_components.p, { children: "检查聊天输入框是否打开/可见。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0B21 SAMP_IS_CHAT_INPUT_VISIBLE" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " sampIsChatInputVisible"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "SampChatInput.SetText",
			children: [jsx(_components.p, { children: "覆盖聊天输入框中的文本。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B76 SAMP_SET_CHAT_INPUT_TEXT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "SampChatInput.GetText",
			children: [jsx(_components.p, { children: "返回聊天输入框当前文本。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B77 SAMP_GET_CHAT_INPUT_TEXT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "SampChatInput.SetVisibility",
			children: [jsx(_components.p, { children: "设置聊天输入框打开/关闭。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B79 SAMP_SET_CHAT_INPUT_VISIBILITY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "sampSetChatInputVisibility"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
		...
		jsxs(Opcode, {
			id: "0C8F",
			name: "SAMP_PROCESS_CHAT_INPUT",
			member: "SampChatInput.Process",
			children: [jsx(_components.p, { children: "经 SAMPFUNCS 回调处理后，作为 SampRpc.Chat 发往服务器。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C8F SAMP_PROCESS_CHAT_INPUT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

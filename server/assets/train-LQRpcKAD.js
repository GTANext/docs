...
//#region content/docs/cleo/sa/default/train.mdx?collection=docs
var frontmatter = {
	"title": "火车 Train",
	"description": "任务列车"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "创建",
			"content": "按类型建任务列车（长度 / 车厢由类型定）并设行驶方向。"
		},
		{
			"heading": "速度",
			"content": "设列车速度 / 加速度类参数。"
		},
		{
			"heading": "巡航速度",
			"content": "设巡航速度。"
		...
		{
			"heading": "行驶方向",
			"content": "是否沿圣安地列斯环线顺时针。用在 `if` 里。"
		},
		{
			"heading": "下一站可达",
			"content": "下一站是否已解锁可达。用在 `if` 里。"
		},
		{
			"heading": "跳下一站",
			"content": "跳到下一座允许的车站。"
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#速度",
		title: jsx(Fragment, { children: "速度" })
	},
	{
		depth: 2,
		url: "#巡航速度",
		title: jsx(Fragment, { children: "巡航速度" })
	},
	{
		depth: 2,
		url: "#守车",
		title: jsx(Fragment, { children: "守车" })
	},
	{
		depth: 2,
		url: "#第-n-节",
		title: jsx(Fragment, { children: "第 n 节" })
	},
	{
		depth: 2,
		url: "#删除",
	...
	},
	{
		depth: 2,
		url: "#标记可清理",
		title: jsx(Fragment, { children: "标记可清理" })
	},
	{
		depth: 2,
		url: "#贴轨坐标",
		title: jsx(Fragment, { children: "贴轨坐标" })
	},
	{
		depth: 2,
		url: "#是否脱轨",
		title: jsx(Fragment, { children: "是否脱轨" })
	},
	{
		depth: 2,
		url: "#每站减速",
		title: jsx(Fragment, { children: "每站减速" })
	},
	{
		depth: 2,
		url: "#行驶方向",
		title: jsx(Fragment, { children: "行驶方向" })
	},
	{
		depth: 2,
		url: "#下一站可达",
		title: jsx(Fragment, { children: "下一站可达" })
	},
	{
		depth: 2,
		url: "#跳下一站",
		title: jsx(Fragment, { children: "跳下一站" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Train.Create",
			children: [jsx(_components.p, { children: "按类型建任务列车（长度 / 车厢由类型定）并设行驶方向。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "06D8 CREATE_MISSION_TRAIN" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: type, x, y, z, direction" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Train.SetSpeed",
			children: [jsx(_components.p, { children: "设列车速度 / 加速度类参数。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "06DC SET_TRAIN_SPEED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Train.SetCruiseSpeed",
			children: [jsx(_components.p, { children: "设巡航速度。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "06DD SET_TRAIN_CRUISE_SPEED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Train.GetCaboose",
			children: [jsx(_components.p, { children: "取最后一节车厢（守车）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "06DE GET_TRAIN_CABOOSE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: caboose" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Train.GetCarriage",
			children: [jsx(_components.p, { children: "取第 n 节车厢。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "078A GET_TRAIN_CARRIAGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, number" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: carriage" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Train.Delete",
			children: [jsx(_components.p, { children: "删除脚本列车。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07BD DELETE_MISSION_TRAIN" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Train.MarkAsNoLongerNeeded",
			children: [jsx(_components.p, { children: "标记脚本列车可被游戏清理。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07BE MARK_MISSION_TRAIN_AS_NO_LONGER_NEEDED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "markMissionTrainAsNoLongerNeeded"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Train.SetCoordinates",
			children: [jsx(_components.p, { children: "放到离坐标最近的铁轨上。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07C7 SET_MISSION_TRAIN_COORDINATES" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "setMissionTrainCoordinates"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0981 HAS_TRAIN_DERAILED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Train.SetForcedToSlowDown",
			children: [jsx(_components.p, { children: "是否每站减速 / 停靠。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "09CF SET_TRAIN_FORCED_TO_SLOW_DOWN" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "setTrainForcedToSlowDown"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "09E3 FIND_TRAIN_DIRECTION" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Train.IsNextStationAllowed",
			children: [jsxs(_components.p, { children: [
				"下一站是否已解锁可达。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0A06 IS_NEXT_STATION_ALLOWED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Train.SkipToNextAllowedStation",
			children: [jsx(_components.p, { children: "跳到下一座允许的车站。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0A07 SKIP_TO_NEXT_ALLOWED_STATION" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "skipToNextAllowedStation"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",

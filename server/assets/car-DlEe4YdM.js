...
//#region content/docs/cleo/sa/ext/sampfuncs/car.mdx?collection=docs
var frontmatter = {
	"title": "载具 Car",
...
var toc = [{
	depth: 2,
	url: "#车辆-id",
	title: jsx(Fragment, { children: "车辆 ID" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0B2C",
			name: "SAMP_GET_CAR_ID",
			member: "Car.GetSampId",
			children: [jsx(_components.p, { children: "按车辆句柄返回 SA-MP 车辆 ID。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B2C SAMP_GET_CAR_ID" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

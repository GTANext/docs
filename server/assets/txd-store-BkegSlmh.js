...
//#region content/docs/plugins/entities/txd-store.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "贴图字典槽。加载自定义 UI 贴图常用：`AddTxdSlot` → `LoadTxd` → `AddRef` → `SetCurrentTxd`。"
		},
		{
			"heading": "引用计数",
			"content": "引用到 0 会删。"
		...
		{
			"heading": "设当前-txd",
			"content": "`SetTexture` 前要先设当前。"
		},
		{
			"heading": "移除-txd-数据",
			"content": "设备丢失时配合 `d3dLost` / `d3dReset` 重载，或用 `SpriteLoader` / `DynamicResource`。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#分配槽",
		title: jsx(Fragment, { children: "分配槽" })
	},
	{
		depth: 2,
		url: "#从文件加载",
		title: jsx(Fragment, { children: "从文件加载" })
	},
	{
		depth: 2,
		url: "#引用计数",
		title: jsx(Fragment, { children: "引用计数" })
	},
	{
		depth: 2,
		url: "#设当前-txd",
		title: jsx(Fragment, { children: "设当前 TXD" })
	},
	{
		depth: 2,
		url: "#移除-txd-数据",
		title: jsx(Fragment, { children: "移除 TXD 数据" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CTxdStore.h" }) }),
		"\n",
		jsxs(_components.p, { children: [
			"贴图字典槽。加载自定义 UI 贴图常用：",
			jsx(_components.code, { children: "AddTxdSlot" }),
			" → ",
			jsx(_components.code, { children: "LoadTxd" }),
			" → ",
			jsx(_components.code, { children: "AddRef" }),
			" → ",
			jsx(_components.code, { children: "SetCurrentTxd" }),
			"。"
		] }),
		"\n",
		jsx(_components.h2, {
		...
		"\n",
		jsx(Api, {
			name: "AddTxdSlot / FindTxdSlot / RemoveTxdSlot",
		...
		"\n",
		jsxs(Api, {
			name: "AddRef / RemoveRef / GetNumRefs",
			children: [jsx(_components.p, { children: "引用到 0 会删。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " RemoveRefWithoutDelete"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// CTxdStore::RemoveRef(slot);"
									})
								})
							] })
						}) })
		...
		"\n",
		jsxs(Api, {
			name: "SetCurrentTxd / PushCurrentTxd / PopCurrentTxd",
			children: [jsxs(_components.p, { children: [jsx(_components.code, { children: "SetTexture" }), " 前要先设当前。"] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// sprite.SetTexture(\"icon\");"
									})
								}),
								"\n",
								jsxs(_components.span, {
		...
		jsxs(_components.p, { children: [
			...
			" 重载，或用 ",
			jsx(_components.code, { children: "SpriteLoader" }),
			" / ",

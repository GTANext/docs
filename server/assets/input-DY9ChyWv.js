...
//#region content/docs/cleo/sa/ext/input.mdx?collection=docs
var frontmatter = {
	"title": "手柄 Pad",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`sa` · 扩展 `input` · 需对应 CLEO 扩展"
		},
		{
			"heading": void 0,
			"content": "键边沿 / 模拟按键 / 控制器绑定查询。"
		},
		{
			"heading": void 0,
		...
		{
			"heading": "键刚按下",
			"content": "虚拟键本帧刚按下（边沿）。用在 `if` 里。"
		},
		{
			"heading": "区间内正按住",
			"content": "区间内是否有键正按住，返回该键码。用在 `if` 里。"
		},
		{
			"heading": "区间内刚按下",
			"content": "用在 `if` 里。"
		...
		{
			"heading": "动作绑定键",
			"content": "取动作绑定的第 n 个备用键。未绑定时输出不变且条件假。用在 `if` 里。"
		},
		{
			"heading": "键显示名",
			"content": "取键显示名。无名则条件假。用在 `if` 里。"
		}
	],
	"headings": [
		{
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#区间内正按住",
		title: jsx(Fragment, { children: "区间内正按住" })
	},
	{
		depth: 2,
		url: "#区间内刚按下",
		title: jsx(Fragment, { children: "区间内刚按下" })
	},
	{
		depth: 2,
		url: "#模拟按下",
		title: jsx(Fragment, { children: "模拟按下" })
	},
	{
		depth: 2,
		url: "#模拟松开",
		title: jsx(Fragment, { children: "模拟松开" })
	},
	{
		depth: 2,
		url: "#动作绑定键",
		title: jsx(Fragment, { children: "动作绑定键" })
	},
	{
		depth: 2,
		url: "#键显示名",
		title: jsx(Fragment, { children: "键显示名" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		"\n",
		jsx(_components.p, { children: "键边沿 / 模拟按键 / 控制器绑定查询。" }),
		"\n",
		jsxs(_components.p, { children: [
			"写法见 ",
			jsx(_components.a, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2080 IS_KEY_JUST_PRESSED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "2081",
			name: "GET_KEY_PRESSED_IN_RANGE",
			member: "Pad.GetKeyPressedInRange",
			children: [jsxs(_components.p, { children: [
				"区间内是否有键正按住，返回该键码。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2081 GET_KEY_PRESSED_IN_RANGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: minKeyCode, maxKeyCode" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: keyCode" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "(minKeyCode, maxKeyCode)"
									})
								]
							}) })
						}) })
		...
		jsxs(Opcode, {
			id: "2082",
			name: "GET_KEY_JUST_PRESSED_IN_RANGE",
			member: "Pad.GetKeyJustPressedInRange",
			children: [jsxs(_components.p, { children: [
				"用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2082 GET_KEY_JUST_PRESSED_IN_RANGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " getKeyJustPressedInRange"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsx(Opcode, {
			id: "2083",
			name: "EMULATE_KEY_PRESS",
			member: "Pad.EmulateKeyPress",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2083 EMULATE_KEY_PRESS" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsx(Opcode, {
			id: "2084",
			name: "EMULATE_KEY_RELEASE",
			member: "Pad.EmulateKeyRelease",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2084 EMULATE_KEY_RELEASE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "2085",
			name: "GET_CONTROLLER_KEY",
			member: "Pad.GetControllerKey",
			children: [jsxs(_components.p, { children: [
				"取动作绑定的第 n 个备用键。未绑定时输出不变且条件假。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2085 GET_CONTROLLER_KEY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: action, altKey" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2086 GET_KEY_NAME" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

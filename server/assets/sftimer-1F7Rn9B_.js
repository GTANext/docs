...
//#region content/docs/cleo/sa/ext/sampfuncs/sftimer.mdx?collection=docs
var frontmatter = {
	"title": "定时器 SfTimer",
	"description": "周期定时器"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "共 9 条。调用见 Lua / Redux。"
		},
		{
			"heading": "创建--删除--重置",
			"content": "创建并启动 SfTimer，到期后周期执行回调。"
		},
		{
			"heading": "创建--删除--重置",
			"content": "删除指定 SfTimer 并释放内存。用在 `if` 里。"
		},
		{
			"heading": "创建--删除--重置",
			"content": "重置 SfTimer 到期时间，重新开始倒计时。用在 `if` 里。"
		},
		{
			"heading": "间隔--状态",
			"content": "设置 SfTimer 新的间隔。用在 `if` 里。"
		},
		{
			"heading": "间隔--状态",
			"content": "激活或暂停 SfTimer。用在 `if` 里。"
		},
		{
			"heading": "间隔--状态",
			"content": "若 SfTimer 处于活动状态则为真。"
		},
		{
			"heading": "时间查询",
			"content": "返回 SfTimer 配置的间隔。"
		},
		{
			"heading": "时间查询",
			"content": "返回自上次重置以来经过的毫秒数（含已超过间隔后的时间）。"
		},
		{
			"heading": "时间查询",
			"content": "返回距到期剩余毫秒数（定时器活动时会递减）。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#创建--删除--重置",
		title: jsx(Fragment, { children: "创建 / 删除 / 重置" })
	},
	{
		depth: 2,
		url: "#间隔--状态",
		title: jsx(Fragment, { children: "间隔 / 状态" })
	},
	{
		depth: 2,
		url: "#时间查询",
		title: jsx(Fragment, { children: "时间查询" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0C74",
			name: "SF_CREATE_TIMER",
			member: "SfTimer.Create",
			children: [jsx(_components.p, { children: "创建并启动 SfTimer，到期后周期执行回调。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C74 SF_CREATE_TIMER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: interval, callback" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0C75",
			name: "SF_DELETE_TIMER",
			member: "SfTimer.Delete",
			children: [jsxs(_components.p, { children: [
				"删除指定 SfTimer 并释放内存。用在 ",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C75 SF_DELETE_TIMER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0C76",
			name: "SF_RESET_TIMER",
			member: "SfTimer.Reset",
			children: [jsxs(_components.p, { children: [
				"重置 SfTimer 到期时间，重新开始倒计时。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C76 SF_RESET_TIMER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0C77",
			name: "SF_SET_TIMER_INTERVAL",
			member: "SfTimer.SetInterval",
			children: [jsxs(_components.p, { children: [
				"设置 SfTimer 新的间隔。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C77 SF_SET_TIMER_INTERVAL" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, interval" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0C78",
			name: "SF_SET_TIMER_STATUS",
			member: "SfTimer.SetStatus",
			children: [jsxs(_components.p, { children: [
				"激活或暂停 SfTimer。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C78 SF_SET_TIMER_STATUS" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, isActive" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0C79",
			name: "SF_IS_TIMER_ACTIVE",
			member: "SfTimer.IsActive",
			children: [jsx(_components.p, { children: "若 SfTimer 处于活动状态则为真。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C79 SF_IS_TIMER_ACTIVE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0C7A",
			name: "SF_GET_TIMER_INTERVAL",
			member: "SfTimer.GetInterval",
			children: [jsx(_components.p, { children: "返回 SfTimer 配置的间隔。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C7A SF_GET_TIMER_INTERVAL" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: interval" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0C7B",
			name: "SF_GET_TIMER_ELAPSED_TIME",
			member: "SfTimer.GetElapsedTime",
			children: [jsx(_components.p, { children: "返回自上次重置以来经过的毫秒数（含已超过间隔后的时间）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C7B SF_GET_TIMER_ELAPSED_TIME" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: elapsedTime" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " sfGetTimerElapsedTime"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			id: "0C7C",
			name: "SF_GET_TIMER_TIME_LEFT",
			member: "SfTimer.GetTimeLeft",
			children: [jsx(_components.p, { children: "返回距到期剩余毫秒数（定时器活动时会递减）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C7C SF_GET_TIMER_TIME_LEFT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: timeLeft" })
								})
							] })
						}) })
					}),

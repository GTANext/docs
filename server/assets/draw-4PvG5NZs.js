...
//#region content/docs/plugins/entities/draw.mdx?collection=docs
var frontmatter = {
	"title": "绘制 CDraw",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "全局 FOV、裁剪面、淡色。和 CCamera 一起看。"
		},
		{
			"heading": "视场角",
			"content": "默认约 45。"
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#裁剪与-lod",
		title: jsx(Fragment, { children: "裁剪与 LOD" })
	},
	{
		depth: 2,
		url: "#宽高比",
		title: jsx(Fragment, { children: "宽高比" })
	},
	{
		depth: 2,
		url: "#淡色通道",
		title: jsx(Fragment, { children: "淡色通道" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CDraw.h" }) }),
		"\n",
		...
		jsxs(Api, {
			name: "ms_fFOV / SetFOV",
			children: [jsx(_components.p, { children: "默认约 45。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		"\n",
		jsx(Api, {
			name: "ms_fNearClipZ / ms_fFarClipZ / ms_fLODDistance",
		...
		"\n",
		jsx(Api, {
			name: "ms_fAspectRatio / CalculateAspectRatio",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsxs(Api, {
			name: "FadeRed / FadeGreen / FadeBlue / FadeValue",
			children: [jsx(_components.p, { children: "与镜头 Fade 联动。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",

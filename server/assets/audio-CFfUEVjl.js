...
//#region content/docs/plugins/utils/audio.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`Audio.h` · `BassSampleManager` · 需要链接 bass"
		},
		{
			"heading": "创建与销毁",
			"content": "构造时 `BASS_Init`；析构释放 sample / stream。"
		},
		{
			"heading": "音量与静音回调",
			"content": "`Process` 内读取这些回调。可挂到游戏主音量 / 静音。"
		},
		{
			"heading": "播放入队",
			"content": "可按名称或 id 入队。"
		...
		{
			"heading": "每帧处理队列",
			"content": "**必须每帧 `Process` 才会出声。**"
		},
		{
			"heading": "通道细调",
			"content": "一般用「入队 + Process」即可。需要细控时："
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#创建与销毁",
		title: jsx(Fragment, { children: "创建与销毁" })
	},
	{
		depth: 2,
		url: "#音量与静音回调",
		title: jsx(Fragment, { children: "音量与静音回调" })
	},
	{
		depth: 2,
		url: "#加载采样",
		title: jsx(Fragment, { children: "加载采样" })
	},
	{
		depth: 2,
		url: "#取采样与清空",
		title: jsx(Fragment, { children: "取采样与清空" })
	},
	{
		depth: 2,
		url: "#播放入队",
		title: jsx(Fragment, { children: "播放入队" })
	},
	{
		depth: 2,
		url: "#每帧处理队列",
		title: jsx(Fragment, { children: "每帧处理队列" })
	},
	{
		depth: 2,
		url: "#通道细调",
		title: jsx(Fragment, { children: "通道细调" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "Audio.h" }),
			" · ",
			jsx(_components.code, { children: "BassSampleManager" }),
			" · 需要链接 bass"
		] }),
		"\n",
		jsx(_components.h2, {
		...
		jsxs(_components.p, { children: [
			"构造时 ",
			jsx(_components.code, { children: "BASS_Init" }),
			"；析构释放 sample / stream。"
		] }),
		"\n",
		jsxs(CodeBlockTabs, {
						...
						children: jsx(_components.code, { children: jsxs(_components.span, {
							...
							children: [
								...
								jsx(_components.span, {
									...
									children: "::BassSampleManager g_audio;"
								})
							]
						}) })
					}) })
		...
		"\n",
		jsxs(_components.p, { children: [jsx(_components.code, { children: "Process" }), " 内读取这些回调。可挂到游戏主音量 / 静音。"] }),
		"\n",
		jsxs(CodeBlockTabs, {
			defaultValue: "签名",
			children: [
							...
							jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "g_audio.settings.masterVolume "
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#D73A49",
							...
							jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "g_audio.settings.mute "
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#D73A49",
							...
							jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " LoadAllSamplesFromFolder"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		"\n",
		jsx(_components.p, { children: "可按名称或 id 入队。" }),
		"\n",
		jsxs(CodeBlockTabs, {
			defaultValue: "签名",
			children: [
		...
		"\n",
		jsx(_components.p, { children: jsxs(_components.strong, { children: [
			"必须每帧 ",
		...
		"\n",
		jsx(_components.p, { children: "一般用「入队 + Process」即可。需要细控时：" }),
		"\n",
		jsxs(CodeBlockTabs, {
			defaultValue: "签名",
			children: [

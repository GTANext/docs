...
//#region content/docs/cleo/sa/default/checkpoint.mdx?collection=docs
var frontmatter = {
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#改坐标",
		title: jsx(Fragment, { children: "改坐标" })
	},
	{
		depth: 2,
		url: "#朝向",
		title: jsx(Fragment, { children: "朝向" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Checkpoint.Create",
			children: [jsx(_components.p, { children: "创建竞速 / 飞行风格的红色检查点。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "06D5 CREATE_CHECKPOINT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: type, x, y, z, pointX, pointY, pointZ, radius" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: ", x, y, z, pointX, pointY, pointZ, radius)"
									})
								]
							}) })
						}) })
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "(type, x, y, z, pointX, pointY, pointZ, radius)"
									})
								]
							}) })
						}) })
		...
		jsxs(Opcode, {
			...
			member: "Checkpoint.Delete",
			children: [jsx(_components.p, { children: "删除检查点。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "06D6 DELETE_CHECKPOINT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Checkpoint.SetCoords",
			children: [jsx(_components.p, { children: "改检查点坐标。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07F3 SET_CHECKPOINT_COORDS" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Checkpoint.SetHeading",
			children: [jsx(_components.p, { children: "设检查点朝向。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0996 SET_CHECKPOINT_HEADING" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

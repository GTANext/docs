...
//#region content/docs/cleo/sa/plus/streaming.mdx?collection=docs
var frontmatter = {
	"title": "流式 Streaming",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "模型请求 / 特殊角色 / 池清理。`0E7F` 见 game（`GET_MODEL_TYPE`）。写法见 Lua / Redux。"
		},
		{
			"heading": "优先模型",
			"content": "请求优先加载模型。"
		...
		{
			"heading": "优先模型",
			"content": "立刻加载所有优先模型（语义类似 `LOAD_ALL_MODELS_NOW`）。"
		},
		{
			"heading": "特殊角色-id",
			"content": "按 id 加载特殊角色名。"
		},
		{
			"heading": "特殊角色-id",
			"content": "按 id 卸载特殊角色。"
		...
		{
			"heading": "按名查模型",
			"content": "名字 → modelId。用在 `if` 里。"
		},
		{
			"heading": "按名查模型",
			"content": "名字是否可作为有效特殊角色模型。用在 `if` 里。"
		},
		{
			"heading": "空闲-id--清理",
			"content": "在 `[start, end]` 区间找一个尚未占用的 modelId。"
		},
		{
			"heading": "空闲-id--清理",
			"content": "清掉未使用模型。"
		...
		{
			"heading": "空闲-id--清理",
			"content": "指定模型未用则从内存卸掉。"
		},
		{
			"heading": "modelinfo",
			"content": "modelId → modelInfo 地址。用在 `if` 里。"
		},
		{
			"heading": "specialmodel",
			"content": "按 dff/txd 名加载 specialModel。用在 `if` 里。"
		},
		{
			"heading": "specialmodel",
			"content": "卸载 specialModel。"
		},
		{
			"heading": "specialmodel",
			"content": "取 specialModel 的 clump / atomic / txd 下标。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#优先模型",
		title: jsx(Fragment, { children: "优先模型" })
	},
	{
		depth: 2,
		url: "#特殊角色-id",
		title: jsx(Fragment, { children: "特殊角色 id" })
	},
	{
		depth: 2,
		url: "#按名查模型",
		title: jsx(Fragment, { children: "按名查模型" })
	},
	{
		depth: 2,
		url: "#空闲-id--清理",
		title: jsx(Fragment, { children: "空闲 id / 清理" })
	},
	{
		depth: 2,
		url: "#modelinfo",
		title: jsx(Fragment, { children: "modelInfo" })
	},
	{
		depth: 2,
		url: "#specialmodel",
		title: jsx(Fragment, { children: "specialModel" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(_components.p, { children: [
			"模型请求 / 特殊角色 / 池清理。",
			jsx(_components.code, { children: "0E7F" }),
			" 见 ",
			jsx(_components.a, {
			...
			"（",
			jsx(_components.code, { children: "GET_MODEL_TYPE" }),
			"）。写法见 ",
			jsx(_components.a, {
		...
		jsxs(Opcode, {
			id: "0E98",
			name: "REQUEST_PRIORITY_MODEL",
			member: "Streaming.RequestPriorityModel",
			children: [jsx(_components.p, { children: "请求优先加载模型。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0E98 REQUEST_PRIORITY_MODEL" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0E99",
			name: "LOAD_ALL_PRIORITY_MODELS_NOW",
			member: "Streaming.LoadAllPriorityModelsNow",
			children: [jsxs(_components.p, { children: [
				"立刻加载所有优先模型（语义类似 ",
				jsx(_components.code, { children: "LOAD_ALL_MODELS_NOW" }),
				"）。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0E99 LOAD_ALL_PRIORITY_MODELS_NOW" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "loadAllPriorityModelsNow"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
		...
		jsxs(Opcode, {
			id: "0E9A",
			name: "LOAD_SPECIAL_CHARACTER_FOR_ID",
			member: "Streaming.LoadSpecialCharacterForId",
			children: [jsx(_components.p, { children: "按 id 加载特殊角色名。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0E9A LOAD_SPECIAL_CHARACTER_FOR_ID" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: id, name" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "loadSpecialCharacterForId"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			id: "0E9B",
			name: "UNLOAD_SPECIAL_CHARACTER_FROM_ID",
			member: "Streaming.UnloadSpecialCharacterFromId",
			children: [jsx(_components.p, { children: "按 id 卸载特殊角色。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0E9B UNLOAD_SPECIAL_CHARACTER_FROM_ID" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "unloadSpecialCharacterFromId"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Streaming.GetModelByName",
			children: [jsxs(_components.p, { children: [
				"名字 → modelId。用在 ",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0E9C GET_MODEL_BY_NAME" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0E9D",
			name: "IS_MODEL_AVAILABLE_BY_NAME",
			member: "Streaming.IsModelAvailableByName",
			children: [jsxs(_components.p, { children: [
				"名字是否可作为有效特殊角色模型。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0E9D IS_MODEL_AVAILABLE_BY_NAME" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " isModelAvailableByName"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			id: "0E9E",
			name: "GET_MODEL_DOESNT_EXIST_IN_RANGE",
			children: [jsxs(_components.p, { children: [
				"在 ",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0E9E GET_MODEL_DOESNT_EXIST_IN_RANGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: start, end" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " getModelDoesntExistInRange"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "\"GET_MODEL_DOESNT_EXIST_IN_RANGE\""
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			id: "0E9F",
			name: "REMOVE_ALL_UNUSED_MODELS",
			member: "Streaming.RemoveAllUnusedModels",
			children: [jsx(_components.p, { children: "清掉未使用模型。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0E9F REMOVE_ALL_UNUSED_MODELS" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "removeAllUnusedModels"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
		...
		jsxs(Opcode, {
			id: "0EA3",
			name: "REMOVE_MODEL_IF_UNUSED",
			member: "Streaming.RemoveModelIfUnused",
			children: [jsx(_components.p, { children: "指定模型未用则从内存卸掉。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0EA3 REMOVE_MODEL_IF_UNUSED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0EF8",
			name: "GET_MODEL_INFO",
			member: "Streaming.GetModelInfo",
			children: [jsxs(_components.p, { children: [
				"modelId → modelInfo 地址。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0EF8 GET_MODEL_INFO" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: modelInfo" })
								})
							] })
						}) })
					}),
		...
		jsx(_components.h2, {
			id: "specialmodel",
			children: "specialModel"
		}),
		"\n",
		jsxs(Opcode, {
			id: "0F00",
			name: "LOAD_SPECIAL_MODEL",
			member: "Streaming.LoadSpecialModel",
			children: [jsxs(_components.p, { children: [
				"按 dff/txd 名加载 specialModel。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0F00 LOAD_SPECIAL_MODEL" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: dff, txd" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: specialModel" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0F01",
			name: "REMOVE_SPECIAL_MODEL",
			member: "Streaming.RemoveSpecialModel",
			children: [jsx(_components.p, { children: "卸载 specialModel。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0F01 REMOVE_SPECIAL_MODEL" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: specialModel" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0F05",
			name: "GET_SPECIAL_MODEL_DATA",
			member: "Streaming.GetSpecialModelData",
			children: [jsx(_components.p, { children: "取 specialModel 的 clump / atomic / txd 下标。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0F05 GET_SPECIAL_MODEL_DATA" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: clump, atomic, txdIndex" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " clump, atomic, txdIndex "
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#D73A49",

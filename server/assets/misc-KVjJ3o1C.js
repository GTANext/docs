...
//#region content/docs/cleo/sa/misc.mdx?collection=docs
var frontmatter = {
	"title": "杂项",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "无独立 class 或占位类 op。若 JSON 里还有 `none` class 条目，补进本页。"
		},
		{
			"heading": void 0,
		...
		{
			"heading": "nop--占位",
			"content": "部分环境用空指令垫对齐；无业务效果。具体 opcode 以你装的 CLEO 版本为准。"
		}
	],
	"headings": [{
		"id": "nop--占位",
...
var toc = [{
	depth: 2,
	url: "#nop--占位",
	title: jsx(Fragment, { children: "NOP / 占位" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		"\n",
		jsxs(_components.p, { children: [
			"无独立 class 或占位类 op。若 JSON 里还有 ",
			jsx(_components.code, { children: "none" }),
			" class 条目，补进本页。"
		] }),
		"\n",
		jsxs(_components.p, { children: [
		...
		"\n",
		jsx(_components.p, { children: "部分环境用空指令垫对齐；无业务效果。具体 opcode 以你装的 CLEO 版本为准。" }),
		"\n",
		jsxs(CodeBlockTabs, {
			defaultValue: "Lua",
			children: [
						...
						children: jsxs(_components.code, { children: [
							jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// 无统一 Redux 符号；按具体 opcode 用 native(\"…\")"
								})
							}),
							"\n",
							jsxs(_components.span, {

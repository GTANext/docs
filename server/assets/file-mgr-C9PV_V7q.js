...
//#region content/docs/plugins/entities/file-mgr.mdx?collection=docs
var frontmatter = {
	"title": "文件 CFileMgr",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "游戏目录相对路径读写。`FILESTREAM` 是 `int` 句柄，不是 `FILE*`。"
		},
		{
			"heading": "注意",
			"content": "点"
		...
		{
			"heading": "注意",
			"content": "简单 ini 优先 `plugin::config` / 扩展 Config"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#工作目录",
		title: jsx(Fragment, { children: "工作目录" })
	},
	{
		depth: 2,
		url: "#打开关闭",
		title: jsx(Fragment, { children: "打开关闭" })
	},
	{
		depth: 2,
		url: "#读写定位",
		title: jsx(Fragment, { children: "读写定位" })
	},
	{
		depth: 2,
		url: "#一次载入",
		title: jsx(Fragment, { children: "一次载入" })
	},
	{
		depth: 2,
		url: "#注意",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CFileMgr.h" }) }),
		"\n",
		jsxs(_components.p, { children: [
			"游戏目录相对路径读写。",
			jsx(_components.code, { children: "FILESTREAM" }),
			" 是 ",
		...
		"\n",
		jsx(Api, {
			name: "SetDir / ChangeDir / SetDirMyDocuments",
		...
		jsxs(_components.table, { children: [jsx(_components.thead, { children: jsxs(_components.tr, { children: [jsx(_components.th, { children: "点" }), jsx(_components.th, { children: "说明" })] }) }), jsxs(_components.tbody, { children: [
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "路径" }), jsxs(_components.td, { children: ["相对游戏目录；自定义文件也可用 ", jsx(_components.a, {
				href: "/docs/plugins/extensions/paths",
				children: "路径"
			})] })] }),
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "句柄" }), jsxs(_components.td, { children: [
				jsx(_components.code, { children: "FILESTREAM" }),
				" ≠ CRT ",
				jsx(_components.code, { children: "FILE*" })
			] })] }),
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "ASI 配置" }), jsxs(_components.td, { children: [
				"简单 ini 优先 ",
				jsx(_components.code, { children: "plugin::config" }),
				" / 扩展 Config"
			] })] })
		] })] })
	] });

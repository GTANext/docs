...
var toc = [
	{
		depth: 2,
		url: "#按-id-取模型信息",
		title: jsx(Fragment, { children: "按 id 取模型信息" })
	},
	{
		depth: 2,
		url: "#按名字取模型",
		title: jsx(Fragment, { children: "按名字取模型" })
	},
	{
		depth: 2,
		url: "#判断行人--载具",
		title: jsx(Fragment, { children: "判断行人 / 载具" })
	},
	{
		depth: 2,
		url: "#判断载具子类",
		title: jsx(Fragment, { children: "判断载具子类" })
	},
	{
		depth: 2,
		url: "#遍历同类型模型",
		title: jsx(Fragment, { children: "遍历同类型模型" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CModelInfo.h" }) }),
		"\n",
		jsxs(_components.p, { children: [
			"按模型 id 查 ",
			jsx(_components.code, { children: "CBaseModelInfo*" }),
			"；换皮 / 判断车型常用。"
		] }),
		"\n",
		jsx(_components.h2, {
		...
		"\n",
		jsx(Api, {
			name: "GetModelInfo / ms_modelInfoPtrs",
		...
		"\n",
		jsx(Api, {
			name: "GetModelInfo(name) / GetModelInfoFromHashKey",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetModelInfoFromHashKey"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsx(Api, {
			name: "IsPedModel / IsVehicleModel",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsx(Api, {
			name: "GetVehicleModelType / IsCarModel / IsHeliModel",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// int next = CModelInfo::FindNextModel(type, startId);"
								})
							}) })
						}) })
					})

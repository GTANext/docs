...
//#region content/docs/cleo/sa/plus/memory.mdx?collection=docs
var frontmatter = {
	"title": "内存 Memory",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "拷贝",
			"content": "从 `src` 拷 `size` 字节到 `dest`。"
		},
		{
			"heading": "结构体下标",
			"content": "按下标写结构体 dword：`address + index*4`。"
		},
		{
			"heading": "结构体下标",
			"content": "按下标读结构体 dword。"
		},
		{
			"heading": "偏移读写",
			"content": "从 `address+offset` 按 `size` 读值。"
		},
		{
			"heading": "偏移读写",
			"content": "往 `address+offset` 按 `size` 写值（与 `0D4E` 配对；下标版见 `0D37`）。"
		},
		{
			"heading": "nop",
			"content": "从 `address` 起写 `size` 个 `0x90`。"
		},
		{
			"heading": "最近自定义脚本",
			"content": "最近一次创建的自定义脚本地址。用在 `if` 里。"
		},
		{
			"heading": "连续多值",
			"content": "从 `address+offset` 按 `size` 连续读 `count` 个值（数组/向量）。"
		},
		{
			"heading": "连续多值",
			"content": "往 `address+offset` 连续写多个值。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#拷贝",
		title: jsx(Fragment, { children: "拷贝" })
	},
	{
		depth: 2,
		url: "#结构体下标",
		title: jsx(Fragment, { children: "结构体下标" })
	},
	{
		depth: 2,
		url: "#偏移读写",
		title: jsx(Fragment, { children: "偏移读写" })
	},
	{
		depth: 2,
		url: "#nop",
		title: jsx(Fragment, { children: "NOP" })
	},
	{
		depth: 2,
		url: "#最近自定义脚本",
		title: jsx(Fragment, { children: "最近自定义脚本" })
	},
	{
		depth: 2,
		url: "#连续多值",
		title: jsx(Fragment, { children: "连续多值" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D27 COPY_MEMORY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0D37",
			name: "WRITE_STRUCT_PARAM",
			member: "Memory.WriteStructParam",
			children: [jsxs(_components.p, { children: [
				"按下标写结构体 dword：",
				jsx(_components.code, { children: "address + index*4" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D37 WRITE_STRUCT_PARAM" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: address, index, value" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0D38",
			name: "READ_STRUCT_PARAM",
			member: "Memory.ReadStructParam",
			children: [jsx(_components.p, { children: "按下标读结构体 dword。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D38 READ_STRUCT_PARAM" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: address, index" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0D4E",
			name: "READ_STRUCT_OFFSET",
			member: "Memory.ReadStructOffset",
			children: [jsxs(_components.p, { children: [
				"从 ",
				jsx(_components.code, { children: "address+offset" }),
				" 按 ",
				jsx(_components.code, { children: "size" }),
				" 读值。"
			] }), jsxs(CodeBlockTabs, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D4E READ_STRUCT_OFFSET" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0E28",
			name: "WRITE_STRUCT_OFFSET",
			member: "Memory.WriteStructOffset",
			children: [jsxs(_components.p, { children: [
				"往 ",
				jsx(_components.code, { children: "address+offset" }),
				" 按 ",
				jsx(_components.code, { children: "size" }),
				" 写值（与 ",
				jsx(_components.code, { children: "0D4E" }),
				" 配对；下标版见 ",
				jsx(_components.code, { children: "0D37" }),
				"）。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0E28 WRITE_STRUCT_OFFSET" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			children: [jsxs(_components.p, { children: [
				...
				jsx(_components.code, { children: "size" }),
				" 个 ",
				jsx(_components.code, { children: "0x90" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0E6A MAKE_NOP" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: address, size" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0E70",
			name: "GET_LAST_CREATED_CUSTOM_SCRIPT",
			member: "Memory.GetLastCreatedCustomScript",
			children: [jsxs(_components.p, { children: [
				"最近一次创建的自定义脚本地址。用在 ",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0E70 GET_LAST_CREATED_CUSTOM_SCRIPT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " getLastCreatedCustomScript"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			id: "0EE2",
			name: "READ_STRUCT_OFFSET_MULTI",
			member: "Memory.ReadStructOffsetMulti",
			children: [jsxs(_components.p, { children: [
				"从 ",
				jsx(_components.code, { children: "address+offset" }),
				" 按 ",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0EE2 READ_STRUCT_OFFSET_MULTI" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: address, offset, count, size" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: results" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " readStructOffsetMulti"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "(address, offset, count, size)"
									})
								]
							}) })
						}) })
		...
		jsxs(Opcode, {
			id: "0EE3",
			name: "WRITE_STRUCT_OFFSET_MULTI",
			member: "Memory.WriteStructOffsetMulti",
			children: [jsxs(_components.p, { children: [
				"往 ",
				jsx(_components.code, { children: "address+offset" }),
				" 连续写多个值。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0EE3 WRITE_STRUCT_OFFSET_MULTI" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: address, offset, count, size, params" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "writeStructOffsetMulti"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",

...
//#region content/docs/plugins/extensions/config.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "打开-ini",
			"content": "`usePluginName=true` 时使用与 ASI 同名的 ini。写完后记得 `save()`。"
		},
		{
			"heading": "读配置项",
			"content": "数组在文件中用空格分隔。"
...
var toc = [
	{
		depth: 2,
		url: "#打开-ini",
		title: jsx(Fragment, { children: "打开 ini" })
	},
	{
		depth: 2,
		url: "#读配置项",
		title: jsx(Fragment, { children: "读配置项" })
	},
	{
		depth: 2,
		url: "#写配置项",
		title: jsx(Fragment, { children: "写配置项" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "Config.h" }) }),
		"\n",
		jsx(_components.h2, {
			id: "打开-ini",
			children: "打开 ini"
		...
		jsxs(Api, {
			...
			children: [jsxs(_components.p, { children: [
				jsx(_components.code, { children: "usePluginName=true" }),
				" 时使用与 ASI 同名的 ini。写完后记得 ",
				jsx(_components.code, { children: "save()" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		"\n",
		jsxs(Api, {
			name: "asFloat / asInt / asString / asBool …",
			children: [jsx(_components.p, { children: "数组在文件中用空格分隔。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// asRect asVec2d asVec3d asFloatArray asBoolArray isEmpty"
									})
								})
							] })
						}) })

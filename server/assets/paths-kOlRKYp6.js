...
//#region content/docs/plugins/extensions/paths.mdx?collection=docs
var frontmatter = {
	"title": "路径 paths",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`Paths.h` · `plugin::paths`"
		},
		{
			"heading": void 0,
			"content": "多数接口返回 **静态缓冲**，下一次调用会覆盖。需要长期保存时拷到 `std::string`。"
		},
		{
			"heading": "取游戏与插件目录",
			"content": "窄字符：游戏根目录与本 ASI 所在目录。"
		},
		{
			"heading": "拼相对路径",
			"content": "根目录 + 相对子路径。也有写入外部缓冲的重载。"
		},
		{
			"heading": "路径宏",
			"content": "日常写 ini / 资源路径最省事："
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#取游戏与插件目录",
		title: jsx(Fragment, { children: "取游戏与插件目录" })
	},
	{
		depth: 2,
		url: "#宽字符目录",
		title: jsx(Fragment, { children: "宽字符目录" })
	},
	{
		depth: 2,
		url: "#拼相对路径",
		title: jsx(Fragment, { children: "拼相对路径" })
	},
	{
		depth: 2,
		url: "#宽字符相对路径",
		title: jsx(Fragment, { children: "宽字符相对路径" })
	},
	{
		depth: 2,
		url: "#按类型拼路径",
		title: jsx(Fragment, { children: "按类型拼路径" })
	},
	{
		depth: 2,
		url: "#本-asi-文件名",
		title: jsx(Fragment, { children: "本 ASI 文件名" })
	},
	{
		depth: 2,
		url: "#路径宏",
		title: jsx(Fragment, { children: "路径宏" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "Paths.h" }),
			" · ",
			jsx(_components.code, { children: "plugin::paths" })
		] }),
		"\n",
		jsxs(_components.p, { children: [
			"多数接口返回 ",
			jsx(_components.strong, { children: "静态缓冲" }),
			"，下一次调用会覆盖。需要长期保存时拷到 ",
			jsx(_components.code, { children: "std::string" }),
			"。"
		] }),
		"\n",
		jsx(_components.h2, {
		...
		"\n",
		jsxs(Api, {
			name: "GetGameDirPathA / GetPluginDirPathA",
			children: [jsx(_components.p, { children: "窄字符：游戏根目录与本 ASI 所在目录。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		"\n",
		jsx(Api, {
			name: "GetGameDirPathW / GetPluginDirPathW",
		...
		"\n",
		jsxs(Api, {
			name: "GetGameDirRelativePathA / GetPluginDirRelativePathA",
			children: [jsx(_components.p, { children: "根目录 + 相对子路径。也有写入外部缓冲的重载。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetGameDirRelativePathA"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetPluginDirRelativePathA"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsx(Api, {
			name: "GetGameDirRelativePathW / GetPluginDirRelativePathW",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetGameDirRelativePathW"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetPluginDirRelativePathW"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsx(Api, {
			name: "GetPluginFileNameA / GetPluginFileNameW",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsx(_components.p, { children: "日常写 ini / 资源路径最省事：" }),
		"\n",
		jsxs(CodeBlockTabs, {
			defaultValue: "签名",
			children: [

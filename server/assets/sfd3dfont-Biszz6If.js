...
//#region content/docs/cleo/sa/ext/sampfuncs/sfd3dfont.mdx?collection=docs
var frontmatter = {
	"title": "字体 SfD3DFont",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "共 5 条。调用见 Lua / Redux。"
		},
		{
			"heading": "尺寸",
			"content": "返回使用该字体绘制文本所占像素宽度。"
		},
		{
			"heading": "尺寸",
			"content": "返回使用该字体时文本所占像素高度。"
		},
		{
			"heading": "生命周期--绘制",
			"content": "创建 D3DFont 对象。"
		},
		{
			"heading": "生命周期--绘制",
			"content": "销毁指定字体对象并释放内存。用在 `if` 里。"
		},
		{
			"heading": "生命周期--绘制",
			"content": "用指定字体绘制文本。"
...
var toc = [{
	depth: 2,
	url: "#尺寸",
	title: jsx(Fragment, { children: "尺寸" })
}, {
	depth: 2,
	url: "#生命周期--绘制",
	title: jsx(Fragment, { children: "生命周期 / 绘制" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0B6B",
			name: "SF_D3D_GET_DRAW_WIDTH_OF_TEXT_WITH_FONT",
			member: "SfD3DFont.GetDrawWidth",
			children: [jsx(_components.p, { children: "返回使用该字体绘制文本所占像素宽度。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B6B SF_D3D_GET_DRAW_WIDTH_OF_TEXT_WITH_FONT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, text" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: width" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " sfD3dGetDrawWidthOfTextWithFont"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			id: "0B6C",
			name: "SF_D3D_GET_FONT_DRAW_HEIGHT",
			member: "SfD3DFont.GetDrawHeight",
			children: [jsx(_components.p, { children: "返回使用该字体时文本所占像素高度。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B6C SF_D3D_GET_FONT_DRAW_HEIGHT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: height" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " sfD3dGetFontDrawHeight"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			id: "0B6D",
			name: "SF_D3D_CREATE_FONT",
			member: "SfD3DFont.Create",
			children: [jsx(_components.p, { children: "创建 D3DFont 对象。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B6D SF_D3D_CREATE_FONT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: fontName, size, styleFlags" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "(fontName, size, styleFlags)"
									})
								]
							}) })
						}) })
		...
		jsxs(Opcode, {
			id: "0B6E",
			name: "SF_D3D_DELETE_FONT",
			member: "SfD3DFont.Delete",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B6E SF_D3D_DELETE_FONT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0B6F",
			name: "SF_D3D_DRAW_TEXT_WITH_FONT",
			member: "SfD3DFont.DrawText",
			children: [jsx(_components.p, { children: "用指定字体绘制文本。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B6F SF_D3D_DRAW_TEXT_WITH_FONT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, text, coordX, coordY, color" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "sfD3dDrawTextWithFont"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
									...
									jsx(_components.span, {
										...
										children: ", text, coordX, coordY, color)"
									})
								]
							}) })
						}) })
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "(self, text, coordX, coordY, color)"
									})
								]
							}) })
						}) })

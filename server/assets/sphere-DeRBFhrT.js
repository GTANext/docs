...
//#region content/docs/cleo/sa/ext/sphere.mdx?collection=docs
var frontmatter = {
	"title": "球体 Sphere",
	"description": "球体显示颜色"
};
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`sa` · 扩展 `Sphere` · 需对应 CLEO 扩展"
		},
		{
			"heading": void 0,
...
var toc = [{
	depth: 2,
	url: "#设球体颜色",
	title: jsx(Fragment, { children: "设球体颜色" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			...
			" · 扩展 ",
			jsx(_components.code, { children: "Sphere" }),
			" · 需对应 CLEO 扩展"
		] }),
		"\n",
		jsxs(_components.p, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Sphere.SetColor",
			children: [jsx(_components.p, { children: "改球体显示颜色。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "2880 SET_SPHERE_COLOR" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, r, g, b" })
								})
							] })
						}) })
					}),

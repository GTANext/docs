...
var structuredData = {
	"contents": [
		...
		{
			"heading": "读写原始字节",
			"content": "任意长度字节块。修改代码路径前务必备份。"
		},
		{
			"heading": "重定向-call--jump",
			"content": "改写 `E8` call、`E9` 跳转或短跳。`address` 指向 **指令本身** 的起始地址。"
		},
		{
			"heading": "替换函数入口",
			"content": "入口整体替换，或只替换 call 点。"
		},
		{
			"heading": "写-ret-返回",
			"content": "写入返回指令。`Retn0` / `Retn1` 会先让函数返回 0 / 1。`BytesToPop` 用于 stdcall 清栈。"
		},
		{
			"heading": "解析跳转目标",
			"content": "解析 `E8` / `E9` 的目标地址。若该处不是对应 opcode，结果为空。"
		},
		{
			"heading": "批量改多地址",
			"content": "同一操作可对一组地址执行。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#写-nop",
		title: jsx(Fragment, { children: "写 NOP" })
	},
	{
		depth: 2,
		url: "#读写-1-字节",
		title: jsx(Fragment, { children: "读写 1 字节" })
	},
	{
		depth: 2,
		url: "#读写-2-字节",
		title: jsx(Fragment, { children: "读写 2 字节" })
	},
	{
		depth: 2,
		url: "#读写-4-字节整数",
		title: jsx(Fragment, { children: "读写 4 字节整数" })
	},
	{
		depth: 2,
		url: "#读写-float",
		title: jsx(Fragment, { children: "读写 float" })
	},
	{
		depth: 2,
		url: "#读写指针",
		title: jsx(Fragment, { children: "读写指针" })
	},
	{
		depth: 2,
		url: "#模板读写-pod",
		title: jsx(Fragment, { children: "模板读写 POD" })
	},
	{
		depth: 2,
		url: "#读写原始字节",
		title: jsx(Fragment, { children: "读写原始字节" })
	},
	{
		depth: 2,
		url: "#重定向-call--jump",
		title: jsx(Fragment, { children: "重定向 call / jump" })
	},
	{
		depth: 2,
		url: "#替换函数入口",
		title: jsx(Fragment, { children: "替换函数入口" })
	},
	{
		depth: 2,
		url: "#写-ret-返回",
		title: jsx(Fragment, { children: "写 ret 返回" })
	},
	{
		depth: 2,
		url: "#解析跳转目标",
		title: jsx(Fragment, { children: "解析跳转目标" })
	},
	{
		depth: 2,
		url: "#批量改多地址",
		title: jsx(Fragment, { children: "批量改多地址" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "shared/Patch.h" }),
			" · ",
			jsx(_components.code, { children: "plugin::patch" })
		] }),
		"\n",
		jsxs(_components.p, { children: [
			"大多数写入 API 的 ",
			...
			"（内部 ",
			jsx(_components.code, { children: "VirtualProtect" }),
			"）。改代码前先 ",
		...
		jsx(Callout, {
			type: "warn",
			title: "可逆",
			children: jsx(_components.p, { children: "可开关的修改务必保存原始字节或数值，不要把「默认值」写死在还原路径里。" })
		}),
		"\n",
		jsx(_components.h2, {
			id: "写-nop",
		...
		jsxs(Api, {
			...
			children: [jsxs(_components.p, { children: [
				jsx(_components.code, { children: "Nop" }),
				" 写入 ",
				jsx(_components.code, { children: "0x90" }),
				"。",
				jsx(_components.code, { children: "NopRestore" }),
				" 还原 SDK 记录的那一次 Nop。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		"\n",
		jsxs(Api, {
			name: "SetFloat / GetFloat",
			children: [jsx(_components.p, { children: "改倍率等浮点配置时：先备份再写，关闭时还原。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsxs(Api, {
			name: "SetPointer / GetPointer",
			children: [jsx(_components.p, { children: "按指针宽度读写。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		jsxs(Api, {
			name: "Set / Get（模板）",
			children: [jsx(_components.p, { children: "任意 POD 类型读写。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		jsxs(Api, {
			name: "SetRaw / GetRaw",
			children: [jsx(_components.p, { children: "任意长度字节块。修改代码路径前务必备份。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		jsx(_components.h2, {
			id: "重定向-call--jump",
			children: "重定向 call / jump"
		}),
		"\n",
		jsxs(Api, {
			name: "RedirectCall / RedirectJump / RedirectShortJump",
			children: [jsxs(_components.p, { children: [
				"改写 ",
				jsx(_components.code, { children: "E8" }),
				" call、",
				jsx(_components.code, { children: "E9" }),
				" 跳转或短跳。",
				jsx(_components.code, { children: "address" }),
				" 指向 ",
				jsx(_components.strong, { children: "指令本身" }),
				" 的起始地址。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		"\n",
		jsxs(Api, {
			name: "ReplaceFunction / ReplaceFunctionCall",
			children: [jsx(_components.p, { children: "入口整体替换，或只替换 call 点。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsxs(Api, {
			name: "PutRetn / PutRetn0 / PutRetn1",
			children: [jsxs(_components.p, { children: [
				"写入返回指令。",
				jsx(_components.code, { children: "Retn0" }),
				" / ",
				jsx(_components.code, { children: "Retn1" }),
				" 会先让函数返回 0 / 1。",
				jsx(_components.code, { children: "BytesToPop" }),
				" 用于 stdcall 清栈。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		"\n",
		jsxs(Api, {
			name: "TranslateCallOffset / TranslateJumpOffset",
			children: [jsxs(_components.p, { children: [
				"解析 ",
				jsx(_components.code, { children: "E8" }),
				" / ",
				jsx(_components.code, { children: "E9" }),
				" 的目标地址。若该处不是对应 opcode，结果为空。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsx(_components.p, { children: "同一操作可对一组地址执行。" }),
		"\n",
		jsxs(CodeBlockTabs, {
			defaultValue: "签名",
			children: [

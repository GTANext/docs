...
//#region content/docs/cleo/sa/default/txd.mdx?collection=docs
var frontmatter = {
	"title": "贴图 Txd",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "加载精灵",
			"content": "从最近加载的字典（`0390`）取贴图进精灵槽。"
		},
		{
			"heading": "加载字典",
			"content": "加载贴图字典，供屏上画精灵（`038D` 等）。"
		},
		{
			"heading": "卸载字典",
			"content": "卸掉已加载精灵与字典，腾内存。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#加载精灵",
		title: jsx(Fragment, { children: "加载精灵" })
	},
	{
		depth: 2,
		url: "#加载字典",
		title: jsx(Fragment, { children: "加载字典" })
	},
	{
		depth: 2,
		url: "#卸载字典",
		title: jsx(Fragment, { children: "卸载字典" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "038F",
			name: "LOAD_SPRITE",
			member: "Txd.LoadSprite",
			children: [jsxs(_components.p, { children: [
				"从最近加载的字典（",
				jsx(_components.code, { children: "0390" }),
				"）取贴图进精灵槽。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "038F LOAD_SPRITE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: spriteSlot, textureName" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "(spriteSlot, textureName)"
								})]
							}) })
						}) })
					}),
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0390 LOAD_TEXTURE_DICTIONARY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "loadTextureDictionary"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
		...
		jsxs(Opcode, {
			...
			member: "Txd.Remove",
			children: [jsx(_components.p, { children: "卸掉已加载精灵与字典，腾内存。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0391 REMOVE_TEXTURE_DICTIONARY" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "removeTextureDictionary"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"

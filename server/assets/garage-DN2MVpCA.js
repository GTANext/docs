...
//#region content/docs/cleo/sa/default/garage.mdx?collection=docs
var frontmatter = {
	"title": "车库 Garage",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "是否打开",
			"content": "门是否打开。用在 `if` 里。"
		},
		{
			"heading": "是否关闭",
			"content": "门是否关闭。用在 `if` 里。"
		},
		{
			"heading": "喷漆免费",
			"content": "喷漆是否免费。"
...
var toc = [
	{
		depth: 2,
		url: "#任务车库目标车",
		title: jsx(Fragment, { children: "任务车库目标车" })
	},
	{
		depth: 2,
		url: "#激活",
		title: jsx(Fragment, { children: "激活" })
	},
	{
		depth: 2,
		url: "#停用",
		title: jsx(Fragment, { children: "停用" })
	},
	{
		depth: 2,
		url: "#改类型",
		title: jsx(Fragment, { children: "改类型" })
	},
	{
		depth: 2,
		url: "#开门",
		title: jsx(Fragment, { children: "开门" })
	},
	{
		depth: 2,
		url: "#关门",
		title: jsx(Fragment, { children: "关门" })
	},
	{
		depth: 2,
		url: "#是否打开",
		title: jsx(Fragment, { children: "是否打开" })
	},
	{
		depth: 2,
		url: "#是否关闭",
		title: jsx(Fragment, { children: "是否关闭" })
	},
	{
		depth: 2,
		url: "#喷漆免费",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Garage.SetTargetCarForMission",
			children: [jsx(_components.p, { children: "任务车库只认指定车。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "021B SET_TARGET_CAR_FOR_MISSION_GARAGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: garageName, vehicle" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "setTargetCarForMissionGarage"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(garageName, vehicle)"
								})]
							}) })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: "setTargetCarForMission"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Garage.Activate",
			children: [jsx(_components.p, { children: "激活车库。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0299 ACTIVATE_GARAGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: garageId" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Garage.Deactivate",
			children: [jsx(_components.p, { children: "停用车库。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "02B9 DEACTIVATE_GARAGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Garage.ChangeType",
			children: [jsx(_components.p, { children: "改车库类型。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "02FA CHANGE_GARAGE_TYPE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: garageId, type" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			name: "OPEN_GARAGE",
			member: "Garage.Open",
			children: [jsx(_components.p, { children: "开车库门。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0360 OPEN_GARAGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			name: "CLOSE_GARAGE",
			member: "Garage.Close",
			children: [jsx(_components.p, { children: "关车库门。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0361 CLOSE_GARAGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "03B0 IS_GARAGE_OPEN" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "03B1 IS_GARAGE_CLOSED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Garage.SetResprayFree",
			children: [jsx(_components.p, { children: "喷漆是否免费。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "093A SET_GARAGE_RESPRAY_FREE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: garageId, state" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "setGarageResprayFree"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(garageId, state)"
								})]
							}) })
						}) })
					}),

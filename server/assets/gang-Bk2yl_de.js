...
//#region content/docs/cleo/sa/default/gang.mdx?collection=docs
var frontmatter = {
	"title": "帮派 Gang",
	"description": "帮派武器配置"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "共 1 条。写法见 Lua / Redux。"
		},
		{
			"heading": "帮派三武器",
			"content": "设帮派可用的三把武器类型。"
		}
	],
	"headings": [{
		"id": "帮派三武器",
...
var toc = [{
	depth: 2,
	url: "#帮派三武器",
	title: jsx(Fragment, { children: "帮派三武器" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Gang.SetWeapons",
			children: [jsx(_components.p, { children: "设帮派可用的三把武器类型。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0237 SET_GANG_WEAPONS" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: gangId, weaponType1, weaponType2, weaponType3" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "setGangWeapons"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(gangId, weaponType1, weaponType2, weaponType3)"
								})]
							}) })
						}) })
					}),

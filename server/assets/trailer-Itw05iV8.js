...
//#region content/docs/cleo/sa/default/trailer.mdx?collection=docs
var frontmatter = {
	"title": "拖车 Trailer",
	"description": "挂车挂接"
};
...
var toc = [
	{
		depth: 2,
		url: "#是否已挂",
		title: jsx(Fragment, { children: "是否已挂" })
	},
	{
		depth: 2,
		url: "#卸下",
		title: jsx(Fragment, { children: "卸下" })
	},
	{
		depth: 2,
		url: "#挂上",
		title: jsx(Fragment, { children: "挂上" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Trailer.IsAttachedToCab",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07AB IS_TRAILER_ATTACHED_TO_CAB" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: self, cab" })
								})
							] })
						}) })
					}),
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " isTrailerAttachedToCab"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Trailer.DetachFromCab",
			children: [jsx(_components.p, { children: "从牵引车上卸下挂车。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "07AC DETACH_TRAILER_FROM_CAB" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Trailer.AttachToCab",
			children: [jsx(_components.p, { children: "把挂车挂到牵引车上。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0893 ATTACH_TRAILER_TO_CAB" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

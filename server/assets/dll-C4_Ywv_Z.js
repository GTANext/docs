...
//#region content/docs/cleo/gta3/dll.mdx?collection=docs
var frontmatter = {
...
var toc = [
	{
		depth: 2,
		url: "#加载动态库",
		title: jsx(Fragment, { children: "加载动态库" })
	},
	{
		depth: 2,
		url: "#卸载动态库",
		title: jsx(Fragment, { children: "卸载动态库" })
	},
	{
		depth: 2,
		url: "#取导出过程地址",
		title: jsx(Fragment, { children: "取导出过程地址" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "加载 DLL。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "卸载。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "取导出地址。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {

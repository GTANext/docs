...
//#region content/docs/plugins/extender.mdx?collection=docs
var frontmatter = {
	"title": "附加数据 Extender",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`shared/extender/PedExtender.h`\\\n另有 `VehicleExtender.h`、`ObjectExtender.h`"
		},
		{
			"heading": void 0,
			"content": "`T` 必须能构造：`T(CPed*)` / `T(CVehicle*)` / `T(CObject*)`。\\\n`*ExtendedData` 放在全局或静态存储。实体析构后不要再 `Get`。"
		},
		{
			"heading": "行人附加数据",
			"content": "每个 ped 一块 `T`，随实体生命周期管理。"
		},
		{
			"heading": "注册自定义扩展器",
			"content": "`PedExtendedData` 构造时会自行 `Add`。需要自定义 `ExtenderInterface` 时："
		},
		{
			"heading": "注册自定义扩展器",
			"content": "Vehicle / Object 有对应的 Handler。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#行人附加数据",
		title: jsx(Fragment, { children: "行人附加数据" })
	},
	{
		depth: 2,
		url: "#载具附加数据",
		title: jsx(Fragment, { children: "载具附加数据" })
	},
	{
		depth: 2,
		url: "#物体附加数据",
		title: jsx(Fragment, { children: "物体附加数据" })
	},
	{
		depth: 2,
		url: "#注册自定义扩展器",
		title: jsx(Fragment, { children: "注册自定义扩展器" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "shared/extender/PedExtender.h" }),
			jsx(_components.br, {}),
			"\n",
			"另有 ",
			jsx(_components.code, { children: "VehicleExtender.h" }),
			"、",
			jsx(_components.code, { children: "ObjectExtender.h" })
		] }),
		"\n",
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "T" }),
			" 必须能构造：",
			jsx(_components.code, { children: "T(CPed*)" }),
			" / ",
			jsx(_components.code, { children: "T(CVehicle*)" }),
			" / ",
			jsx(_components.code, { children: "T(CObject*)" }),
			"。",
			jsx(_components.br, {}),
			"\n",
			jsx(_components.code, { children: "*ExtendedData" }),
			" 放在全局或静态存储。实体析构后不要再 ",
		...
		"\n",
		jsxs(Api, {
			name: "PedExtendedData",
			header: "extender/PedExtender.h",
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// g_obj_data.Get(obj).from_menu = true;"
									})
								})
							] })
						}) })
		...
		"\n",
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "PedExtendedData" }),
			" 构造时会自行 ",
			jsx(_components.code, { children: "Add" }),
			"。需要自定义 ",
			jsx(_components.code, { children: "ExtenderInterface" }),
			" 时："
		] }),
		"\n",
		...
		"\n",
		jsx(_components.p, { children: "Vehicle / Object 有对应的 Handler。" })
	] });
}

...
//#region content/docs/cleo/sa/ext/newopcodes/print.mdx?collection=docs
var frontmatter = {
	"title": "打印 PrintText",
	"description": "临时屏上文字"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "临时屏上文字（基础 / 全格式）。写法见 Lua / Redux。"
		},
		{
			"heading": "基础",
			"content": "在屏幕位置画临时文字：缩放 + 字体样式。"
		},
		{
			"heading": "全格式",
			"content": "全格式临时文字：对齐、换行、颜色、描边、阴影、背景等。"
		}
	],
	"headings": [{
		"id": "基础",
...
var toc = [{
	depth: 2,
	url: "#基础",
	title: jsx(Fragment, { children: "基础" })
}, {
	depth: 2,
	url: "#全格式",
	title: jsx(Fragment, { children: "全格式" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0D65",
			name: "PRINT_TEMPORARY_TEXT",
			children: [jsx(_components.p, { children: "在屏幕位置画临时文字：缩放 + 字体样式。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D65 PRINT_TEMPORARY_TEXT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: text, x, y, widthScale, heightScale, style" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: ", text, x, y, widthScale, heightScale, style)"
									})
								]
							}) })
						}) })
		...
		jsxs(Opcode, {
			id: "0D66",
			name: "PRINT_TEMPORARY_TEXT_EX",
			children: [jsx(_components.p, { children: "全格式临时文字：对齐、换行、颜色、描边、阴影、背景等。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0D66 PRINT_TEMPORARY_TEXT_EX" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: text, x, y, widthScale, heightScale, style, prop, align, wrap, justify," })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "    red, green, blue, alpha, outline, shadow," })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "  outline, shadow, dropRed, dropGreen, dropBlue, dropAlpha,"
									})
								}),
								"\n",
								jsx(_components.span, {

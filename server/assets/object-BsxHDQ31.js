...
//#region content/docs/plugins/entities/object.mdx?collection=docs
var frontmatter = {
	"title": "物体 CObject",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`CObject.h` · 继承 `CPhysical`"
		},
		{
			"heading": void 0,
			"content": "逻辑帧改；drawing 只读。"
		},
		{
			"heading": "创建与类型",
			"content": "也可用 Command 创建后 `CPools::GetObject`。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#创建与类型",
		title: jsx(Fragment, { children: "创建与类型" })
	},
	{
		depth: 2,
		url: "#血量与缩放",
		title: jsx(Fragment, { children: "血量与缩放" })
	},
	{
		depth: 2,
		url: "#伤害与爆炸",
		title: jsx(Fragment, { children: "伤害与爆炸" })
	},
	{
		depth: 2,
		url: "#可锁定目标",
		title: jsx(Fragment, { children: "可锁定目标" })
	},
	{
		depth: 2,
		url: "#门行为",
		title: jsx(Fragment, { children: "门行为" })
	},
	{
		depth: 2,
		url: "#绳索",
		title: jsx(Fragment, { children: "绳索" })
	},
	{
		depth: 2,
		url: "#重映射贴图",
		title: jsx(Fragment, { children: "重映射贴图" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "CObject.h" }),
			" · 继承 ",
			jsx(_components.code, { children: "CPhysical" })
		] }),
		"\n",
		jsx(_components.p, { children: "逻辑帧改；drawing 只读。" }),
		"\n",
		jsx(_components.h2, {
			id: "创建与类型",
			children: "创建与类型"
		...
		"\n",
		jsxs(Api, {
			name: "CObject / m_nObjectType",
			children: [jsxs(_components.p, { children: [
				"也可用 Command 创建后 ",
				jsx(_components.code, { children: "CPools::GetObject" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// 推荐：Command CREATE_OBJECT 再 GetObject(handle)"
								})
							}) })
						}) })
					})
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// m_nObjectFlags bitfield"
									})
								})
							] })
						}) })
		...
		"\n",
		jsx(Api, {
			name: "ObjectDamage / Explode / TryToExplode",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsx(Api, {
			name: "SetObjectTargettable / CanBeTargetted",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsx(Api, {
			name: "GetRopeHeight / SetRopeHeight",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetObjectCarriedWithRope"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " ReleaseObjectCarriedWithRope"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// obj->SetRemapTexture(tex, txdIndex);"
								})
							}) })
						}) })
					})

...
//#region content/docs/plugins/entities/explosion.mdx?collection=docs
var frontmatter = {
	"title": "爆炸 CExplosion",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`CExplosion.h`"
		},
		{
			"heading": void 0,
			"content": "逻辑帧。与 `CWorld::TriggerExplosion` 不同：这是爆炸槽表。"
		},
		{
			"heading": "添加爆炸",
			"content": "`eExplosionType` 见头文件。"
		},
		{
			"heading": "爆炸类型",
			"content": "手雷、燃烧瓶、火箭、车、船、飞机、小爆炸等。"
		},
		{
			"heading": "全局表",
			"content": "也可用 `CWorld::TriggerExplosion` 做世界伤害扩散，见 世界。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#添加爆炸",
		title: jsx(Fragment, { children: "添加爆炸" })
	},
	{
		depth: 2,
		url: "#爆炸类型",
		title: jsx(Fragment, { children: "爆炸类型" })
	},
	{
		depth: 2,
		url: "#清爆炸",
		title: jsx(Fragment, { children: "清爆炸" })
	},
	{
		depth: 2,
		url: "#区域是否有爆炸",
		title: jsx(Fragment, { children: "区域是否有爆炸" })
	},
	{
		depth: 2,
		url: "#读槽信息",
		title: jsx(Fragment, { children: "读槽信息" })
	},
	{
		depth: 2,
		url: "#全局表",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CExplosion.h" }) }),
		"\n",
		jsxs(_components.p, { children: [
			"逻辑帧。与 ",
			jsx(_components.code, { children: "CWorld::TriggerExplosion" }),
			" 不同：这是爆炸槽表。"
		] }),
		"\n",
		jsx(_components.h2, {
		...
		jsxs(Api, {
			name: "AddExplosion",
			children: [jsxs(_components.p, { children: [jsx(_components.code, { children: "eExplosionType" }), " 见头文件。"] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		jsxs(Api, {
			name: "eExplosionType",
			children: [jsx(_components.p, { children: "手雷、燃烧瓶、火箭、车、船、飞机、小爆炸等。" }), jsx(Fragment, { children: jsx(_components.pre, {
				className: "shiki shiki-themes github-light github-dark",
				style: {
					"--shiki-light": "#24292e",
					"--shiki-dark": "#e1e4e8",
				...
				children: jsxs(_components.code, { children: [
					jsx(_components.span, {
						...
						children: jsx(_components.span, {
							...
							children: "// EXPLOSION_GRENADE, EXPLOSION_MOLOTOV, EXPLOSION_ROCKET,"
						})
					}),
					"\n",
					jsx(_components.span, {
						...
						children: jsx(_components.span, {
							...
							children: "// EXPLOSION_CAR, EXPLOSION_BOAT, EXPLOSION_AIRCRAFT,"
						})
					}),
					"\n",
					jsx(_components.span, {
						...
						children: jsx(_components.span, {
							...
							children: "// EXPLOSION_SMALL, EXPLOSION_RC_VEHICLE, ..."
						})
					})
				] })
			}) })]
		...
		"\n",
		jsx(Api, {
			name: "ClearAllExplosions / RemoveAllExplosionsInArea",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " RemoveAllExplosionsInArea"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " TestForExplosionInArea"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: "(EXPLOSION_CAR, x1, y1, z1, x2, y2, z2)) {"
										})
									]
								}),
								"\n",
		...
		"\n",
		jsx(Api, {
			name: "GetExplosionType / GetExplosionPosition",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetExplosionActiveCounter"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// id 0..MAX_EXPLOSIONS-1（默认 16）"
								})
							}) })
						}) })
					})
		...
		"\n",
		jsx(Api, {
			name: "aExplosions / MAX_EXPLOSIONS",
			children: jsx(Fragment, { children: jsx(_components.pre, {
				className: "shiki shiki-themes github-light github-dark",
				style: {
					"--shiki-light": "#24292e",

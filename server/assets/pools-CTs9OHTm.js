...
//#region content/docs/plugins/entities/pools.mdx?collection=docs
var frontmatter = {
	"title": "对象池 CPools",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "跨帧存 **handle**，再用 `Get*` 取指针。池满会创建失败。"
		},
		{
			"heading": "句柄转指针",
			"content": "脚本句柄 → 指针。无效 null。"
		},
		{
			"heading": "任务与其它池",
			"content": "任务槽紧，别泄漏 Task。"
		},
		{
			"heading": "存档与槽位",
			"content": "一般只读；改存档流程要极谨慎。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#句柄转指针",
		title: jsx(Fragment, { children: "句柄转指针" })
	},
	{
		depth: 2,
		url: "#指针转句柄",
		title: jsx(Fragment, { children: "指针转句柄" })
	},
	{
		depth: 2,
		url: "#主对象池",
		title: jsx(Fragment, { children: "主对象池" })
	},
	{
		depth: 2,
		url: "#任务与其它池",
		title: jsx(Fragment, { children: "任务与其它池" })
	},
	{
		depth: 2,
		url: "#存档与槽位",
		title: jsx(Fragment, { children: "存档与槽位" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CPools.h" }) }),
		"\n",
		jsxs(_components.p, { children: [
			"跨帧存 ",
			jsx(_components.strong, { children: "handle" }),
			"，再用 ",
		...
		"\n",
		jsxs(Api, {
			name: "GetPed / GetVehicle / GetObject",
			children: [jsx(_components.p, { children: "脚本句柄 → 指针。无效 null。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		"\n",
		jsx(Api, {
			name: "GetPedRef / GetVehicleRef / GetObjectRef",
		...
		"\n",
		jsx(Api, {
			name: "ms_pPedPool / ms_pVehiclePool / ms_pObjectPool",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: "CObject, CCutsceneObject"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#D73A49",
		...
		"\n",
		jsxs(Api, {
			name: "ms_pTaskPool / ms_pPedIntelligencePool",
			children: [jsx(_components.p, { children: "任务槽紧，别泄漏 Task。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " ms_pPedIntelligencePool;"
										})
									]
								}),
								"\n",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " ms_pPtrNodeSingleLinkPool;"
										})
									]
								}),
								"\n",
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " ms_pPtrNodeDoubleLinkPool;"
										})
									]
								})
							] })
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// 看占用：pool->GetNoOfUsedSpaces() 等，以 CPool 头文件为准"
								})
							}) })
						}) })
					})
		...
		"\n",
		jsxs(Api, {
			name: "Save / Load / MakeSureSlotInObjectPoolIsEmpty",
			children: [jsx(_components.p, { children: "一般只读；改存档流程要极谨慎。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " MakeSureSlotInObjectPoolIsEmpty"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// 正常 ASI 不直接调 Save/Load"
								})
							}) })
						}) })
					})

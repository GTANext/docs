...
//#region content/docs/cleo/vc/math.mdx?collection=docs
var frontmatter = {
	"title": "数学 Math",
	"description": "幂与对数"
};
...
var toc = [{
	depth: 2,
	url: "#幂",
	title: jsx(Fragment, { children: "幂" })
}, {
	depth: 2,
	url: "#对数",
	title: jsx(Fragment, { children: "对数" })
}];
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			children: [jsxs(_components.p, { children: [
				"幂。经典别名 ",
				jsx(_components.code, { children: "05F3" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0AEE POW" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: number, power" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "// 经典别名 05F3" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			children: [jsxs(_components.p, { children: [
				"指定底对数。经典别名 ",
				jsx(_components.code, { children: "05F4" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0AEF LOG" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: number, base" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "// 经典别名 05F4" })
								})
							] })
						}) })
					}),

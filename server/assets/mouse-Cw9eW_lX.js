...
//#region content/docs/cleo/sa/default/mouse.mdx?collection=docs
var frontmatter = {
	"title": "鼠标 Mouse",
	"description": "鼠标位移与反转"
};
...
var toc = [{
	depth: 2,
	url: "#本帧位移",
	title: jsx(Fragment, { children: "本帧位移" })
}, {
	depth: 2,
	url: "#上下反转",
	title: jsx(Fragment, { children: "上下反转" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Mouse.GetMovement",
			children: [jsx(_components.p, { children: "鼠标或右摇杆本帧位移。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0A4A GET_PC_MOUSE_MOVEMENT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: deltaX, deltaY" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Mouse.IsUsingVerticalInversion",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0A4C IS_MOUSE_USING_VERTICAL_INVERSION" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " isMouseUsingVerticalInversion"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: "isUsingVerticalInversion"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",

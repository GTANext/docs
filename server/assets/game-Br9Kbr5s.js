...
//#region content/docs/cleo/vc/game.mdx?collection=docs
var frontmatter = {
	"title": "游戏 Game / Pad",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "取游戏版本",
			"content": "返回游戏版本 id（VC 经典号）。"
		},
		{
			"heading": "是否原版",
			"content": "是否原版 1.0。用在 `if` 里。"
		},
		{
			"heading": "键是否按下",
			"content": "指定键码是否按下。用在 `if` 里。经典别名 `05EE`。"
		},
		{
			"heading": "测试作弊串",
			"content": "是否刚打出指定作弊串。用在 `if` 里。"
		},
		{
			"heading": "手柄键灵敏度",
			"content": "手柄键是否达到灵敏度。用在 `if` 里。"
		},
		{
			"heading": "模拟手柄键",
			"content": "模拟按下手柄键。"
...
var toc = [
	{
		depth: 2,
		url: "#取游戏版本",
		title: jsx(Fragment, { children: "取游戏版本" })
	},
	{
		depth: 2,
		url: "#是否原版",
		title: jsx(Fragment, { children: "是否原版" })
	},
	{
		depth: 2,
		url: "#键是否按下",
		title: jsx(Fragment, { children: "键是否按下" })
	},
	{
		depth: 2,
		url: "#测试作弊串",
		title: jsx(Fragment, { children: "测试作弊串" })
	},
	{
		depth: 2,
		url: "#手柄键灵敏度",
		title: jsx(Fragment, { children: "手柄键灵敏度" })
	},
	{
		depth: 2,
		url: "#模拟手柄键",
		title: jsx(Fragment, { children: "模拟手柄键" })
	},
	{
		depth: 2,
		url: "#当前天气",
		title: jsx(Fragment, { children: "当前天气" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			member: "Game.GetVersion",
			children: [jsx(_components.p, { children: "返回游戏版本 id（VC 经典号）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "05E5 GET_GAME_VERSION" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: versionId" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0AA9",
			name: "IS_GAME_VERSION_ORIGINAL",
			member: "Game.IsVersionOriginal",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								className: "line",
								children: jsx(_components.span, { children: "0AA9 IS_GAME_VERSION_ORIGINAL" })
							}) })
						}) })
					}),
					jsx(CodeBlockTab, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " isGameVersionOriginal"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			children: [jsxs(_components.p, { children: [
				...
				jsx(_components.code, { children: "if" }),
				" 里。经典别名 ",
				jsx(_components.code, { children: "05EE" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0AB0 IS_KEY_PRESSED" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: keyCode" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "// 经典别名 05EE" })
								})
							] })
						}) })
					}),
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0ADC TEST_CHEAT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: input" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0601",
			name: "IS_BUTTON_PRESSED_WITH_SENSITIVITY",
			member: "Pad.IsButtonPressedWithSensitivity",
			children: [jsxs(_components.p, { children: [
				"手柄键是否达到灵敏度。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0601 IS_BUTTON_PRESSED_WITH_SENSITIVITY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: buttonId, sensitivity" })
								})
							] })
						}) })
					}),
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " isButtonPressedWithSensitivity"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			id: "0602",
			name: "EMULATE_BUTTON_PRESS_WITH_SENSITIVITY",
			member: "Pad.EmulateButtonPressWithSensitivity",
			children: [jsx(_components.p, { children: "模拟按下手柄键。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0602 EMULATE_BUTTON_PRESS_WITH_SENSITIVITY" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "emulateButtonPressWithSensitivity"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Weather.GetCurrent",
			children: [jsx(_components.p, { children: "当前天气 id。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0607 GET_CURRENT_WEATHER" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: weatherType" })
								})
							] })
						}) })
					}),

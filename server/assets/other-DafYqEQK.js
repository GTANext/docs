...
//#region content/docs/plugins/utils/other.mdx?collection=docs
var frontmatter = {
	"title": "杂项工具",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`Other.h` · 命名空间 `plugin`"
		},
		{
			"heading": "打开控制台",
			"content": "分配控制台并 freopen stdin/out，便于调试。"
		},
		{
			"heading": "随机数",
			"content": "基于 `mt19937`。`Random()` 为 0..999。"
		},
		{
			"heading": "检测按键无边沿",
			"content": "当前是否按下。需要边沿时用 KeyCheck。"
		},
		{
			"heading": "从文件或内存解码图",
			"content": "解码到 `Image*`，失败返回 `false`。成功后需 `Release`。见 图片与精灵。"
		},
		{
			"heading": "扫目录文件",
			"content": "不要每帧调用。"
		...
		{
			"heading": "格式化字符串",
			"content": "`FormatStatic` 使用轮转静态缓冲，不要长期保存返回指针。"
		},
		{
			"heading": "限幅与插值",
			"content": "`f` 一般在 0..1。"
		...
		{
			"heading": "帧步归一与浮点近似",
			"content": "按 `CTimer::ms_fTimeStep` 归一，适合帧率相关位移。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#打开控制台",
		title: jsx(Fragment, { children: "打开控制台" })
	},
	{
		depth: 2,
		url: "#随机数",
		title: jsx(Fragment, { children: "随机数" })
	},
	{
		depth: 2,
		url: "#检测按键无边沿",
		title: jsx(Fragment, { children: "检测按键（无边沿）" })
	},
	{
		depth: 2,
		url: "#查同目录-asi",
		title: jsx(Fragment, { children: "查同目录 ASI" })
	},
	{
		depth: 2,
		url: "#窄宽字符串互转",
		title: jsx(Fragment, { children: "窄宽字符串互转" })
	},
	{
		depth: 2,
		url: "#从文件或内存解码图",
		title: jsx(Fragment, { children: "从文件或内存解码图" })
	},
	{
		depth: 2,
		url: "#扫目录文件",
		title: jsx(Fragment, { children: "扫目录文件" })
	},
	{
		depth: 2,
		url: "#格式化字符串",
		title: jsx(Fragment, { children: "格式化字符串" })
	},
	{
		depth: 2,
		url: "#大小写与路径裁剪",
		title: jsx(Fragment, { children: "大小写与路径裁剪" })
	},
	{
		depth: 2,
		url: "#角度弧度",
		title: jsx(Fragment, { children: "角度弧度" })
	},
	{
		depth: 2,
		url: "#限幅与插值",
		title: jsx(Fragment, { children: "限幅与插值" })
	},
	{
		depth: 2,
		url: "#帧步归一与浮点近似",
		title: jsx(Fragment, { children: "帧步归一与浮点近似" })
	},
	{
		depth: 2,
		url: "#文件存在与可用内存",
		title: jsx(Fragment, { children: "文件存在与可用内存" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "Other.h" }),
			" · 命名空间 ",
		...
		jsxs(Api, {
			name: "OpenConsole",
			children: [jsx(_components.p, { children: "分配控制台并 freopen stdin/out，便于调试。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		"\n",
		jsxs(Api, {
			name: "RandomNumberInRange / Random",
			children: [jsxs(_components.p, { children: [
				"基于 ",
				jsx(_components.code, { children: "mt19937" }),
				"。",
				jsx(_components.code, { children: "Random()" }),
				" 为 0..999。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		jsxs(_components.p, { children: [
			"解码到 ",
			jsx(_components.code, { children: "Image*" }),
			"，失败返回 ",
			jsx(_components.code, { children: "false" }),
			"。成功后需 ",
			jsx(_components.code, { children: "Release" }),
			"。见 ",
			jsx(_components.a, {
							...
							jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " CreateImageFromMemory"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		"\n",
		jsx(_components.p, { children: "不要每帧调用。" }),
		"\n",
		jsxs(CodeBlockTabs, {
			defaultValue: "签名",
			children: [
		...
		"\n",
		jsxs(_components.p, { children: [jsx(_components.code, { children: "FormatStatic" }), " 使用轮转静态缓冲，不要长期保存返回指针。"] }),
		"\n",
		jsxs(CodeBlockTabs, {
			defaultValue: "签名",
			children: [
		...
		"\n",
		jsxs(_components.p, { children: [jsx(_components.code, { children: "f" }), " 一般在 0..1。"] }),
		"\n",
		jsxs(CodeBlockTabs, {
			defaultValue: "签名",
			children: [
		...
		jsxs(_components.p, { children: [
			"按 ",
			jsx(_components.code, { children: "CTimer::ms_fTimeStep" }),
			" 归一，适合帧率相关位移。"
		] }),
		"\n",
		jsxs(CodeBlockTabs, {

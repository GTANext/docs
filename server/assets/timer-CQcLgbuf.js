...
//#region content/docs/plugins/entities/timer.mdx?collection=docs
var frontmatter = {
	"title": "计时 CTimer",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "逻辑帧步长、游戏时间、暂停与慢动作。插值、冷却、计时都靠它。"
		},
		{
			"heading": "帧步长",
			"content": "物理 / 动画乘 dt 用。"
...
var toc = [
	{
		depth: 2,
		url: "#帧步长",
		title: jsx(Fragment, { children: "帧步长" })
	},
	{
		depth: 2,
		url: "#游戏毫秒",
		title: jsx(Fragment, { children: "游戏毫秒" })
	},
	{
		depth: 2,
		url: "#时间缩放与慢动作",
		title: jsx(Fragment, { children: "时间缩放与慢动作" })
	},
	{
		depth: 2,
		url: "#暂停",
		title: jsx(Fragment, { children: "暂停" })
	},
	{
		depth: 2,
		url: "#帧计数与-fps",
		title: jsx(Fragment, { children: "帧计数与 FPS" })
	},
	{
		depth: 2,
		url: "#高精度周期",
		title: jsx(Fragment, { children: "高精度周期" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CTimer.h" }) }),
		"\n",
		jsx(_components.p, { children: "逻辑帧步长、游戏时间、暂停与慢动作。插值、冷却、计时都靠它。" }),
		"\n",
		jsx(_components.h2, {
			id: "帧步长",
			children: "帧步长"
		...
		"\n",
		jsxs(Api, {
			name: "ms_fTimeStep / ms_fTimeStepNonClipped",
			children: [jsx(_components.p, { children: "物理 / 动画乘 dt 用。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " ms_fTimeStepNonClipped;"
										})
									]
								}),
								"\n",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " m_snTimeInMilliseconds;"
										})
									]
								}),
								"\n",
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " m_snTimeInMillisecondsNonClipped;"
										})
									]
								}),
								"\n",
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " m_snTimeInMillisecondsPauseMode;"
										})
									]
								}),
								"\n",
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " m_snPreviousTimeInMilliseconds;"
										})
									]
								})
							] })
		...
		"\n",
		jsx(Api, {
			name: "ms_fTimeScale / bSlowMotionActive",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetIsSlowMotionActive"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// float old = CTimer::ms_fTimeScale;"
									})
								}),
								"\n",
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// CTimer::ms_fTimeScale = 0.5f;"
									})
								})
							] })
						}) })
		...
		"\n",
		jsx(Api, {
			name: "m_UserPause / StartUserPause / Suspend",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " bSkipProcessThisFrame;"
										})
									]
								})
							] })
		...
		"\n",
		jsx(Api, {
			name: "GetCurrentTimeInCycles / GetCyclesPerMillisecond",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetCurrentTimeInCycles"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetCyclesPerMillisecond"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",

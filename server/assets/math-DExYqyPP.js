...
//#region content/docs/cleo/sa/math.mdx?collection=docs
var frontmatter = {
	"title": "数学 Math",
	"description": "幂与对数"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "幂",
			"content": "`number ^ power`。"
		},
		{
			"heading": "对数",
			"content": "以 `base` 为底的对数。"
		}
	],
	"headings": [{
		"id": "幂",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			name: "POW",
			member: "Math.Pow",
			children: [jsxs(_components.p, { children: [jsx(_components.code, { children: "number ^ power" }), "。"] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
		...
		jsxs(Opcode, {
			...
			children: [jsxs(_components.p, { children: [
				"以 ",
				jsx(_components.code, { children: "base" }),
				" 为底的对数。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [

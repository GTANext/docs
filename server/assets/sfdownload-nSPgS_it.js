...
//#region content/docs/cleo/sa/ext/sampfuncs/sfdownload.mdx?collection=docs
var frontmatter = {
	"title": "下载 SfDownload",
	"description": "异步下载文件"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "共 3 条。调用见 Lua / Redux。"
		},
		{
			"heading": "下载",
			"content": "从 url 异步下载文件并保存到 filePath，返回 SfDownload 句柄以便跟踪。"
		},
		{
			"heading": "状态--释放",
			"content": "返回 SfDownload 对象的下载状态。"
		},
		{
			"heading": "状态--释放",
			"content": "释放 SfDownload 对象内存。用在 `if` 里。"
		}
	],
	"headings": [{
		"id": "下载",
...
var toc = [{
	depth: 2,
	url: "#下载",
	title: jsx(Fragment, { children: "下载" })
}, {
	depth: 2,
	url: "#状态--释放",
	title: jsx(Fragment, { children: "状态 / 释放" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0C65",
			name: "SF_DOWNLOAD_FILE",
			member: "SfDownload.File",
			children: [jsx(_components.p, { children: "从 url 异步下载文件并保存到 filePath，返回 SfDownload 句柄以便跟踪。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C65 SF_DOWNLOAD_FILE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: url, filePath" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0C66",
			name: "SF_GET_DOWNLOAD_STATE",
			member: "SfDownload.GetState",
			children: [jsx(_components.p, { children: "返回 SfDownload 对象的下载状态。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C66 SF_GET_DOWNLOAD_STATE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: state" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "0C7D",
			name: "SF_RELEASE_DOWNLOAD",
			member: "SfDownload.Release",
			children: [jsxs(_components.p, { children: [
				"释放 SfDownload 对象内存。用在 ",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C7D SF_RELEASE_DOWNLOAD" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

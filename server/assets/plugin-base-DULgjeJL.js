...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "编译期已知地址、cdecl"
		},
		{
			"heading": void 0,
			"content": "`Call` / `CallAndReturn`"
		},
		{
			"heading": void 0,
			"content": "thiscall"
		...
		{
			"heading": void 0,
			"content": "`CallMethod` / `CallMethodAndReturn`"
		},
		{
			"heading": void 0,
			"content": "运行时才有地址（Pattern / 重定位）"
		},
		{
			"heading": void 0,
			"content": "`CallDyn*`"
		...
		{
			"heading": void 0,
			"content": "静态构造 / `DllMain` / 对象池尚未建立 / 设备 Lost 之后继续画或调渲染相关逻辑。"
		},
		{
			"heading": "无返回-cdecl",
			"content": "无返回的 cdecl 调用。`address` 按 `void(__cdecl*)(Args...)` 解释。调用约定错误会破坏栈。固定 RVA 换游戏版本通常要更新，或改用 Pattern + `CallDyn`。"
		},
		{
			"heading": "有返回-cdecl",
			"content": "`Ret` 写在模板参数最前。"
		},
		{
			"heading": "stdcall",
			"content": "游戏内多数并不是 stdcall，确认约定后再用。"
		},
		{
			"heading": "thiscall-方法",
			"content": "第一个参数是 `this`，必须有效。"
		},
		{
			"heading": "虚表方法",
			"content": "模板参数是虚表 **下标**，不是函数地址。下标错误几乎必崩。"
		},
		{
			"heading": "运行时地址-cdecl",
			"content": "内部会做重定位。地址为 `0` 时不要调用。"
		},
		{
			"heading": "取虚表",
			"content": "取虚表指针，或某一槽位。"
		...
		{
			"heading": "基址与绝对地址",
			"content": "模块基址；RVA → 绝对地址。"
		},
		{
			"heading": "分配与释放",
			"content": "等价于 new / delete，必须成对使用。"
		},
		{
			"heading": "跨游戏取值",
			"content": "按当前工程宏取三端之一。"
	...
	"headings": [
		...
		{
			"id": "运行时地址-stdcall",
			"content": "运行时地址 stdcall"
		},
		{
			"id": "运行时地址-thiscall",
			"content": "运行时地址 thiscall"
		},
		{
			"id": "绝对地址-cdecl",
			"content": "绝对地址 cdecl"
...
var toc = [
	{
		depth: 2,
		url: "#无返回-cdecl",
		title: jsx(Fragment, { children: "无返回 cdecl" })
	},
	{
		depth: 2,
		url: "#有返回-cdecl",
		title: jsx(Fragment, { children: "有返回 cdecl" })
	},
	{
		depth: 2,
		url: "#stdcall",
		title: jsx(Fragment, { children: "stdcall" })
	},
	{
		depth: 2,
		url: "#thiscall-方法",
		title: jsx(Fragment, { children: "thiscall 方法" })
	},
	{
		depth: 2,
		url: "#虚表方法",
		title: jsx(Fragment, { children: "虚表方法" })
	},
	{
		depth: 2,
		url: "#运行时地址-cdecl",
		title: jsx(Fragment, { children: "运行时地址 cdecl" })
	},
	{
		depth: 2,
		url: "#运行时地址-stdcall",
		title: jsx(Fragment, { children: "运行时地址 stdcall" })
	},
	{
		depth: 2,
		url: "#运行时地址-thiscall",
		title: jsx(Fragment, { children: "运行时地址 thiscall" })
	},
	{
		depth: 2,
		url: "#绝对地址-cdecl",
		title: jsx(Fragment, { children: "绝对地址 cdecl" })
	},
	{
		depth: 2,
		url: "#绝对地址-thiscall",
		title: jsx(Fragment, { children: "绝对地址 thiscall" })
	},
	{
		depth: 2,
		url: "#取虚表",
		title: jsx(Fragment, { children: "取虚表" })
	},
	{
		depth: 2,
		url: "#基址与绝对地址",
		title: jsx(Fragment, { children: "基址与绝对地址" })
	},
	{
		depth: 2,
		url: "#分配与释放",
		title: jsx(Fragment, { children: "分配与释放" })
	},
	{
		depth: 2,
		url: "#栈上临时对象",
		title: jsx(Fragment, { children: "栈上临时对象" })
	},
	{
		depth: 2,
		url: "#sdk-版本",
		title: jsx(Fragment, { children: "SDK 版本" })
	},
	{
		depth: 2,
		url: "#跨游戏取值",
		title: jsx(Fragment, { children: "跨游戏取值" })
	}
];
function _createMdxContent(props) {
	const _components = {
		...
		tr: "tr",
		...props.components
	}, { Api, Callout, CodeBlockTab, CodeBlockTabs, CodeBlockTabsList, CodeBlockTabsTrigger } = _components;
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "shared/PluginBase.h" }),
			" · 命名空间 ",
		...
		jsxs(_components.p, { children: [
			"优先顺序：",
			jsx(_components.strong, { children: "已有 C++ 封装 → Command → Call → 最后才 patch" }),
			"。"
		] }),
		"\n",
		jsxs(_components.table, { children: [jsx(_components.thead, { children: jsxs(_components.tr, { children: [jsx(_components.th, { children: "场景" }), jsx(_components.th, { children: "选用" })] }) }), jsxs(_components.tbody, { children: [
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "编译期已知地址、cdecl" }), jsxs(_components.td, { children: [
				jsx(_components.code, { children: "Call" }),
				" / ",
				jsx(_components.code, { children: "CallAndReturn" })
			] })] }),
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "thiscall" }), jsxs(_components.td, { children: [
				jsx(_components.code, { children: "CallMethod" }),
				" / ",
				jsx(_components.code, { children: "CallMethodAndReturn" })
			] })] }),
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "运行时才有地址（Pattern / 重定位）" }), jsx(_components.td, { children: jsx(_components.code, { children: "CallDyn*" }) })] }),
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "地址已是绝对、不要再加基址" }), jsx(_components.td, { children: jsx(_components.code, { children: "*DynGlobal" }) })] }),
			jsxs(_components.tr, { children: [jsx(_components.td, { children: "虚表槽" }), jsx(_components.td, { children: jsx(_components.code, { children: "CallVirtualMethod*" }) })] })
		] })] }),
		"\n",
		jsxs(_components.p, { children: [
			"编译期地址 → ",
			...
			"\n",
			"运行时地址 → ",
			jsx(_components.code, { children: "CallDyn*" }),
			"（多数配合 ",
			jsx(_components.code, { children: "GetGlobalAddress" }),
			" / Pattern）",
			jsx(_components.br, {}),
			"\n",
			jsx(_components.code, { children: "*DynGlobal" }),
			" ",
			jsx(_components.strong, { children: "不做" }),
			"重定位"
		] }),
		"\n",
		jsx(Callout, {
			type: "error",
			title: "不要在这些时机 Call 游戏逻辑",
			children: jsxs(_components.p, { children: [
				"静态构造 / ",
				jsx(_components.code, { children: "DllMain" }),
				" / 对象池尚未建立 / 设备 Lost 之后继续画或调渲染相关逻辑。"
			] })
		}),
		"\n",
		jsx(_components.h2, {
		...
		jsxs(Api, {
			...
			children: [jsxs(_components.p, { children: [
				...
				" 按 ",
				jsx(_components.code, { children: "void(__cdecl*)(Args...)" }),
				" 解释。调用约定错误会破坏栈。固定 RVA 换游戏版本通常要更新，或改用 Pattern + ",
				jsx(_components.code, { children: "CallDyn" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
		...
		jsxs(Api, {
			name: "CallAndReturn",
			header: "编译期地址 · cdecl",
			children: [jsxs(_components.p, { children: [jsx(_components.code, { children: "Ret" }), " 写在模板参数最前。"] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsxs(Api, {
			name: "CallStd / CallStdAndReturn",
			header: "编译期地址 · stdcall",
			children: [jsx(_components.p, { children: "游戏内多数并不是 stdcall，确认约定后再用。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		jsx(_components.h2, {
			id: "thiscall-方法",
			children: "thiscall 方法"
		}),
		"\n",
		jsxs(Api, {
			name: "CallMethod / CallMethodAndReturn",
			header: "编译期地址 · thiscall",
			children: [jsxs(_components.p, { children: [
				"第一个参数是 ",
				jsx(_components.code, { children: "this" }),
				"，必须有效。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
		...
		"\n",
		jsxs(Api, {
			name: "CallVirtualMethod / CallVirtualMethodAndReturn",
			header: "虚表下标",
			children: [jsxs(_components.p, { children: [
				"模板参数是虚表 ",
				jsx(_components.strong, { children: "下标" }),
				"，不是函数地址。下标错误几乎必崩。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " CallVirtualMethodAndReturn"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsx(_components.h2, {
			id: "运行时地址-cdecl",
			children: "运行时地址 cdecl"
		}),
		"\n",
		jsxs(Api, {
			name: "CallDyn / CallAndReturnDyn",
			header: "运行时 · cdecl · 重定位",
			children: [jsxs(_components.p, { children: [
				"内部会做重定位。地址为 ",
		...
		jsx(_components.h2, {
			id: "运行时地址-stdcall",
			children: "运行时地址 stdcall"
		}),
		"\n",
		jsx(Api, {
			name: "CallStdDyn / CallStdAndReturnDyn",
		...
		jsx(_components.h2, {
			id: "运行时地址-thiscall",
			children: "运行时地址 thiscall"
		}),
		"\n",
		jsx(Api, {
			name: "CallMethodDyn / CallMethodAndReturnDyn",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " CallMethodAndReturnDyn"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsx(Api, {
			name: "CallDynGlobal / CallAndReturnDynGlobal",
			header: "绝对地址 · 不重定位",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " CallAndReturnDynGlobal"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsx(_components.h2, {
			id: "绝对地址-thiscall",
			children: "绝对地址 thiscall"
		}),
		"\n",
		jsx(Api, {
			name: "CallMethodDynGlobal / CallMethodAndReturnDynGlobal",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " CallMethodAndReturnDynGlobal"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Api, {
			name: "GetVMT",
			children: [jsx(_components.p, { children: "取虚表指针，或某一槽位。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsxs(Api, {
			name: "GetBaseAddress / GetGlobalAddress",
			header: "DynAddress.h",
			children: [jsx(_components.p, { children: "模块基址；RVA → 绝对地址。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsxs(Api, {
			name: "operator_new / operator_delete 族",
			children: [jsx(_components.p, { children: "等价于 new / delete，必须成对使用。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " operator_delete_array"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Api, {
			name: "BY_GAME",
			header: "宏",
			children: [jsx(_components.p, { children: "按当前工程宏取三端之一。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "(iii_val, vc_val, sa_val)"
								})]
							}) })
						}) })
					}),

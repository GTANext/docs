...
//#region content/docs/plugins/entities/weapon.mdx?collection=docs
var frontmatter = {
	"title": "武器 CWeapon",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "挂在 Ped 武器槽上的实例（类型、弹匣、状态）。全局表见 world-state 的 `CWeaponInfo`。"
		},
		{
			"heading": "开火入口",
			"content": "参数多，错用易崩。"
		...
		{
			"heading": "与武器表",
			"content": "`CWeaponInfo::GetWeaponInfo(type, skill)` 改射程 / 伤害等全局。实例弹药在 `CWeapon`，表在 Info。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#槽位字段",
		title: jsx(Fragment, { children: "槽位字段" })
	},
	{
		depth: 2,
		url: "#武器状态枚举",
		title: jsx(Fragment, { children: "武器状态枚举" })
	},
	{
		depth: 2,
		url: "#类型判断",
		title: jsx(Fragment, { children: "类型判断" })
	},
	{
		depth: 2,
		url: "#初始化与装填",
		title: jsx(Fragment, { children: "初始化与装填" })
	},
	{
		depth: 2,
		url: "#开火入口",
		title: jsx(Fragment, { children: "开火入口" })
	},
	{
		depth: 2,
		url: "#全局辅助",
		title: jsx(Fragment, { children: "全局辅助" })
	},
	{
		depth: 2,
		url: "#与武器表",
		title: jsx(Fragment, { children: "与武器表" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CWeapon.h" }) }),
		"\n",
		jsxs(_components.p, { children: [
			"挂在 Ped 武器槽上的实例（类型、弹匣、状态）。全局表见 ",
			jsx(_components.a, {
				href: "/docs/plugins/entities/world-state",
				children: "world-state"
			}),
			" 的 ",
			jsx(_components.code, { children: "CWeaponInfo" }),
			"。"
		] }),
		"\n",
		jsx(_components.h2, {
		...
		"\n",
		jsx(Api, {
			name: "m_eWeaponType / m_nAmmoInClip / m_nAmmoTotal",
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "eWeaponType m_eWeaponType;"
									})
								}),
								"\n",
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "eWeaponState m_nState;"
									})
								}),
								"\n",
							...
							children: jsxs(_components.code, { children: [
								jsxs(_components.span, {
									...
									children: [jsx(_components.span, {
										...
										children: "// CWeapon& w = ped->m_aWeapons[slot];"
									}), jsx(_components.span, {
										style: {
											"--shiki-light": "#6A737D",
											"--shiki-dark": "#6A737D"
										},
										children: " // 槽布局以 CPed 为准"
									})]
								}),
								"\n",
								jsx(_components.span, {
				...
				children: jsxs(_components.code, { children: [
					...
					jsxs(_components.span, {
						...
						children: [jsx(_components.span, {
							...
							children: "    WEAPONSTATE_RELOADING"
						}), jsx(_components.span, {
							style: {
								"--shiki-light": "#24292E",
								"--shiki-dark": "#E1E4E8"
					...
					jsxs(_components.span, {
						...
						children: [jsx(_components.span, {
							...
							children: "    WEAPONSTATE_OUT_OF_AMMO"
						}), jsx(_components.span, {
							style: {
								"--shiki-light": "#24292E",
								"--shiki-dark": "#E1E4E8"
					...
					jsx(_components.span, {
						...
						children: jsx(_components.span, {
							...
							children: "    WEAPONSTATE_MELEE_MADECONTACT"
						})
					}),
					"\n",
					jsx(_components.span, {
		...
		"\n",
		jsx(Api, {
			name: "IsTypeMelee / IsType2Handed / IsTypeProjectile",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " HasWeaponAmmoToBeUsed"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsx(Api, {
			name: "Initialise / Reload / Shutdown",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// 给枪优先 ped->GiveWeapon；直接 Initialise 要自己维护槽"
								})
							}) })
						}) })
					})
		...
		"\n",
		jsxs(Api, {
			name: "Fire / FireProjectile / FireInstantHit",
			children: [jsx(_components.p, { children: "参数多，错用易崩。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// 脚本/任务侧更稳；ASI 作弊优先改弹药 + GiveWeapon"
								})
							}) })
						}) })
					})
		...
		"\n",
		jsx(Api, {
			name: "GenerateDamageEvent / ProcessLineOfSight",
			children: jsx(Fragment, { children: jsx(_components.pre, {
				className: "shiki shiki-themes github-light github-dark",
				style: {
					"--shiki-light": "#24292e",
		...
		"\n",
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "CWeaponInfo::GetWeaponInfo(type, skill)" }),
			" 改射程 / 伤害等全局。实例弹药在 ",
			jsx(_components.code, { children: "CWeapon" }),
			"，表在 Info。"
		] })
	] });
}

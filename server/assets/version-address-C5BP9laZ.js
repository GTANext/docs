...
//#region content/docs/plugins/utils/version-address.mdx?collection=docs
var frontmatter = {
	"title": "版本与地址",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`GameVersion.h` / `DynAddress.h` / `extensions/DynamicResource.h`"
		},
		{
			"heading": "取游戏版本",
			"content": "SA 常见：`GAME_10US_COMPACT` / `HOODLUM` / `STEAM` 等。"
		},
		{
			"heading": "判断支持的版本",
			"content": "`IsSupportedGameVersion` 受编译期 `PLUGIN_SGV_*` 影响。"
		},
		{
			"heading": "设备丢失资源",
			"content": "注册后：设备 Lost 调 `Unload`，Reset 调 `Load`。继承并实现纯虚函数。"
		}
	],
	"headings": [
		{
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#判断支持的版本",
		title: jsx(Fragment, { children: "判断支持的版本" })
	},
	{
		depth: 2,
		url: "#基址与重定位",
		title: jsx(Fragment, { children: "基址与重定位" })
	},
	{
		depth: 2,
		url: "#设备丢失资源",
		title: jsx(Fragment, { children: "设备丢失资源" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "GameVersion.h" }),
			" / ",
			jsx(_components.code, { children: "DynAddress.h" }),
			" / ",
			jsx(_components.code, { children: "extensions/DynamicResource.h" })
		] }),
		"\n",
		jsx(_components.h2, {
			id: "取游戏版本",
		...
		jsxs(_components.p, { children: [
			"SA 常见：",
			jsx(_components.code, { children: "GAME_10US_COMPACT" }),
			" / ",
			jsx(_components.code, { children: "HOODLUM" }),
			" / ",
			jsx(_components.code, { children: "STEAM" }),
			" 等。"
		] }),
		"\n",
		jsxs(CodeBlockTabs, {
		...
		"\n",
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "IsSupportedGameVersion" }),
			" 受编译期 ",
			jsx(_components.code, { children: "PLUGIN_SGV_*" }),
			" 影响。"
		] }),
		"\n",
		jsxs(CodeBlockTabs, {
							...
							jsxs(_components.span, {
								...
								children: [
									...
									jsx(_components.span, {
										...
										children: " IsSupportedGameVersion"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(_components.p, { children: [
			"注册后：设备 Lost 调 ",
			jsx(_components.code, { children: "Unload" }),
			"，Reset 调 ",
						...
						children: jsxs(_components.code, { children: [
							jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: " \"extensions/DynamicResource.h\""
								})]
							}),
							"\n",
							jsx(_components.span, { className: "line" }),

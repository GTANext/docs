...
//#region content/docs/cleo/gta3/game.mdx?collection=docs
var frontmatter = {
	"title": "游戏 Game / Pad",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "是否-pc-版",
			"content": "是否 PC 版。用在 `if` 里（扩展表收录）。"
		},
		{
			"heading": "是否澳大利亚版",
			"content": "是否澳大利亚发行版。用在 `if` 里。"
		},
		{
			"heading": "取游戏版本",
			"content": "取版本 id。"
		...
		{
			"heading": "手柄键灵敏度",
			"content": "手柄键是否按到指定灵敏度。用在 `if` 里。"
		},
		{
			"heading": "模拟手柄键",
			"content": "模拟按下手柄键到指定灵敏度。"
		},
		{
			"heading": "当前天气",
			"content": "取当前天气 id。"
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#是否澳大利亚版",
		title: jsx(Fragment, { children: "是否澳大利亚版" })
	},
	{
		depth: 2,
		url: "#取游戏版本",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "取版本 id。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "是否输入了指定作弊串。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "模拟按下手柄键到指定灵敏度。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "取当前天气 id。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {

...
//#region content/docs/cleo/sa/default/weapon.mdx?collection=docs
var frontmatter = {
	"title": "武器 Weapon",
...
var toc = [{
	depth: 2,
	url: "#类型--模型",
	title: jsx(Fragment, { children: "类型 → 模型" })
}, {
	depth: 2,
	url: "#类型--槽位",
	title: jsx(Fragment, { children: "类型 → 槽位" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0781 GET_WEAPONTYPE_MODEL" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Weapon.GetSlot",
			children: [jsx(_components.p, { children: "武器类型 → 武器槽位。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0782 GET_WEAPONTYPE_SLOT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: slot" })
								})
							] })
						}) })
					}),

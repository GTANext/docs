...
//#region content/docs/cleo/sa/ext/sampfuncs/samptextlabel3d.mdx?collection=docs
var frontmatter = {
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "创建--删除",
			"content": "按给定参数创建模拟的 SA-MP 3D 文本。"
		},
		{
			"heading": "创建--删除",
			"content": "按 ID 销毁 3D 文本。用在 `if` 里。"
		},
		{
			"heading": "创建--删除",
			"content": "若指定 3D 文本存在则为真。"
		},
		{
			"heading": "指定-id--参数",
			"content": "用指定 ID 创建/覆盖 3D 文本。"
		},
		{
			"heading": "指定-id--参数",
			"content": "按 ID 返回 SampTextLabel3D 的全部信息。"
		},
		{
			"heading": "指定-id--参数",
			"content": "设置 3D 文本的新文字。用在 `if` 里。"
		}
	],
	"headings": [{
		"id": "创建--删除",
...
var toc = [{
	...
	depth: 2,
	url: "#指定-id--参数",
	title: jsx(Fragment, { children: "指定 ID / 参数" })
}];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			id: "0B44",
			name: "SAMP_CREATE_3D_TEXT",
			member: "SampTextLabel3D.Create",
			children: [jsx(_components.p, { children: "按给定参数创建模拟的 SA-MP 3D 文本。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B44 SAMP_CREATE_3D_TEXT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: text, color, coordX, coordY, coordZ, visibilityRadius, showBehindWalls, attachedPlayerId, attachedCarId" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "  text, color, coordX, coordY, coordZ,"
									})
								}),
								"\n",
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "  visibilityRadius, showBehindWalls, attachedPlayerId, attachedCarId"
									})
								}),
								"\n",
								jsx(_components.span, {
		...
		jsxs(Opcode, {
			id: "0B45",
			name: "SAMP_DELETE_3D_TEXT",
			member: "SampTextLabel3D.Delete",
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B45 SAMP_DELETE_3D_TEXT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0B46",
			name: "SAMP_DOES_3D_TEXT_EXIST",
			member: "SampTextLabel3D.DoesExist",
			children: [jsx(_components.p, { children: "若指定 3D 文本存在则为真。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0B46 SAMP_DOES_3D_TEXT_EXIST" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "0C45",
			name: "SAMP_CREATE_3D_TEXT_WITH_ID",
			member: "SampTextLabel3D.CreateWithId",
			children: [jsx(_components.p, { children: "用指定 ID 创建/覆盖 3D 文本。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C45 SAMP_CREATE_3D_TEXT_WITH_ID" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: idAsHandle, text, color, coordX, coordY, coordZ, visibilityRadius, showBehindWalls, attachedPlayerId, attachedCarId" })
								})
							] })
						}) })
					}),
							...
							children: jsxs(_components.code, { children: [
								jsxs(_components.span, {
									...
									children: [jsx(_components.span, {
										...
										children: "sampCreate3dTextWithId"
									}), jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
											"--shiki-dark": "#E1E4E8"
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "  idAsHandle, text, color, coordX, coordY, coordZ,"
									})
								}),
								"\n",
								jsx(_components.span, {
		...
		jsxs(Opcode, {
			id: "0C46",
			name: "SAMP_GET_3D_TEXT_PARAMS",
			member: "SampTextLabel3D.GetParams",
			children: [jsx(_components.p, { children: "按 ID 返回 SampTextLabel3D 的全部信息。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C46 SAMP_GET_3D_TEXT_PARAMS" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "out: text, color, coordX, coordY, coordZ, visibilityRadius, showBehindWalls, attachedPlayerId, attachedCarId" })
								})
							] })
						}) })
					}),
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " text, color, coordX, coordY, coordZ, visibilityRadius, showBehindWalls, attachedPlayerId, attachedCarId "
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#D73A49",
		...
		jsxs(Opcode, {
			id: "0C47",
			name: "SAMP_SET_3D_TEXT",
			member: "SampTextLabel3D.SetText",
			children: [jsxs(_components.p, { children: [
				"设置 3D 文本的新文字。用在 ",
				jsx(_components.code, { children: "if" }),
				" 里。"
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0C47 SAMP_SET_3D_TEXT" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

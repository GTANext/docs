...
//#region content/docs/plugins/entities/wanted.mdx?collection=docs
var frontmatter = {
	"title": "通缉 CWanted",
...
var structuredData = {
	"contents": [{
		"heading": void 0,
		"content": "`CWanted.h` · 通常 `FindPlayerWanted()` 取得"
	}, {
		"heading": void 0,
		"content": "逻辑帧改。"
	}],
...
var toc = [
	...
	},
	{
		depth: 2,
		url: "#读通缉等级",
		title: jsx(Fragment, { children: "读通缉等级" })
	},
	{
		depth: 2,
		url: "#设通缉等级",
		title: jsx(Fragment, { children: "设通缉等级" })
	},
	{
		depth: 2,
		url: "#登记犯罪",
		title: jsx(Fragment, { children: "登记犯罪" })
	},
	{
		depth: 2,
		url: "#警察后退",
		title: jsx(Fragment, { children: "警察后退" })
	},
	{
		depth: 2,
		url: "#最大通缉",
		title: jsx(Fragment, { children: "最大通缉" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "CWanted.h" }),
			" · 通常 ",
			jsx(_components.code, { children: "FindPlayerWanted()" }),
			" 取得"
		] }),
		"\n",
		jsx(_components.p, { children: "逻辑帧改。" }),
		"\n",
		jsx(_components.h2, {
			id: "取通缉对象",
			children: "取通缉对象"
		...
		"\n",
		jsx(Api, {
			name: "m_nWantedLevel / m_nChaosLevel",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsx(Api, {
			name: "SetWantedLevel / CheatWantedLevel",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " ClearWantedLevelAndGoOnParole"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsx(Api, {
			name: "RegisterCrime / RegisterCrime_Immediately",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " bPoliceDontReallyCare"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " RegisterCrime_Immediately"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// w->RegisterCrime_Immediately(crime, pos, 0, false);"
								})
							}) })
						}) })
					})
		...
		"\n",
		jsx(Api, {
			name: "m_bPoliceBackOff / m_bLeavePlayerAlone",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// m_bPoliceBackOff, m_bEverybodyBackOff, m_bLeavePlayerAlone"
									})
								})
							] })
						}) })
		...
		"\n",
		jsx(Api, {
			name: "SetMaximumWantedLevel / MaximumWantedLevel",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " SetMaximumWantedLevel"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",

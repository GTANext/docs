...
//#region content/docs/cleo/sa/default/sphere.mdx?collection=docs
var frontmatter = {
	"title": "球体 Sphere",
	"description": "调试球 / 静态球"
};
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "画一帧",
			"content": "画一帧红色圆柱 / 球标记（调试用）。"
		},
		{
			"heading": "添加静态球",
			"content": "在坐标放静态球，半径 `radius`。"
		},
		{
			"heading": "移除",
			"content": "删掉静态球。"
...
var toc = [
	{
		depth: 2,
		url: "#画一帧",
		title: jsx(Fragment, { children: "画一帧" })
	},
	{
		depth: 2,
		url: "#添加静态球",
		title: jsx(Fragment, { children: "添加静态球" })
	},
	{
		depth: 2,
		url: "#移除",
...
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			name: "DRAW_SPHERE",
			member: "Sphere.Draw",
			children: [jsx(_components.p, { children: "画一帧红色圆柱 / 球标记（调试用）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "03A1 DRAW_SPHERE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: x, y, z, diameter" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "03BC",
			name: "ADD_SPHERE",
			member: "Sphere.Create",
			children: [jsxs(_components.p, { children: [
				"在坐标放静态球，半径 ",
				jsx(_components.code, { children: "radius" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "03BC ADD_SPHERE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: x, y, z, radius" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			id: "03BD",
			name: "REMOVE_SPHERE",
			member: "Sphere.Remove",
			children: [jsx(_components.p, { children: "删掉静态球。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "03BD REMOVE_SPHERE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",

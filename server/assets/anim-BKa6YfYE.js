...
var structuredData = {
	"contents": [
		...
		{
			"heading": "加动画到-clump",
			"content": "`AssocGroupId` / `AnimationId` 见动画枚举。"
		},
		{
			"heading": "全局表",
			"content": "加载 ifp 还涉及 `LoadAnimFile` / Streaming；复杂链查头文件与逆向笔记。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#取动画块",
		title: jsx(Fragment, { children: "取动画块" })
	},
	{
		depth: 2,
		url: "#取动画层级",
		title: jsx(Fragment, { children: "取动画层级" })
	},
	{
		depth: 2,
		url: "#加动画到-clump",
		title: jsx(Fragment, { children: "加动画到 clump" })
	},
	{
		depth: 2,
		url: "#关联定义",
		title: jsx(Fragment, { children: "关联定义" })
	},
	{
		depth: 2,
		url: "#动画块引用",
		title: jsx(Fragment, { children: "动画块引用" })
	},
	{
		depth: 2,
		url: "#全局表",
		title: jsx(Fragment, { children: "全局表" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CAnimManager.h" }) }),
		"\n",
		jsx(_components.p, { children: "动画块与混合。逻辑帧 / 任务侧用；渲染钩子里改要小心。" }),
		"\n",
		jsx(_components.h2, {
			id: "取动画块",
			children: "取动画块"
		...
		"\n",
		jsx(Api, {
			name: "GetAnimationBlock / GetAnimationBlockIndex",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetAnimationBlockIndex"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Api, {
			name: "GetAnimation",
			children: [jsx(_components.p, { children: "按名或 hash。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// auto* hier = CAnimManager::GetAnimation(\"walk_civi\", block);"
								})
							}) })
						}) })
					})
		...
		"\n",
		jsxs(Api, {
			name: "AddAnimation / BlendAnimation",
			children: [jsxs(_components.p, { children: [
				jsx(_components.code, { children: "AssocGroupId" }),
				" / ",
				jsx(_components.code, { children: "AnimationId" }),
				" 见动画枚举。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " CAnimBlendAssociation"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#D73A49",
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "    // CAnimManager::BlendAnimation(ped->m_pRwClump, group, anim, 4.0f);"
									})
								}),
								"\n",
								jsx(_components.span, {
		...
		"\n",
		jsx(Api, {
			name: "CreateAnimAssociation / GetAnimAssociation",
			children: jsx(Fragment, { children: jsx(_components.pre, {
				className: "shiki shiki-themes github-light github-dark",
				style: {
					"--shiki-light": "#24292e",
					...
					jsxs(_components.span, {
						...
						children: [
							...
							jsx(_components.span, {
								...
								children: " CreateAnimAssociation"
							}),
							jsx(_components.span, {
								style: {
									"--shiki-light": "#24292E",
					...
					jsxs(_components.span, {
						...
						children: [
							...
							jsx(_components.span, {
								...
								children: " CAnimBlendStaticAssociation"
							}),
							jsx(_components.span, {
								style: {
									"--shiki-light": "#D73A49",
		...
		"\n",
		jsx(Api, {
			name: "AddAnimBlockRef / RemoveAnimBlockRef",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " GetNumRefsToAnimBlock"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// 自定义 ifp 加载后 AddRef，不用 RemoveRef"
								})
							}) })
						}) })
					})
		...
		"\n",
		jsx(Api, {
			name: "ms_aAnimBlocks / ms_aAnimations",
			children: jsx(Fragment, { children: jsx(_components.pre, {
				className: "shiki shiki-themes github-light github-dark",
				style: {
					"--shiki-light": "#24292e",
		...
		jsxs(_components.p, { children: [
			"加载 ifp 还涉及 ",
			jsx(_components.code, { children: "LoadAnimFile" }),
			" / Streaming；复杂链查头文件与逆向笔记。"
		] })
	] });
}

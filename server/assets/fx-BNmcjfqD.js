...
//#region content/docs/cleo/sa/default/fx.mdx?collection=docs
var frontmatter = {
	"title": "特效 Fx",
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "光晕",
			"content": "在坐标画带淡入淡出的光晕。"
		},
		{
			"heading": "武器店光晕",
			"content": "低绘制距离的武器店式光晕。"
		},
		{
			"heading": "静音爆炸",
			"content": "静音爆炸。"
...
var toc = [
	{
		depth: 2,
		url: "#阴影",
		title: jsx(Fragment, { children: "阴影" })
	},
	{
		depth: 2,
		url: "#爆炸",
		title: jsx(Fragment, { children: "爆炸" })
	},
	{
		depth: 2,
		url: "#光晕",
		title: jsx(Fragment, { children: "光晕" })
	},
	{
		depth: 2,
		url: "#武器店光晕",
		title: jsx(Fragment, { children: "武器店光晕" })
	},
	{
		depth: 2,
		url: "#静音爆炸",
		title: jsx(Fragment, { children: "静音爆炸" })
	},
	{
		depth: 2,
		url: "#枪口闪光",
		title: jsx(Fragment, { children: "枪口闪光" })
	},
	{
		depth: 2,
		url: "#火花",
		title: jsx(Fragment, { children: "火花" })
	},
	{
		depth: 2,
		url: "#带震爆炸",
		title: jsx(Fragment, { children: "带震爆炸" })
	},
	{
		depth: 2,
		url: "#烟雾粒子",
		title: jsx(Fragment, { children: "烟雾粒子" })
	},
	{
		depth: 2,
		url: "#喷血",
		title: jsx(Fragment, { children: "喷血" })
	},
	{
		depth: 2,
		url: "#有色光",
		title: jsx(Fragment, { children: "有色光" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		...
		jsxs(Opcode, {
			...
			children: [jsx(_components.p, { children: "本帧画阴影。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								...
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: textureType, x, y, z, angle, length, intensity, r, g, b" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "(textureType, x, y, z, angle, length, intensity, r, g, b)"
								})]
							}) })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "020C",
			name: "ADD_EXPLOSION",
			member: "Fx.AddExplosion",
			children: [jsx(_components.p, { children: "在点上生成爆炸。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "020C ADD_EXPLOSION" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: x, y, z, type" })
								})
							] })
						}) })
					}),
		...
		jsxs(Opcode, {
			id: "024F",
			name: "DRAW_CORONA",
			member: "Fx.DrawCorona",
			children: [jsx(_components.p, { children: "在坐标画带淡入淡出的光晕。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "024F DRAW_CORONA" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: x, y, z, size, coronaType, flareType, r, g, b" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "(x, y, z, size, coronaType, flareType, r, g, b)"
								})]
							}) })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Fx.DrawWeaponshopCorona",
			children: [jsx(_components.p, { children: "低绘制距离的武器店式光晕。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "04D5 DRAW_WEAPONSHOP_CORONA" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Fx.AddExplosionNoSound",
			children: [jsx(_components.p, { children: "静音爆炸。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0565 ADD_EXPLOSION_NO_SOUND" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			member: "Fx.AddBigGunFlash",
			children: [jsx(_components.p, { children: "枪口闪光粒子（从点到点）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "058A ADD_BIG_GUN_FLASH" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
		...
		jsxs(Opcode, {
			...
			name: "ADD_SPARKS",
			member: "Fx.AddSparks",
			children: [jsx(_components.p, { children: "单次火花喷发。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "08EB ADD_SPARKS" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: x, y, z, velocityX, velocityY, velocityZ, density" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "(x, y, z, velocityX, velocityY, velocityZ, density)"
								})]
							}) })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Fx.AddExplosionVariableShake",
			children: [jsx(_components.p, { children: "爆炸并指定屏幕震动强度。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "0948 ADD_EXPLOSION_VARIABLE_SHAKE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: x, y, z, type, shake" })
								})
							] })
						}) })
					}),
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [
									jsx(_components.span, {
										...
										children: "addExplosionVariableShake"
									}),
									jsx(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		jsxs(Opcode, {
			...
			member: "Fx.AddSmokeParticle",
			children: [jsx(_components.p, { children: "生成烟雾粒子。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "095C ADD_SMOKE_PARTICLE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: x, y, z, velocityX, velocityY, velocityZ, red, green, blue, alpha, size, lastFactor" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "addSmokeParticle"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(x, y, z, velocityX, velocityY, velocityZ, red, green, blue, alpha, size, lastFactor)"
								})]
							}) })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			name: "ADD_BLOOD",
			member: "Fx.AddBlood",
			children: [jsx(_components.p, { children: "喷血与地面血迹。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "09B8 ADD_BLOOD" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: x, y, z, velocityX, velocityY, velocityZ, density, handle" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "(x, y, z, velocityX, velocityY, velocityZ, density, handle)"
								})]
							}) })
						}) })
					}),
		...
		jsxs(Opcode, {
			...
			member: "Fx.DrawLightWithRange",
			children: [jsx(_components.p, { children: "在点周围画有色光（半径）。" }), jsxs(CodeBlockTabs, {
				defaultValue: "OP",
				children: [
					jsxs(CodeBlockTabsList, { children: [
						jsx(CodeBlockTabsTrigger, {
					...
					jsx(CodeBlockTab, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "09E5 DRAW_LIGHT_WITH_RANGE" })
								}),
								"\n",
								jsx(_components.span, {
									className: "line",
									children: jsx(_components.span, { children: "in: x, y, z, red, green, blue, radius" })
								})
							] })
						}) })
					}),
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "drawLightWithRange"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#24292E",
										"--shiki-dark": "#E1E4E8"
									},
									children: "(x, y, z, red, green, blue, radius)"
								})]
							}) })
						}) })
					}),

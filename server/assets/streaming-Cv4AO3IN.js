...
//#region content/docs/plugins/entities/streaming.mdx?collection=docs
var frontmatter = {
	"title": "流式 CStreaming",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`CStreaming.h`"
		},
		{
			"heading": void 0,
			"content": "也可走 Command `REQUEST_MODEL`（见 Command）。"
		},
		{
			"heading": "移除模型",
			"content": "用完再删，避免正在用的被踢。"
		},
		{
			"heading": "内存与状态",
			"content": "诊断用。"
...
var toc = [
	{
		depth: 2,
		url: "#请求与加载模型",
		title: jsx(Fragment, { children: "请求与加载模型" })
	},
	{
		depth: 2,
		url: "#移除模型",
		title: jsx(Fragment, { children: "移除模型" })
	},
	{
		depth: 2,
		url: "#特殊模型--特殊角色",
		title: jsx(Fragment, { children: "特殊模型 / 特殊角色" })
	},
	{
		depth: 2,
		url: "#txd-与升级件",
		title: jsx(Fragment, { children: "TXD 与升级件" })
	},
	{
		depth: 2,
		url: "#加载场景碰撞",
		title: jsx(Fragment, { children: "加载场景碰撞" })
	},
	{
		depth: 2,
		url: "#内存与状态",
		title: jsx(Fragment, { children: "内存与状态" })
	},
	{
		depth: 2,
		url: "#典型顺序",
		title: jsx(Fragment, { children: "典型顺序" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsx(_components.p, { children: jsx(_components.code, { children: "CStreaming.h" }) }),
		"\n",
		jsxs(_components.p, { children: [
			"也可走 Command ",
			jsx(_components.code, { children: "REQUEST_MODEL" }),
			"（见 ",
			jsx(_components.a, {
		...
		"\n",
		jsx(Api, {
			name: "RequestModel / LoadAllRequestedModels / HasModelLoaded",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " bOnlyPriorityRequests"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " SetModelTxdIsDeletable"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		jsxs(Api, {
			name: "RemoveModel",
			children: [jsx(_components.p, { children: "用完再删，避免正在用的被踢。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
		...
		"\n",
		jsx(Api, {
			name: "RequestSpecialModel / RequestSpecialChar",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsx(_components.span, {
								...
								children: jsx(_components.span, {
									...
									children: "// CStreaming::RequestSpecialChar(slot, \"name\", 0x16);"
								})
							}) })
						}) })
					})
		...
		"\n",
		jsx(Api, {
			name: "RequestTxdModel / RequestVehicleUpgrade",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " RequestVehicleUpgrade"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " HasVehicleUpgradeLoaded"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsx(Api, {
			name: "LoadScene / LoadSceneCollision / RequestBigBuildings",
			children: jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
		...
		"\n",
		jsxs(Api, {
			name: "ms_memoryAvailable / ms_numPriorityRequests",
			children: [jsx(_components.p, { children: "诊断用。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " ms_numPriorityRequests;"
										})
									]
								})
							] })
		...
		jsx(Fragment, { children: jsx(_components.pre, {
			...
			children: jsxs(_components.code, { children: [
				jsx(_components.span, {
					className: "line",
					children: jsx(_components.span, { children: "RequestModel" })
				}),
				"\n",
				jsx(_components.span, {
					className: "line",
					children: jsx(_components.span, { children: "  → LoadAllRequestedModels（或分帧等 HasModelLoaded）" })
				}),
				"\n",
				jsx(_components.span, {
					className: "line",
					children: jsx(_components.span, { children: "  → 创建实体 / SetModelIndex" })
				}),
				"\n",
				jsx(_components.span, {
					className: "line",
					children: jsx(_components.span, { children: "  → SetModelIsDeletable（可选）" })
				})
			] })
		}) })
	] });

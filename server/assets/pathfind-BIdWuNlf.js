...
//#region content/docs/plugins/entities/pathfind.mdx?collection=docs
var frontmatter = {
	"title": "寻路 CPathFind",
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`CPathFind.h` · 全局 `ThePaths`"
		},
		{
			"heading": void 0,
			"content": "车 / 人路径节点。搜路参数多，先小范围试。"
		},
		{
			"heading": "搜路",
			"content": "从起点到终点填节点序列。"
		...
		{
			"heading": "取节点",
			"content": "用 `CNodeAddress` 取 `CPathNode*`。"
		},
		{
			"heading": "流式路径",
			"content": "按位置拉路径区。"
		...
		{
			"heading": "与交通",
			"content": "随机车挂节点见 CCarCtrl。本对象只持图数据与搜路。"
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#搜路",
		title: jsx(Fragment, { children: "搜路" })
	},
	{
		depth: 2,
		url: "#取节点",
		title: jsx(Fragment, { children: "取节点" })
	},
	{
		depth: 2,
		url: "#流式路径",
		title: jsx(Fragment, { children: "流式路径" })
	},
	{
		depth: 2,
		url: "#水域节点",
		title: jsx(Fragment, { children: "水域节点" })
	},
	{
		depth: 2,
		url: "#禁区字段",
		title: jsx(Fragment, { children: "禁区字段" })
	},
	{
		depth: 2,
		url: "#与交通",
		title: jsx(Fragment, { children: "与交通" })
	}
];
function _createMdxContent(props) {
	...
	return jsxs(Fragment, { children: [
		jsxs(_components.p, { children: [
			jsx(_components.code, { children: "CPathFind.h" }),
			" · 全局 ",
			jsx(_components.code, { children: "ThePaths" })
		] }),
		"\n",
		jsx(_components.p, { children: "车 / 人路径节点。搜路参数多，先小范围试。" }),
		"\n",
		jsx(_components.h2, {
			id: "搜路",
			children: "搜路"
		...
		jsxs(Api, {
			name: "DoPathSearch",
			children: [jsx(_components.p, { children: "从起点到终点填节点序列。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " includeNodesWithoutLinks"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
						...
						children: jsx(Fragment, { children: jsx(_components.pre, {
							...
							children: jsx(_components.code, { children: jsxs(_components.span, {
								...
								children: [jsx(_components.span, {
									...
									children: "// ThePaths.DoPathSearch(...);"
								}), jsx(_components.span, {
									style: {
										"--shiki-light": "#6A737D",
										"--shiki-dark": "#6A737D"
									},
									children: " // 参数顺序以头文件为准，失败看 *pNodesCount"
								})]
							}) })
						}) })
					})
		...
		jsxs(Api, {
			...
			children: [jsxs(_components.p, { children: [
				"用 ",
				jsx(_components.code, { children: "CNodeAddress" }),
				" 取 ",
				jsx(_components.code, { children: "CPathNode*" }),
				"。"
			] }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
							...
							children: jsxs(_components.code, { children: [
								jsx(_components.span, {
									...
									children: jsx(_components.span, {
										...
										children: "// CPathNode* node = ThePaths.GetPathNode(addr);"
									})
								}),
								"\n",
								jsxs(_components.span, {
									...
									children: [jsx(_components.span, {
										...
										children: "// if (node) { CVector p = node->GetPosition(); }"
									}), jsx(_components.span, {
										style: {
											"--shiki-light": "#6A737D",
											"--shiki-dark": "#6A737D"
										},
										children: " // 具体访问以 CPathNode 为准"
									})]
								})
							] })
						}) })
		...
		"\n",
		jsxs(Api, {
			name: "SetPathsNeededAtPosition / UpdateStreaming",
			children: [jsx(_components.p, { children: "按位置拉路径区。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
								...
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " SetPathsNeededAtPosition"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		"\n",
		jsxs(Api, {
			name: "m_aForbiddenAreas / m_bForbiddenForScriptedCarsEnabled",
			children: [jsx(_components.p, { children: "脚本车绕行相关。" }), jsxs(CodeBlockTabs, {
				defaultValue: "签名",
				children: [
					jsxs(CodeBlockTabsList, { children: [jsx(CodeBlockTabsTrigger, {
						value: "签名",
							...
							children: jsxs(_components.code, { children: [
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " m_dwNumForbiddenAreas;"
										})
									]
								}),
								"\n",
								jsxs(_components.span, {
									...
									children: [
										jsx(_components.span, {
											...
											children: "CForbiddenArea m_aForbiddenAreas["
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#005CC5",
								...
								jsxs(_components.span, {
									...
									children: [jsx(_components.span, {
										...
										children: " m_bForbiddenForScriptedCarsEnabled;"
									})]
								}),
								"\n",
								jsxs(_components.span, {
									...
									children: [
										...
										jsx(_components.span, {
											...
											children: " m_fForbiddenForScrCarsX1;"
										}),
										jsx(_components.span, {
											style: {
												"--shiki-light": "#6A737D",
